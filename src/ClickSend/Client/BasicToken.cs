...
namespace ClickSend.Client
{
    ...
    public class BasicToken : TokenBase
    {
        ...
        {
            request.Headers.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Basic", ClickSend.Client.ClientUtils.Base64Encode(_username + ":" + _password));
        }
    }
}
