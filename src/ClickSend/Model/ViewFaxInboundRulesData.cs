...
namespace ClickSend.Model
{
    ...
    /// </summary>
    public partial class ViewFaxInboundRulesData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewFaxInboundRulesData" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ViewFaxInboundRulesData(Option<int?> total = default, Option<int?> perPage = default, Option<int?> currentPage = default, Option<int?> lastPage = default, Option<string?> nextPageUrl = default, Option<string?> prevPageUrl = default, Option<int?> from = default, Option<int?> to = default, Option<List<InboundFaxRule>?> data = default)
        {
            TotalOption = total;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<InboundFaxRule>?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        /* <example>[{&quot;inbound_rule_id&quot;:1,&quot;dedicated_number&quot;:19,&quot;rule_name&quot;:&quot;Email&quot;,&quot;user_id&quot;:&quot;1&quot;,&quot;action&quot;:&quot;EMAIL_FIXED&quot;,&quot;action_address&quot;:&quot;test@test.com&quot;,&quot;enabled&quot;:&quot;1&quot;},{&quot;inbound_rule_id&quot;:2,&quot;dedicated_number&quot;:19,&quot;rule_name&quot;:&quot;URL&quot;,&quot;user_id&quot;:&quot;1&quot;,&quot;action&quot;:&quot;URL&quot;,&quot;action_address&quot;:&quot;http://yourdomain.com&quot;,&quot;enabled&quot;:&quot;0&quot;}]</example> */
        [JsonPropertyName("data")]
        public List<InboundFaxRule>? Data { get { return this.DataOption.Value; } set { this.DataOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ViewFaxInboundRulesData" />
    /// </summary>
    public class ViewFaxInboundRulesDataJsonConverter : JsonConverter<ViewFaxInboundRulesData>
    {
        /// <summary>
        /// Deserializes json to <see cref="ViewFaxInboundRulesData" />
        /// </summary>
        ...
        public override ViewFaxInboundRulesData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<InboundFaxRule>?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "to":
                            ...
                            break;
                        case "data":
                            data = new Option<List<InboundFaxRule>?>(JsonSerializer.Deserialize<List<InboundFaxRule>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class ViewFaxInboundRulesData.");

            if (perPage.IsSet && perPage.Value == null)
                throw new ArgumentNullException(nameof(perPage), "Property is not nullable for class ViewFaxInboundRulesData.");

            if (currentPage.IsSet && currentPage.Value == null)
                throw new ArgumentNullException(nameof(currentPage), "Property is not nullable for class ViewFaxInboundRulesData.");

            if (lastPage.IsSet && lastPage.Value == null)
                throw new ArgumentNullException(nameof(lastPage), "Property is not nullable for class ViewFaxInboundRulesData.");

            if (from.IsSet && from.Value == null)
                throw new ArgumentNullException(nameof(from), "Property is not nullable for class ViewFaxInboundRulesData.");

            if (to.IsSet && to.Value == null)
                throw new ArgumentNullException(nameof(to), "Property is not nullable for class ViewFaxInboundRulesData.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ViewFaxInboundRulesData.");

            return new ViewFaxInboundRulesData(total, perPage, currentPage, lastPage, nextPageUrl, prevPageUrl, from, to, data);
        }

        /// <summary>
        /// Serializes a <see cref="ViewFaxInboundRulesData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewFaxInboundRulesData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ViewFaxInboundRulesData viewFaxInboundRulesData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, viewFaxInboundRulesData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ViewFaxInboundRulesData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewFaxInboundRulesData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ViewFaxInboundRulesData viewFaxInboundRulesData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (viewFaxInboundRulesData.DataOption.IsSet && viewFaxInboundRulesData.Data == null)
                throw new ArgumentNullException(nameof(viewFaxInboundRulesData.Data), "Property is required for class ViewFaxInboundRulesData.");

            if (viewFaxInboundRulesData.TotalOption.IsSet)
                writer.WriteNumber("total", viewFaxInboundRulesData.TotalOption.Value!.Value);

            if (viewFaxInboundRulesData.PerPageOption.IsSet)
                writer.WriteNumber("per_page", viewFaxInboundRulesData.PerPageOption.Value!.Value);

            if (viewFaxInboundRulesData.CurrentPageOption.IsSet)
                writer.WriteNumber("current_page", viewFaxInboundRulesData.CurrentPageOption.Value!.Value);

            if (viewFaxInboundRulesData.LastPageOption.IsSet)
                writer.WriteNumber("last_page", viewFaxInboundRulesData.LastPageOption.Value!.Value);

            if (viewFaxInboundRulesData.NextPageUrlOption.IsSet)
                if (viewFaxInboundRulesData.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", viewFaxInboundRulesData.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (viewFaxInboundRulesData.PrevPageUrlOption.IsSet)
                if (viewFaxInboundRulesData.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", viewFaxInboundRulesData.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (viewFaxInboundRulesData.FromOption.IsSet)
                writer.WriteNumber("from", viewFaxInboundRulesData.FromOption.Value!.Value);

            if (viewFaxInboundRulesData.ToOption.IsSet)
                writer.WriteNumber("to", viewFaxInboundRulesData.ToOption.Value!.Value);

            if (viewFaxInboundRulesData.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, viewFaxInboundRulesData.Data, jsonSerializerOptions);
            }
        }
    }
}
