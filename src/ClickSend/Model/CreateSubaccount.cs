...
namespace ClickSend.Model
{
    ...
    /// CreateSubaccount
    /// </summary>
    public partial class CreateSubaccount : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public CreateSubaccount(Option<int?> httpCode = default, Option<string?> responseCode = default, Option<string?> responseMsg = default, Option<Subaccount?> data = default)
        {
        ...
        /* <example>New account has been created.</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="CreateSubaccount" />
    /// </summary>
    public class CreateSubaccountJsonConverter : JsonConverter<CreateSubaccount>
    {
        /// <summary>
        /// Deserializes json to <see cref="CreateSubaccount" />
        /// </summary>
        ...
        public override CreateSubaccount Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (httpCode.IsSet && httpCode.Value == null)
                throw new ArgumentNullException(nameof(httpCode), "Property is not nullable for class CreateSubaccount.");

            if (responseCode.IsSet && responseCode.Value == null)
                throw new ArgumentNullException(nameof(responseCode), "Property is not nullable for class CreateSubaccount.");

            if (responseMsg.IsSet && responseMsg.Value == null)
                throw new ArgumentNullException(nameof(responseMsg), "Property is not nullable for class CreateSubaccount.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class CreateSubaccount.");

            return new CreateSubaccount(httpCode, responseCode, responseMsg, data);
        }

        /// <summary>
        /// Serializes a <see cref="CreateSubaccount" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createSubaccount"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CreateSubaccount createSubaccount, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, createSubaccount, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CreateSubaccount" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createSubaccount"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CreateSubaccount createSubaccount, JsonSerializerOptions jsonSerializerOptions)
        {
            if (createSubaccount.ResponseCodeOption.IsSet && createSubaccount.ResponseCode == null)
                throw new ArgumentNullException(nameof(createSubaccount.ResponseCode), "Property is required for class CreateSubaccount.");

            if (createSubaccount.ResponseMsgOption.IsSet && createSubaccount.ResponseMsg == null)
                throw new ArgumentNullException(nameof(createSubaccount.ResponseMsg), "Property is required for class CreateSubaccount.");

            if (createSubaccount.DataOption.IsSet && createSubaccount.Data == null)
                throw new ArgumentNullException(nameof(createSubaccount.Data), "Property is required for class CreateSubaccount.");

            if (createSubaccount.HttpCodeOption.IsSet)
                writer.WriteNumber("http_code", createSubaccount.HttpCodeOption.Value!.Value);

            if (createSubaccount.ResponseCodeOption.IsSet)
                writer.WriteString("response_code", createSubaccount.ResponseCode);

            if (createSubaccount.ResponseMsgOption.IsSet)
                writer.WriteString("response_msg", createSubaccount.ResponseMsg);

            if (createSubaccount.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, createSubaccount.Data, jsonSerializerOptions);
            }
        }
    }
}
