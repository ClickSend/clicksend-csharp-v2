...
namespace ClickSend.Model
{
    ...
    public partial class Pagination : IValidatableObject
    {
        ...
        [JsonConstructor]
        public Pagination(Option<int?> total = default, Option<int?> perPage = default, Option<int?> currentPage = default, Option<int?> lastPage = default, Option<string?> nextPageUrl = default, Option<string?> prevPageUrl = default, Option<int?> from = default, Option<int?> to = default)
        {
            TotalOption = total;
    ...
    public class PaginationJsonConverter : JsonConverter<Pagination>
    {
        ...
        public override Pagination Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (lastPage.IsSet && lastPage.Value == null)
                throw new ArgumentNullException(nameof(lastPage), "Property is not nullable for class Pagination.");

            if (from.IsSet && from.Value == null)
                throw new ArgumentNullException(nameof(from), "Property is not nullable for class Pagination.");

            if (to.IsSet && to.Value == null)
                throw new ArgumentNullException(nameof(to), "Property is not nullable for class Pagination.");

            return new Pagination(total, perPage, currentPage, lastPage, nextPageUrl, prevPageUrl, from, to);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, Pagination pagination, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (pagination.CurrentPageOption.IsSet)
                writer.WriteNumber("current_page", pagination.CurrentPageOption.Value!.Value);

            if (pagination.LastPageOption.IsSet)
                writer.WriteNumber("last_page", pagination.LastPageOption.Value!.Value);

            if (pagination.NextPageUrlOption.IsSet)
                if (pagination.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", pagination.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (pagination.PrevPageUrlOption.IsSet)
                if (pagination.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", pagination.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (pagination.FromOption.IsSet)
                writer.WriteNumber("from", pagination.FromOption.Value!.Value);

            if (pagination.ToOption.IsSet)
                writer.WriteNumber("to", pagination.ToOption.Value!.Value);
        }
    }
}
