...
namespace ClickSend.Model
{
    ...
    /// </summary>
    public partial class ViewSmsReceiptsData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewSmsReceiptsData" /> class.
        /// </summary>
        ...
        /// <param name="data">The parameters related to the actual message receipts.</param>
        [JsonConstructor]
        public ViewSmsReceiptsData(Option<int?> total = default, Option<int?> perPage = default, Option<int?> currentPage = default, Option<int?> lastPage = default, Option<string?> nextPageUrl = default, Option<string?> prevPageUrl = default, Option<int?> from = default, Option<int?> to = default, Option<List<SmsReceipt>?> data = default)
        {
            TotalOption = total;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<SmsReceipt>?> DataOption { get; private set; }

        /// <summary>
        /// The parameters related to the actual message receipts.
        /// </summary>
        /// <value>The parameters related to the actual message receipts.</value>
        [JsonPropertyName("data")]
        public List<SmsReceipt>? Data { get { return this.DataOption.Value; } set { this.DataOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ViewSmsReceiptsData" />
    /// </summary>
    public class ViewSmsReceiptsDataJsonConverter : JsonConverter<ViewSmsReceiptsData>
    {
        /// <summary>
        /// Deserializes json to <see cref="ViewSmsReceiptsData" />
        /// </summary>
        ...
        public override ViewSmsReceiptsData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<SmsReceipt>?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "to":
                            ...
                            break;
                        case "data":
                            data = new Option<List<SmsReceipt>?>(JsonSerializer.Deserialize<List<SmsReceipt>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class ViewSmsReceiptsData.");

            if (perPage.IsSet && perPage.Value == null)
                throw new ArgumentNullException(nameof(perPage), "Property is not nullable for class ViewSmsReceiptsData.");

            if (currentPage.IsSet && currentPage.Value == null)
                throw new ArgumentNullException(nameof(currentPage), "Property is not nullable for class ViewSmsReceiptsData.");

            if (lastPage.IsSet && lastPage.Value == null)
                throw new ArgumentNullException(nameof(lastPage), "Property is not nullable for class ViewSmsReceiptsData.");

            if (from.IsSet && from.Value == null)
                throw new ArgumentNullException(nameof(from), "Property is not nullable for class ViewSmsReceiptsData.");

            if (to.IsSet && to.Value == null)
                throw new ArgumentNullException(nameof(to), "Property is not nullable for class ViewSmsReceiptsData.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ViewSmsReceiptsData.");

            return new ViewSmsReceiptsData(total, perPage, currentPage, lastPage, nextPageUrl, prevPageUrl, from, to, data);
        }

        /// <summary>
        /// Serializes a <see cref="ViewSmsReceiptsData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewSmsReceiptsData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ViewSmsReceiptsData viewSmsReceiptsData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, viewSmsReceiptsData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ViewSmsReceiptsData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewSmsReceiptsData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ViewSmsReceiptsData viewSmsReceiptsData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (viewSmsReceiptsData.DataOption.IsSet && viewSmsReceiptsData.Data == null)
                throw new ArgumentNullException(nameof(viewSmsReceiptsData.Data), "Property is required for class ViewSmsReceiptsData.");

            if (viewSmsReceiptsData.TotalOption.IsSet)
                writer.WriteNumber("total", viewSmsReceiptsData.TotalOption.Value!.Value);

            if (viewSmsReceiptsData.PerPageOption.IsSet)
                writer.WriteNumber("per_page", viewSmsReceiptsData.PerPageOption.Value!.Value);

            if (viewSmsReceiptsData.CurrentPageOption.IsSet)
                writer.WriteNumber("current_page", viewSmsReceiptsData.CurrentPageOption.Value!.Value);

            if (viewSmsReceiptsData.LastPageOption.IsSet)
                writer.WriteNumber("last_page", viewSmsReceiptsData.LastPageOption.Value!.Value);

            if (viewSmsReceiptsData.NextPageUrlOption.IsSet)
                if (viewSmsReceiptsData.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", viewSmsReceiptsData.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (viewSmsReceiptsData.PrevPageUrlOption.IsSet)
                if (viewSmsReceiptsData.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", viewSmsReceiptsData.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (viewSmsReceiptsData.FromOption.IsSet)
                writer.WriteNumber("from", viewSmsReceiptsData.FromOption.Value!.Value);

            if (viewSmsReceiptsData.ToOption.IsSet)
                writer.WriteNumber("to", viewSmsReceiptsData.ToOption.Value!.Value);

            if (viewSmsReceiptsData.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, viewSmsReceiptsData.Data, jsonSerializerOptions);
            }
        }
    }
}
