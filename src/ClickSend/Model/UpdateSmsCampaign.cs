...
namespace ClickSend.Model
{
    ...
    public partial class UpdateSmsCampaign : IValidatableObject
    {
        ...
        [JsonConstructor]
        public UpdateSmsCampaign(Option<int?> httpCode = default, Option<string?> responseCode = default, Option<string?> responseMsg = default, Option<SmsCampaign?> data = default)
        {
        ...
        /* <example>Your SMS Campaign has been updated.</example> */
    ...
    public class UpdateSmsCampaignJsonConverter : JsonConverter<UpdateSmsCampaign>
    {
        ...
        public override UpdateSmsCampaign Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (httpCode.IsSet && httpCode.Value == null)
                throw new ArgumentNullException(nameof(httpCode), "Property is not nullable for class UpdateSmsCampaign.");

            if (responseCode.IsSet && responseCode.Value == null)
                throw new ArgumentNullException(nameof(responseCode), "Property is not nullable for class UpdateSmsCampaign.");

            if (responseMsg.IsSet && responseMsg.Value == null)
                throw new ArgumentNullException(nameof(responseMsg), "Property is not nullable for class UpdateSmsCampaign.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class UpdateSmsCampaign.");

            return new UpdateSmsCampaign(httpCode, responseCode, responseMsg, data);
        }
        ...
        {
            if (updateSmsCampaign.ResponseCodeOption.IsSet && updateSmsCampaign.ResponseCode == null)
                throw new ArgumentNullException(nameof(updateSmsCampaign.ResponseCode), "Property is required for class UpdateSmsCampaign.");

            if (updateSmsCampaign.ResponseMsgOption.IsSet && updateSmsCampaign.ResponseMsg == null)
                throw new ArgumentNullException(nameof(updateSmsCampaign.ResponseMsg), "Property is required for class UpdateSmsCampaign.");

            if (updateSmsCampaign.DataOption.IsSet && updateSmsCampaign.Data == null)
                throw new ArgumentNullException(nameof(updateSmsCampaign.Data), "Property is required for class UpdateSmsCampaign.");

            if (updateSmsCampaign.HttpCodeOption.IsSet)
                writer.WriteNumber("http_code", updateSmsCampaign.HttpCodeOption.Value!.Value);

            if (updateSmsCampaign.ResponseCodeOption.IsSet)
                writer.WriteString("response_code", updateSmsCampaign.ResponseCode);

            if (updateSmsCampaign.ResponseMsgOption.IsSet)
                writer.WriteString("response_msg", updateSmsCampaign.ResponseMsg);

            if (updateSmsCampaign.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, updateSmsCampaign.Data, jsonSerializerOptions);
            }
        }
    }
}
