...
namespace ClickSend.Model
{
    ...
    /// ViewFaxReceiptsData
    /// </summary>
    public partial class ViewFaxReceiptsData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewFaxReceiptsData" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ViewFaxReceiptsData(Option<int?> total = default, Option<int?> perPage = default, Option<int?> currentPage = default, Option<int?> lastPage = default, Option<string?> nextPageUrl = default, Option<string?> prevPageUrl = default, Option<int?> from = default, Option<int?> to = default, Option<List<FaxReceipt>?> data = default)
        {
            TotalOption = total;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<FaxReceipt>?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        [JsonPropertyName("data")]
        public List<FaxReceipt>? Data { get { return this.DataOption.Value; } set { this.DataOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ViewFaxReceiptsData" />
    /// </summary>
    public class ViewFaxReceiptsDataJsonConverter : JsonConverter<ViewFaxReceiptsData>
    {
        /// <summary>
        /// Deserializes json to <see cref="ViewFaxReceiptsData" />
        /// </summary>
        ...
        public override ViewFaxReceiptsData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<FaxReceipt>?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "to":
                            ...
                            break;
                        case "data":
                            data = new Option<List<FaxReceipt>?>(JsonSerializer.Deserialize<List<FaxReceipt>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class ViewFaxReceiptsData.");

            if (perPage.IsSet && perPage.Value == null)
                throw new ArgumentNullException(nameof(perPage), "Property is not nullable for class ViewFaxReceiptsData.");

            if (currentPage.IsSet && currentPage.Value == null)
                throw new ArgumentNullException(nameof(currentPage), "Property is not nullable for class ViewFaxReceiptsData.");

            if (lastPage.IsSet && lastPage.Value == null)
                throw new ArgumentNullException(nameof(lastPage), "Property is not nullable for class ViewFaxReceiptsData.");

            if (from.IsSet && from.Value == null)
                throw new ArgumentNullException(nameof(from), "Property is not nullable for class ViewFaxReceiptsData.");

            if (to.IsSet && to.Value == null)
                throw new ArgumentNullException(nameof(to), "Property is not nullable for class ViewFaxReceiptsData.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ViewFaxReceiptsData.");

            return new ViewFaxReceiptsData(total, perPage, currentPage, lastPage, nextPageUrl, prevPageUrl, from, to, data);
        }

        /// <summary>
        /// Serializes a <see cref="ViewFaxReceiptsData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewFaxReceiptsData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ViewFaxReceiptsData viewFaxReceiptsData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, viewFaxReceiptsData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ViewFaxReceiptsData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewFaxReceiptsData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ViewFaxReceiptsData viewFaxReceiptsData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (viewFaxReceiptsData.DataOption.IsSet && viewFaxReceiptsData.Data == null)
                throw new ArgumentNullException(nameof(viewFaxReceiptsData.Data), "Property is required for class ViewFaxReceiptsData.");

            if (viewFaxReceiptsData.TotalOption.IsSet)
                writer.WriteNumber("total", viewFaxReceiptsData.TotalOption.Value!.Value);

            if (viewFaxReceiptsData.PerPageOption.IsSet)
                writer.WriteNumber("per_page", viewFaxReceiptsData.PerPageOption.Value!.Value);

            if (viewFaxReceiptsData.CurrentPageOption.IsSet)
                writer.WriteNumber("current_page", viewFaxReceiptsData.CurrentPageOption.Value!.Value);

            if (viewFaxReceiptsData.LastPageOption.IsSet)
                writer.WriteNumber("last_page", viewFaxReceiptsData.LastPageOption.Value!.Value);

            if (viewFaxReceiptsData.NextPageUrlOption.IsSet)
                if (viewFaxReceiptsData.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", viewFaxReceiptsData.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (viewFaxReceiptsData.PrevPageUrlOption.IsSet)
                if (viewFaxReceiptsData.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", viewFaxReceiptsData.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (viewFaxReceiptsData.FromOption.IsSet)
                writer.WriteNumber("from", viewFaxReceiptsData.FromOption.Value!.Value);

            if (viewFaxReceiptsData.ToOption.IsSet)
                writer.WriteNumber("to", viewFaxReceiptsData.ToOption.Value!.Value);

            if (viewFaxReceiptsData.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, viewFaxReceiptsData.Data, jsonSerializerOptions);
            }
        }
    }
}
