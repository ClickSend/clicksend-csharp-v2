...
namespace ClickSend.Model
{
    ...
    /// ViewYourNumbersData
    /// </summary>
    public partial class ViewYourNumbersData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewYourNumbersData" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ViewYourNumbersData(Option<int?> total = default, Option<int?> perPage = default, Option<int?> currentPage = default, Option<int?> lastPage = default, Option<string?> nextPageUrl = default, Option<string?> prevPageUrl = default, Option<int?> from = default, Option<int?> to = default, Option<List<ViewYourNumbersDataAllOfDataInner>?> data = default, Option<Currency?> currency = default)
        {
            TotalOption = total;
    ...
    /// <summary>
    /// A Json converter for type <see cref="ViewYourNumbersData" />
    /// </summary>
    public class ViewYourNumbersDataJsonConverter : JsonConverter<ViewYourNumbersData>
    {
        /// <summary>
        /// Deserializes json to <see cref="ViewYourNumbersData" />
        /// </summary>
        ...
        public override ViewYourNumbersData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<ViewYourNumbersDataAllOfDataInner>?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "to":
                            ...
                            break;
                        case "data":
                            data = new Option<List<ViewYourNumbersDataAllOfDataInner>?>(JsonSerializer.Deserialize<List<ViewYourNumbersDataAllOfDataInner>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "_currency":
            ...
            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class ViewYourNumbersData.");

            if (perPage.IsSet && perPage.Value == null)
                throw new ArgumentNullException(nameof(perPage), "Property is not nullable for class ViewYourNumbersData.");

            if (currentPage.IsSet && currentPage.Value == null)
                throw new ArgumentNullException(nameof(currentPage), "Property is not nullable for class ViewYourNumbersData.");

            if (lastPage.IsSet && lastPage.Value == null)
                throw new ArgumentNullException(nameof(lastPage), "Property is not nullable for class ViewYourNumbersData.");

            if (from.IsSet && from.Value == null)
                throw new ArgumentNullException(nameof(from), "Property is not nullable for class ViewYourNumbersData.");

            if (to.IsSet && to.Value == null)
                throw new ArgumentNullException(nameof(to), "Property is not nullable for class ViewYourNumbersData.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ViewYourNumbersData.");

            if (currency.IsSet && currency.Value == null)
                throw new ArgumentNullException(nameof(currency), "Property is not nullable for class ViewYourNumbersData.");

            return new ViewYourNumbersData(total, perPage, currentPage, lastPage, nextPageUrl, prevPageUrl, from, to, data, currency);
        }

        /// <summary>
        /// Serializes a <see cref="ViewYourNumbersData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewYourNumbersData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ViewYourNumbersData viewYourNumbersData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, viewYourNumbersData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ViewYourNumbersData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewYourNumbersData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ViewYourNumbersData viewYourNumbersData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (viewYourNumbersData.DataOption.IsSet && viewYourNumbersData.Data == null)
                throw new ArgumentNullException(nameof(viewYourNumbersData.Data), "Property is required for class ViewYourNumbersData.");

            if (viewYourNumbersData.CurrencyOption.IsSet && viewYourNumbersData.Currency == null)
                throw new ArgumentNullException(nameof(viewYourNumbersData.Currency), "Property is required for class ViewYourNumbersData.");

            if (viewYourNumbersData.TotalOption.IsSet)
                writer.WriteNumber("total", viewYourNumbersData.TotalOption.Value!.Value);

            if (viewYourNumbersData.PerPageOption.IsSet)
                writer.WriteNumber("per_page", viewYourNumbersData.PerPageOption.Value!.Value);

            if (viewYourNumbersData.CurrentPageOption.IsSet)
                writer.WriteNumber("current_page", viewYourNumbersData.CurrentPageOption.Value!.Value);

            if (viewYourNumbersData.LastPageOption.IsSet)
                writer.WriteNumber("last_page", viewYourNumbersData.LastPageOption.Value!.Value);

            if (viewYourNumbersData.NextPageUrlOption.IsSet)
                if (viewYourNumbersData.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", viewYourNumbersData.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (viewYourNumbersData.PrevPageUrlOption.IsSet)
                if (viewYourNumbersData.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", viewYourNumbersData.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (viewYourNumbersData.FromOption.IsSet)
                writer.WriteNumber("from", viewYourNumbersData.FromOption.Value!.Value);

            if (viewYourNumbersData.ToOption.IsSet)
                writer.WriteNumber("to", viewYourNumbersData.ToOption.Value!.Value);

            if (viewYourNumbersData.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, viewYourNumbersData.Data, jsonSerializerOptions);
            }
            if (viewYourNumbersData.CurrencyOption.IsSet)
            {
                writer.WritePropertyName("_currency");
                JsonSerializer.Serialize(writer, viewYourNumbersData.Currency, jsonSerializerOptions);
            }
        }
    }
}
