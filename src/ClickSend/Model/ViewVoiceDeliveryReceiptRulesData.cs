...
namespace ClickSend.Model
{
    ...
    /// </summary>
    public partial class ViewVoiceDeliveryReceiptRulesData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewVoiceDeliveryReceiptRulesData" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ViewVoiceDeliveryReceiptRulesData(Option<int?> total = default, Option<int?> perPage = default, Option<int?> currentPage = default, Option<int?> lastPage = default, Option<string?> nextPageUrl = default, Option<string?> prevPageUrl = default, Option<int?> from = default, Option<int?> to = default, Option<List<VoiceDeliveryReceiptRule>?> data = default)
        {
            TotalOption = total;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<VoiceDeliveryReceiptRule>?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        [JsonPropertyName("data")]
        public List<VoiceDeliveryReceiptRule>? Data { get { return this.DataOption.Value; } set { this.DataOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ViewVoiceDeliveryReceiptRulesData" />
    /// </summary>
    public class ViewVoiceDeliveryReceiptRulesDataJsonConverter : JsonConverter<ViewVoiceDeliveryReceiptRulesData>
    {
        /// <summary>
        /// Deserializes json to <see cref="ViewVoiceDeliveryReceiptRulesData" />
        /// </summary>
        ...
        public override ViewVoiceDeliveryReceiptRulesData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<VoiceDeliveryReceiptRule>?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "to":
                            ...
                            break;
                        case "data":
                            data = new Option<List<VoiceDeliveryReceiptRule>?>(JsonSerializer.Deserialize<List<VoiceDeliveryReceiptRule>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class ViewVoiceDeliveryReceiptRulesData.");

            if (perPage.IsSet && perPage.Value == null)
                throw new ArgumentNullException(nameof(perPage), "Property is not nullable for class ViewVoiceDeliveryReceiptRulesData.");

            if (currentPage.IsSet && currentPage.Value == null)
                throw new ArgumentNullException(nameof(currentPage), "Property is not nullable for class ViewVoiceDeliveryReceiptRulesData.");

            if (lastPage.IsSet && lastPage.Value == null)
                throw new ArgumentNullException(nameof(lastPage), "Property is not nullable for class ViewVoiceDeliveryReceiptRulesData.");

            if (from.IsSet && from.Value == null)
                throw new ArgumentNullException(nameof(from), "Property is not nullable for class ViewVoiceDeliveryReceiptRulesData.");

            if (to.IsSet && to.Value == null)
                throw new ArgumentNullException(nameof(to), "Property is not nullable for class ViewVoiceDeliveryReceiptRulesData.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ViewVoiceDeliveryReceiptRulesData.");

            return new ViewVoiceDeliveryReceiptRulesData(total, perPage, currentPage, lastPage, nextPageUrl, prevPageUrl, from, to, data);
        }

        /// <summary>
        /// Serializes a <see cref="ViewVoiceDeliveryReceiptRulesData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewVoiceDeliveryReceiptRulesData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ViewVoiceDeliveryReceiptRulesData viewVoiceDeliveryReceiptRulesData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, viewVoiceDeliveryReceiptRulesData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ViewVoiceDeliveryReceiptRulesData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewVoiceDeliveryReceiptRulesData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ViewVoiceDeliveryReceiptRulesData viewVoiceDeliveryReceiptRulesData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (viewVoiceDeliveryReceiptRulesData.DataOption.IsSet && viewVoiceDeliveryReceiptRulesData.Data == null)
                throw new ArgumentNullException(nameof(viewVoiceDeliveryReceiptRulesData.Data), "Property is required for class ViewVoiceDeliveryReceiptRulesData.");

            if (viewVoiceDeliveryReceiptRulesData.TotalOption.IsSet)
                writer.WriteNumber("total", viewVoiceDeliveryReceiptRulesData.TotalOption.Value!.Value);

            if (viewVoiceDeliveryReceiptRulesData.PerPageOption.IsSet)
                writer.WriteNumber("per_page", viewVoiceDeliveryReceiptRulesData.PerPageOption.Value!.Value);

            if (viewVoiceDeliveryReceiptRulesData.CurrentPageOption.IsSet)
                writer.WriteNumber("current_page", viewVoiceDeliveryReceiptRulesData.CurrentPageOption.Value!.Value);

            if (viewVoiceDeliveryReceiptRulesData.LastPageOption.IsSet)
                writer.WriteNumber("last_page", viewVoiceDeliveryReceiptRulesData.LastPageOption.Value!.Value);

            if (viewVoiceDeliveryReceiptRulesData.NextPageUrlOption.IsSet)
                if (viewVoiceDeliveryReceiptRulesData.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", viewVoiceDeliveryReceiptRulesData.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (viewVoiceDeliveryReceiptRulesData.PrevPageUrlOption.IsSet)
                if (viewVoiceDeliveryReceiptRulesData.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", viewVoiceDeliveryReceiptRulesData.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (viewVoiceDeliveryReceiptRulesData.FromOption.IsSet)
                writer.WriteNumber("from", viewVoiceDeliveryReceiptRulesData.FromOption.Value!.Value);

            if (viewVoiceDeliveryReceiptRulesData.ToOption.IsSet)
                writer.WriteNumber("to", viewVoiceDeliveryReceiptRulesData.ToOption.Value!.Value);

            if (viewVoiceDeliveryReceiptRulesData.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, viewVoiceDeliveryReceiptRulesData.Data, jsonSerializerOptions);
            }
        }
    }
}
