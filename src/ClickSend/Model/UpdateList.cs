...
namespace ClickSend.Model
{
    ...
    public partial class UpdateList : IValidatableObject
    {
        ...
        [JsonConstructor]
        public UpdateList(Option<int?> httpCode = default, Option<string?> responseCode = default, Option<string?> responseMsg = default, Option<ContactList?> data = default)
        {
        ...
        /* <example>List #439 has been updated.</example> */
    ...
    public class UpdateListJsonConverter : JsonConverter<UpdateList>
    {
        ...
        public override UpdateList Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (httpCode.IsSet && httpCode.Value == null)
                throw new ArgumentNullException(nameof(httpCode), "Property is not nullable for class UpdateList.");

            if (responseCode.IsSet && responseCode.Value == null)
                throw new ArgumentNullException(nameof(responseCode), "Property is not nullable for class UpdateList.");

            if (responseMsg.IsSet && responseMsg.Value == null)
                throw new ArgumentNullException(nameof(responseMsg), "Property is not nullable for class UpdateList.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class UpdateList.");

            return new UpdateList(httpCode, responseCode, responseMsg, data);
        }
        ...
        {
            if (updateList.ResponseCodeOption.IsSet && updateList.ResponseCode == null)
                throw new ArgumentNullException(nameof(updateList.ResponseCode), "Property is required for class UpdateList.");

            if (updateList.ResponseMsgOption.IsSet && updateList.ResponseMsg == null)
                throw new ArgumentNullException(nameof(updateList.ResponseMsg), "Property is required for class UpdateList.");

            if (updateList.DataOption.IsSet && updateList.Data == null)
                throw new ArgumentNullException(nameof(updateList.Data), "Property is required for class UpdateList.");

            if (updateList.HttpCodeOption.IsSet)
                writer.WriteNumber("http_code", updateList.HttpCodeOption.Value!.Value);

            if (updateList.ResponseCodeOption.IsSet)
                writer.WriteString("response_code", updateList.ResponseCode);

            if (updateList.ResponseMsgOption.IsSet)
                writer.WriteString("response_msg", updateList.ResponseMsg);

            if (updateList.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, updateList.Data, jsonSerializerOptions);
            }
        }
    }
}
