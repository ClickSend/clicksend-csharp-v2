...
namespace ClickSend.Model
{
    ...
    /// </summary>
    public partial class SendEmailVerificationToken : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SendEmailVerificationToken" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public SendEmailVerificationToken(Option<int?> httpCode = default, Option<string?> responseCode = default, Option<string?> responseMsg = default, Option<Object?> data = default)
        {
        ...
        /* <example>Verification email has been sent.</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="SendEmailVerificationToken" />
    /// </summary>
    public class SendEmailVerificationTokenJsonConverter : JsonConverter<SendEmailVerificationToken>
    {
        /// <summary>
        /// Deserializes json to <see cref="SendEmailVerificationToken" />
        /// </summary>
        ...
        public override SendEmailVerificationToken Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (httpCode.IsSet && httpCode.Value == null)
                throw new ArgumentNullException(nameof(httpCode), "Property is not nullable for class SendEmailVerificationToken.");

            if (responseCode.IsSet && responseCode.Value == null)
                throw new ArgumentNullException(nameof(responseCode), "Property is not nullable for class SendEmailVerificationToken.");

            if (responseMsg.IsSet && responseMsg.Value == null)
                throw new ArgumentNullException(nameof(responseMsg), "Property is not nullable for class SendEmailVerificationToken.");

            return new SendEmailVerificationToken(httpCode, responseCode, responseMsg, data);
        }

        /// <summary>
        /// Serializes a <see cref="SendEmailVerificationToken" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="sendEmailVerificationToken"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SendEmailVerificationToken sendEmailVerificationToken, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, sendEmailVerificationToken, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SendEmailVerificationToken" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="sendEmailVerificationToken"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SendEmailVerificationToken sendEmailVerificationToken, JsonSerializerOptions jsonSerializerOptions)
        {
            if (sendEmailVerificationToken.ResponseCodeOption.IsSet && sendEmailVerificationToken.ResponseCode == null)
                throw new ArgumentNullException(nameof(sendEmailVerificationToken.ResponseCode), "Property is required for class SendEmailVerificationToken.");

            if (sendEmailVerificationToken.ResponseMsgOption.IsSet && sendEmailVerificationToken.ResponseMsg == null)
                throw new ArgumentNullException(nameof(sendEmailVerificationToken.ResponseMsg), "Property is required for class SendEmailVerificationToken.");

            if (sendEmailVerificationToken.HttpCodeOption.IsSet)
                writer.WriteNumber("http_code", sendEmailVerificationToken.HttpCodeOption.Value!.Value);

            if (sendEmailVerificationToken.ResponseCodeOption.IsSet)
                writer.WriteString("response_code", sendEmailVerificationToken.ResponseCode);

            if (sendEmailVerificationToken.ResponseMsgOption.IsSet)
                writer.WriteString("response_msg", sendEmailVerificationToken.ResponseMsg);

            if (sendEmailVerificationToken.DataOption.IsSet)
                if (sendEmailVerificationToken.DataOption.Value != null)
                {
                    writer.WritePropertyName("data");
                    JsonSerializer.Serialize(writer, sendEmailVerificationToken.Data, jsonSerializerOptions);
                }
                else
