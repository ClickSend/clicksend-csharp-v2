...
namespace ClickSend.Model
{
    ...
    /// </summary>
    public partial class DeleteFaxDeliveryReceiptRule : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteFaxDeliveryReceiptRule" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public DeleteFaxDeliveryReceiptRule(Option<int?> httpCode = default, Option<string?> responseCode = default, Option<string?> responseMsg = default, Option<Object?> data = default)
        {
        ...
        /* <example>Your rule incoming fax receipt has been deleted.</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="DeleteFaxDeliveryReceiptRule" />
    /// </summary>
    public class DeleteFaxDeliveryReceiptRuleJsonConverter : JsonConverter<DeleteFaxDeliveryReceiptRule>
    {
        /// <summary>
        /// Deserializes json to <see cref="DeleteFaxDeliveryReceiptRule" />
        /// </summary>
        ...
        public override DeleteFaxDeliveryReceiptRule Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (httpCode.IsSet && httpCode.Value == null)
                throw new ArgumentNullException(nameof(httpCode), "Property is not nullable for class DeleteFaxDeliveryReceiptRule.");

            if (responseCode.IsSet && responseCode.Value == null)
                throw new ArgumentNullException(nameof(responseCode), "Property is not nullable for class DeleteFaxDeliveryReceiptRule.");

            if (responseMsg.IsSet && responseMsg.Value == null)
                throw new ArgumentNullException(nameof(responseMsg), "Property is not nullable for class DeleteFaxDeliveryReceiptRule.");

            return new DeleteFaxDeliveryReceiptRule(httpCode, responseCode, responseMsg, data);
        }

        /// <summary>
        /// Serializes a <see cref="DeleteFaxDeliveryReceiptRule" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="deleteFaxDeliveryReceiptRule"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DeleteFaxDeliveryReceiptRule deleteFaxDeliveryReceiptRule, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, deleteFaxDeliveryReceiptRule, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DeleteFaxDeliveryReceiptRule" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="deleteFaxDeliveryReceiptRule"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DeleteFaxDeliveryReceiptRule deleteFaxDeliveryReceiptRule, JsonSerializerOptions jsonSerializerOptions)
        {
            if (deleteFaxDeliveryReceiptRule.ResponseCodeOption.IsSet && deleteFaxDeliveryReceiptRule.ResponseCode == null)
                throw new ArgumentNullException(nameof(deleteFaxDeliveryReceiptRule.ResponseCode), "Property is required for class DeleteFaxDeliveryReceiptRule.");

            if (deleteFaxDeliveryReceiptRule.ResponseMsgOption.IsSet && deleteFaxDeliveryReceiptRule.ResponseMsg == null)
                throw new ArgumentNullException(nameof(deleteFaxDeliveryReceiptRule.ResponseMsg), "Property is required for class DeleteFaxDeliveryReceiptRule.");

            if (deleteFaxDeliveryReceiptRule.HttpCodeOption.IsSet)
                writer.WriteNumber("http_code", deleteFaxDeliveryReceiptRule.HttpCodeOption.Value!.Value);

            if (deleteFaxDeliveryReceiptRule.ResponseCodeOption.IsSet)
                writer.WriteString("response_code", deleteFaxDeliveryReceiptRule.ResponseCode);

            if (deleteFaxDeliveryReceiptRule.ResponseMsgOption.IsSet)
                writer.WriteString("response_msg", deleteFaxDeliveryReceiptRule.ResponseMsg);

            if (deleteFaxDeliveryReceiptRule.DataOption.IsSet)
                if (deleteFaxDeliveryReceiptRule.DataOption.Value != null)
                {
                    writer.WritePropertyName("data");
                    JsonSerializer.Serialize(writer, deleteFaxDeliveryReceiptRule.Data, jsonSerializerOptions);
                }
                else
