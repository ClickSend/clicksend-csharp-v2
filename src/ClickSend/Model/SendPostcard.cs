...
namespace ClickSend.Model
{
    ...
    /// SendPostcard
    /// </summary>
    public partial class SendPostcard : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SendPostcard" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public SendPostcard(Option<int?> httpCode = default, Option<string?> responseCode = default, Option<string?> responseMsg = default, Option<SendPostcardData?> data = default)
        {
        ...
        /* <example>Postcard queued for delivery.</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="SendPostcard" />
    /// </summary>
    public class SendPostcardJsonConverter : JsonConverter<SendPostcard>
    {
        /// <summary>
        /// Deserializes json to <see cref="SendPostcard" />
        /// </summary>
        ...
        public override SendPostcard Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (httpCode.IsSet && httpCode.Value == null)
                throw new ArgumentNullException(nameof(httpCode), "Property is not nullable for class SendPostcard.");

            if (responseCode.IsSet && responseCode.Value == null)
                throw new ArgumentNullException(nameof(responseCode), "Property is not nullable for class SendPostcard.");

            if (responseMsg.IsSet && responseMsg.Value == null)
                throw new ArgumentNullException(nameof(responseMsg), "Property is not nullable for class SendPostcard.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class SendPostcard.");

            return new SendPostcard(httpCode, responseCode, responseMsg, data);
        }

        /// <summary>
        /// Serializes a <see cref="SendPostcard" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="sendPostcard"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SendPostcard sendPostcard, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, sendPostcard, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SendPostcard" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="sendPostcard"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SendPostcard sendPostcard, JsonSerializerOptions jsonSerializerOptions)
        {
            if (sendPostcard.ResponseCodeOption.IsSet && sendPostcard.ResponseCode == null)
                throw new ArgumentNullException(nameof(sendPostcard.ResponseCode), "Property is required for class SendPostcard.");

            if (sendPostcard.ResponseMsgOption.IsSet && sendPostcard.ResponseMsg == null)
                throw new ArgumentNullException(nameof(sendPostcard.ResponseMsg), "Property is required for class SendPostcard.");

            if (sendPostcard.DataOption.IsSet && sendPostcard.Data == null)
                throw new ArgumentNullException(nameof(sendPostcard.Data), "Property is required for class SendPostcard.");

            if (sendPostcard.HttpCodeOption.IsSet)
                writer.WriteNumber("http_code", sendPostcard.HttpCodeOption.Value!.Value);

            if (sendPostcard.ResponseCodeOption.IsSet)
                writer.WriteString("response_code", sendPostcard.ResponseCode);

            if (sendPostcard.ResponseMsgOption.IsSet)
                writer.WriteString("response_msg", sendPostcard.ResponseMsg);

            if (sendPostcard.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, sendPostcard.Data, jsonSerializerOptions);
            }
        }
    }
}
