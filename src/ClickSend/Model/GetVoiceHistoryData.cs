...
namespace ClickSend.Model
{
    ...
    /// GetVoiceHistoryData
    /// </summary>
    public partial class GetVoiceHistoryData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetVoiceHistoryData" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public GetVoiceHistoryData(Option<int?> total = default, Option<int?> perPage = default, Option<int?> currentPage = default, Option<int?> lastPage = default, Option<string?> nextPageUrl = default, Option<string?> prevPageUrl = default, Option<int?> from = default, Option<int?> to = default, Option<List<VoiceMessage>?> data = default)
        {
            TotalOption = total;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<VoiceMessage>?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        [JsonPropertyName("data")]
        public List<VoiceMessage>? Data { get { return this.DataOption.Value; } set { this.DataOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetVoiceHistoryData" />
    /// </summary>
    public class GetVoiceHistoryDataJsonConverter : JsonConverter<GetVoiceHistoryData>
    {
        /// <summary>
        /// Deserializes json to <see cref="GetVoiceHistoryData" />
        /// </summary>
        ...
        public override GetVoiceHistoryData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<VoiceMessage>?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "to":
                            ...
                            break;
                        case "data":
                            data = new Option<List<VoiceMessage>?>(JsonSerializer.Deserialize<List<VoiceMessage>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class GetVoiceHistoryData.");

            if (perPage.IsSet && perPage.Value == null)
                throw new ArgumentNullException(nameof(perPage), "Property is not nullable for class GetVoiceHistoryData.");

            if (currentPage.IsSet && currentPage.Value == null)
                throw new ArgumentNullException(nameof(currentPage), "Property is not nullable for class GetVoiceHistoryData.");

            if (lastPage.IsSet && lastPage.Value == null)
                throw new ArgumentNullException(nameof(lastPage), "Property is not nullable for class GetVoiceHistoryData.");

            if (from.IsSet && from.Value == null)
                throw new ArgumentNullException(nameof(from), "Property is not nullable for class GetVoiceHistoryData.");

            if (to.IsSet && to.Value == null)
                throw new ArgumentNullException(nameof(to), "Property is not nullable for class GetVoiceHistoryData.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class GetVoiceHistoryData.");

            return new GetVoiceHistoryData(total, perPage, currentPage, lastPage, nextPageUrl, prevPageUrl, from, to, data);
        }

        /// <summary>
        /// Serializes a <see cref="GetVoiceHistoryData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getVoiceHistoryData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetVoiceHistoryData getVoiceHistoryData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getVoiceHistoryData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetVoiceHistoryData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getVoiceHistoryData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetVoiceHistoryData getVoiceHistoryData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getVoiceHistoryData.DataOption.IsSet && getVoiceHistoryData.Data == null)
                throw new ArgumentNullException(nameof(getVoiceHistoryData.Data), "Property is required for class GetVoiceHistoryData.");

            if (getVoiceHistoryData.TotalOption.IsSet)
                writer.WriteNumber("total", getVoiceHistoryData.TotalOption.Value!.Value);

            if (getVoiceHistoryData.PerPageOption.IsSet)
                writer.WriteNumber("per_page", getVoiceHistoryData.PerPageOption.Value!.Value);

            if (getVoiceHistoryData.CurrentPageOption.IsSet)
                writer.WriteNumber("current_page", getVoiceHistoryData.CurrentPageOption.Value!.Value);

            if (getVoiceHistoryData.LastPageOption.IsSet)
                writer.WriteNumber("last_page", getVoiceHistoryData.LastPageOption.Value!.Value);

            if (getVoiceHistoryData.NextPageUrlOption.IsSet)
                if (getVoiceHistoryData.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", getVoiceHistoryData.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (getVoiceHistoryData.PrevPageUrlOption.IsSet)
                if (getVoiceHistoryData.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", getVoiceHistoryData.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (getVoiceHistoryData.FromOption.IsSet)
                writer.WriteNumber("from", getVoiceHistoryData.FromOption.Value!.Value);

            if (getVoiceHistoryData.ToOption.IsSet)
                writer.WriteNumber("to", getVoiceHistoryData.ToOption.Value!.Value);

            if (getVoiceHistoryData.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, getVoiceHistoryData.Data, jsonSerializerOptions);
            }
        }
    }
}
