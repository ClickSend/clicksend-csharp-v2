...
namespace ClickSend.Model
{
    ...
    /// ViewAllMmsCampaigns
    /// </summary>
    public partial class ViewAllMmsCampaigns : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="ViewAllMmsCampaigns" />
    /// </summary>
    public class ViewAllMmsCampaignsJsonConverter : JsonConverter<ViewAllMmsCampaigns>
    {
        /// <summary>
        /// Deserializes json to <see cref="ViewAllMmsCampaigns" />
        /// </summary>
        ...
        public override ViewAllMmsCampaigns Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="ViewAllMmsCampaigns" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewAllMmsCampaigns"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ViewAllMmsCampaigns viewAllMmsCampaigns, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, viewAllMmsCampaigns, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ViewAllMmsCampaigns" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewAllMmsCampaigns"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, ViewAllMmsCampaigns viewAllMmsCampaigns, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (viewAllMmsCampaigns.DataOption.IsSet)
            {
                ...
                JsonSerializer.Serialize(writer, viewAllMmsCampaigns.Data, jsonSerializerOptions);
            }
        }
    }
}
