...
namespace ClickSend.Model
{
    ...
    /// ViewInboundSmsData
    /// </summary>
    public partial class ViewInboundSmsData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewInboundSmsData" /> class.
        /// </summary>
        ...
        /// <param name="data">The parameters related to the actual inbound SMS.</param>
        [JsonConstructor]
        public ViewInboundSmsData(Option<int?> total = default, Option<int?> perPage = default, Option<int?> currentPage = default, Option<int?> lastPage = default, Option<string?> nextPageUrl = default, Option<string?> prevPageUrl = default, Option<int?> from = default, Option<int?> to = default, Option<List<InboundSms>?> data = default)
        {
            TotalOption = total;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<InboundSms>?> DataOption { get; private set; }

        /// <summary>
        /// The parameters related to the actual inbound SMS.
        /// </summary>
        /// <value>The parameters related to the actual inbound SMS.</value>
        [JsonPropertyName("data")]
        public List<InboundSms>? Data { get { return this.DataOption.Value; } set { this.DataOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ViewInboundSmsData" />
    /// </summary>
    public class ViewInboundSmsDataJsonConverter : JsonConverter<ViewInboundSmsData>
    {
        /// <summary>
        /// Deserializes json to <see cref="ViewInboundSmsData" />
        /// </summary>
        ...
        public override ViewInboundSmsData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<InboundSms>?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "to":
                            ...
                            break;
                        case "data":
                            data = new Option<List<InboundSms>?>(JsonSerializer.Deserialize<List<InboundSms>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class ViewInboundSmsData.");

            if (perPage.IsSet && perPage.Value == null)
                throw new ArgumentNullException(nameof(perPage), "Property is not nullable for class ViewInboundSmsData.");

            if (currentPage.IsSet && currentPage.Value == null)
                throw new ArgumentNullException(nameof(currentPage), "Property is not nullable for class ViewInboundSmsData.");

            if (lastPage.IsSet && lastPage.Value == null)
                throw new ArgumentNullException(nameof(lastPage), "Property is not nullable for class ViewInboundSmsData.");

            if (from.IsSet && from.Value == null)
                throw new ArgumentNullException(nameof(from), "Property is not nullable for class ViewInboundSmsData.");

            if (to.IsSet && to.Value == null)
                throw new ArgumentNullException(nameof(to), "Property is not nullable for class ViewInboundSmsData.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ViewInboundSmsData.");

            return new ViewInboundSmsData(total, perPage, currentPage, lastPage, nextPageUrl, prevPageUrl, from, to, data);
        }

        /// <summary>
        /// Serializes a <see cref="ViewInboundSmsData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewInboundSmsData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ViewInboundSmsData viewInboundSmsData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, viewInboundSmsData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ViewInboundSmsData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewInboundSmsData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ViewInboundSmsData viewInboundSmsData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (viewInboundSmsData.DataOption.IsSet && viewInboundSmsData.Data == null)
                throw new ArgumentNullException(nameof(viewInboundSmsData.Data), "Property is required for class ViewInboundSmsData.");

            if (viewInboundSmsData.TotalOption.IsSet)
                writer.WriteNumber("total", viewInboundSmsData.TotalOption.Value!.Value);

            if (viewInboundSmsData.PerPageOption.IsSet)
                writer.WriteNumber("per_page", viewInboundSmsData.PerPageOption.Value!.Value);

            if (viewInboundSmsData.CurrentPageOption.IsSet)
                writer.WriteNumber("current_page", viewInboundSmsData.CurrentPageOption.Value!.Value);

            if (viewInboundSmsData.LastPageOption.IsSet)
                writer.WriteNumber("last_page", viewInboundSmsData.LastPageOption.Value!.Value);

            if (viewInboundSmsData.NextPageUrlOption.IsSet)
                if (viewInboundSmsData.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", viewInboundSmsData.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (viewInboundSmsData.PrevPageUrlOption.IsSet)
                if (viewInboundSmsData.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", viewInboundSmsData.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (viewInboundSmsData.FromOption.IsSet)
                writer.WriteNumber("from", viewInboundSmsData.FromOption.Value!.Value);

            if (viewInboundSmsData.ToOption.IsSet)
                writer.WriteNumber("to", viewInboundSmsData.ToOption.Value!.Value);

            if (viewInboundSmsData.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, viewInboundSmsData.Data, jsonSerializerOptions);
            }
        }
    }
}
