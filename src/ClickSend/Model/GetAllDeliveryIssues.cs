...
namespace ClickSend.Model
{
    ...
    /// </summary>
    public partial class GetAllDeliveryIssues : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAllDeliveryIssues" /> class.
        /// </summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="GetAllDeliveryIssues" />
    /// </summary>
    public class GetAllDeliveryIssuesJsonConverter : JsonConverter<GetAllDeliveryIssues>
    {
        /// <summary>
        /// Deserializes json to <see cref="GetAllDeliveryIssues" />
        /// </summary>
        ...
        public override GetAllDeliveryIssues Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (httpCode.IsSet && httpCode.Value == null)
                throw new ArgumentNullException(nameof(httpCode), "Property is not nullable for class GetAllDeliveryIssues.");

            if (responseCode.IsSet && responseCode.Value == null)
                throw new ArgumentNullException(nameof(responseCode), "Property is not nullable for class GetAllDeliveryIssues.");

            if (responseMsg.IsSet && responseMsg.Value == null)
                throw new ArgumentNullException(nameof(responseMsg), "Property is not nullable for class GetAllDeliveryIssues.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class GetAllDeliveryIssues.");

            return new GetAllDeliveryIssues(httpCode, responseCode, responseMsg, data);
        }

        /// <summary>
        /// Serializes a <see cref="GetAllDeliveryIssues" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getAllDeliveryIssues"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GetAllDeliveryIssues getAllDeliveryIssues, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, getAllDeliveryIssues, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetAllDeliveryIssues" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getAllDeliveryIssues"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GetAllDeliveryIssues getAllDeliveryIssues, JsonSerializerOptions jsonSerializerOptions)
        {
            if (getAllDeliveryIssues.ResponseCodeOption.IsSet && getAllDeliveryIssues.ResponseCode == null)
                throw new ArgumentNullException(nameof(getAllDeliveryIssues.ResponseCode), "Property is required for class GetAllDeliveryIssues.");

            if (getAllDeliveryIssues.ResponseMsgOption.IsSet && getAllDeliveryIssues.ResponseMsg == null)
                throw new ArgumentNullException(nameof(getAllDeliveryIssues.ResponseMsg), "Property is required for class GetAllDeliveryIssues.");

            if (getAllDeliveryIssues.DataOption.IsSet && getAllDeliveryIssues.Data == null)
                throw new ArgumentNullException(nameof(getAllDeliveryIssues.Data), "Property is required for class GetAllDeliveryIssues.");

            if (getAllDeliveryIssues.HttpCodeOption.IsSet)
                writer.WriteNumber("http_code", getAllDeliveryIssues.HttpCodeOption.Value!.Value);

            if (getAllDeliveryIssues.ResponseCodeOption.IsSet)
                writer.WriteString("response_code", getAllDeliveryIssues.ResponseCode);

            if (getAllDeliveryIssues.ResponseMsgOption.IsSet)
                writer.WriteString("response_msg", getAllDeliveryIssues.ResponseMsg);

            if (getAllDeliveryIssues.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, getAllDeliveryIssues.Data, jsonSerializerOptions);
            }
        }
    }
}
