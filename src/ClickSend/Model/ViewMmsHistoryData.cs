...
namespace ClickSend.Model
{
    ...
    /// ViewMmsHistoryData
    /// </summary>
    public partial class ViewMmsHistoryData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewMmsHistoryData" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ViewMmsHistoryData(Option<int?> total = default, Option<int?> perPage = default, Option<int?> currentPage = default, Option<int?> lastPage = default, Option<string?> nextPageUrl = default, Option<string?> prevPageUrl = default, Option<int?> from = default, Option<int?> to = default, Option<List<ViewMmsHistoryDataAllOfDataInner>?> data = default)
        {
            TotalOption = total;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<ViewMmsHistoryDataAllOfDataInner>?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        [JsonPropertyName("data")]
        public List<ViewMmsHistoryDataAllOfDataInner>? Data { get { return this.DataOption.Value; } set { this.DataOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ViewMmsHistoryData" />
    /// </summary>
    public class ViewMmsHistoryDataJsonConverter : JsonConverter<ViewMmsHistoryData>
    {
        /// <summary>
        /// Deserializes json to <see cref="ViewMmsHistoryData" />
        /// </summary>
        ...
        public override ViewMmsHistoryData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<ViewMmsHistoryDataAllOfDataInner>?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "to":
                            ...
                            break;
                        case "data":
                            data = new Option<List<ViewMmsHistoryDataAllOfDataInner>?>(JsonSerializer.Deserialize<List<ViewMmsHistoryDataAllOfDataInner>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class ViewMmsHistoryData.");

            if (perPage.IsSet && perPage.Value == null)
                throw new ArgumentNullException(nameof(perPage), "Property is not nullable for class ViewMmsHistoryData.");

            if (currentPage.IsSet && currentPage.Value == null)
                throw new ArgumentNullException(nameof(currentPage), "Property is not nullable for class ViewMmsHistoryData.");

            if (lastPage.IsSet && lastPage.Value == null)
                throw new ArgumentNullException(nameof(lastPage), "Property is not nullable for class ViewMmsHistoryData.");

            if (from.IsSet && from.Value == null)
                throw new ArgumentNullException(nameof(from), "Property is not nullable for class ViewMmsHistoryData.");

            if (to.IsSet && to.Value == null)
                throw new ArgumentNullException(nameof(to), "Property is not nullable for class ViewMmsHistoryData.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ViewMmsHistoryData.");

            return new ViewMmsHistoryData(total, perPage, currentPage, lastPage, nextPageUrl, prevPageUrl, from, to, data);
        }

        /// <summary>
        /// Serializes a <see cref="ViewMmsHistoryData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewMmsHistoryData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ViewMmsHistoryData viewMmsHistoryData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, viewMmsHistoryData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ViewMmsHistoryData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewMmsHistoryData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ViewMmsHistoryData viewMmsHistoryData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (viewMmsHistoryData.DataOption.IsSet && viewMmsHistoryData.Data == null)
                throw new ArgumentNullException(nameof(viewMmsHistoryData.Data), "Property is required for class ViewMmsHistoryData.");

            if (viewMmsHistoryData.TotalOption.IsSet)
                writer.WriteNumber("total", viewMmsHistoryData.TotalOption.Value!.Value);

            if (viewMmsHistoryData.PerPageOption.IsSet)
                writer.WriteNumber("per_page", viewMmsHistoryData.PerPageOption.Value!.Value);

            if (viewMmsHistoryData.CurrentPageOption.IsSet)
                writer.WriteNumber("current_page", viewMmsHistoryData.CurrentPageOption.Value!.Value);

            if (viewMmsHistoryData.LastPageOption.IsSet)
                writer.WriteNumber("last_page", viewMmsHistoryData.LastPageOption.Value!.Value);

            if (viewMmsHistoryData.NextPageUrlOption.IsSet)
                if (viewMmsHistoryData.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", viewMmsHistoryData.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (viewMmsHistoryData.PrevPageUrlOption.IsSet)
                if (viewMmsHistoryData.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", viewMmsHistoryData.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (viewMmsHistoryData.FromOption.IsSet)
                writer.WriteNumber("from", viewMmsHistoryData.FromOption.Value!.Value);

            if (viewMmsHistoryData.ToOption.IsSet)
                writer.WriteNumber("to", viewMmsHistoryData.ToOption.Value!.Value);

            if (viewMmsHistoryData.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, viewMmsHistoryData.Data, jsonSerializerOptions);
            }
        }
    }
}
