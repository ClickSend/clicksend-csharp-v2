...
namespace ClickSend.Model
{
    ...
    /// </summary>
    public partial class ViewAllowedEmailAddressesData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewAllowedEmailAddressesData" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ViewAllowedEmailAddressesData(Option<int?> total = default, Option<int?> perPage = default, Option<int?> currentPage = default, Option<int?> lastPage = default, Option<string?> nextPageUrl = default, Option<string?> prevPageUrl = default, Option<int?> from = default, Option<int?> to = default, Option<List<EmailAddress>?> data = default)
        {
            TotalOption = total;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<EmailAddress>?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        /* <example>[{&quot;email_address_id&quot;:2,&quot;email_address&quot;:&quot;test@user.com&quot;,&quot;verified&quot;:1,&quot;date_added&quot;:&quot;1447736880&quot;},{&quot;email_address_id&quot;:3,&quot;email_address&quot;:&quot;test2@user.com&quot;,&quot;verified&quot;:0,&quot;date_added&quot;:&quot;1449042967&quot;}]</example> */
        [JsonPropertyName("data")]
        public List<EmailAddress>? Data { get { return this.DataOption.Value; } set { this.DataOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ViewAllowedEmailAddressesData" />
    /// </summary>
    public class ViewAllowedEmailAddressesDataJsonConverter : JsonConverter<ViewAllowedEmailAddressesData>
    {
        /// <summary>
        /// Deserializes json to <see cref="ViewAllowedEmailAddressesData" />
        /// </summary>
        ...
        public override ViewAllowedEmailAddressesData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<EmailAddress>?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "to":
                            ...
                            break;
                        case "data":
                            data = new Option<List<EmailAddress>?>(JsonSerializer.Deserialize<List<EmailAddress>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class ViewAllowedEmailAddressesData.");

            if (perPage.IsSet && perPage.Value == null)
                throw new ArgumentNullException(nameof(perPage), "Property is not nullable for class ViewAllowedEmailAddressesData.");

            if (currentPage.IsSet && currentPage.Value == null)
                throw new ArgumentNullException(nameof(currentPage), "Property is not nullable for class ViewAllowedEmailAddressesData.");

            if (lastPage.IsSet && lastPage.Value == null)
                throw new ArgumentNullException(nameof(lastPage), "Property is not nullable for class ViewAllowedEmailAddressesData.");

            if (from.IsSet && from.Value == null)
                throw new ArgumentNullException(nameof(from), "Property is not nullable for class ViewAllowedEmailAddressesData.");

            if (to.IsSet && to.Value == null)
                throw new ArgumentNullException(nameof(to), "Property is not nullable for class ViewAllowedEmailAddressesData.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ViewAllowedEmailAddressesData.");

            return new ViewAllowedEmailAddressesData(total, perPage, currentPage, lastPage, nextPageUrl, prevPageUrl, from, to, data);
        }

        /// <summary>
        /// Serializes a <see cref="ViewAllowedEmailAddressesData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewAllowedEmailAddressesData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ViewAllowedEmailAddressesData viewAllowedEmailAddressesData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, viewAllowedEmailAddressesData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ViewAllowedEmailAddressesData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewAllowedEmailAddressesData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ViewAllowedEmailAddressesData viewAllowedEmailAddressesData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (viewAllowedEmailAddressesData.DataOption.IsSet && viewAllowedEmailAddressesData.Data == null)
                throw new ArgumentNullException(nameof(viewAllowedEmailAddressesData.Data), "Property is required for class ViewAllowedEmailAddressesData.");

            if (viewAllowedEmailAddressesData.TotalOption.IsSet)
                writer.WriteNumber("total", viewAllowedEmailAddressesData.TotalOption.Value!.Value);

            if (viewAllowedEmailAddressesData.PerPageOption.IsSet)
                writer.WriteNumber("per_page", viewAllowedEmailAddressesData.PerPageOption.Value!.Value);

            if (viewAllowedEmailAddressesData.CurrentPageOption.IsSet)
                writer.WriteNumber("current_page", viewAllowedEmailAddressesData.CurrentPageOption.Value!.Value);

            if (viewAllowedEmailAddressesData.LastPageOption.IsSet)
                writer.WriteNumber("last_page", viewAllowedEmailAddressesData.LastPageOption.Value!.Value);

            if (viewAllowedEmailAddressesData.NextPageUrlOption.IsSet)
                if (viewAllowedEmailAddressesData.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", viewAllowedEmailAddressesData.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (viewAllowedEmailAddressesData.PrevPageUrlOption.IsSet)
                if (viewAllowedEmailAddressesData.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", viewAllowedEmailAddressesData.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (viewAllowedEmailAddressesData.FromOption.IsSet)
                writer.WriteNumber("from", viewAllowedEmailAddressesData.FromOption.Value!.Value);

            if (viewAllowedEmailAddressesData.ToOption.IsSet)
                writer.WriteNumber("to", viewAllowedEmailAddressesData.ToOption.Value!.Value);

            if (viewAllowedEmailAddressesData.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, viewAllowedEmailAddressesData.Data, jsonSerializerOptions);
            }
        }
    }
}
