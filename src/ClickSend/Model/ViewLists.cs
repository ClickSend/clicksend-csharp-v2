...
namespace ClickSend.Model
{
    ...
    /// ViewLists
    /// </summary>
    public partial class ViewLists : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewLists" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ViewLists(Option<int?> httpCode = default, Option<string?> responseCode = default, Option<string?> responseMsg = default, Option<ViewListsData?> data = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<ViewListsData?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        [JsonPropertyName("data")]
        public ViewListsData? Data { get { return this.DataOption.Value; } set { this.DataOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ViewLists" />
    /// </summary>
    public class ViewListsJsonConverter : JsonConverter<ViewLists>
    {
        /// <summary>
        /// Deserializes json to <see cref="ViewLists" />
        /// </summary>
        ...
        public override ViewLists Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<ViewListsData?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "response_msg":
                            ...
                            break;
                        case "data":
                            data = new Option<ViewListsData?>(JsonSerializer.Deserialize<ViewListsData>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (httpCode.IsSet && httpCode.Value == null)
                throw new ArgumentNullException(nameof(httpCode), "Property is not nullable for class ViewLists.");

            if (responseCode.IsSet && responseCode.Value == null)
                throw new ArgumentNullException(nameof(responseCode), "Property is not nullable for class ViewLists.");

            if (responseMsg.IsSet && responseMsg.Value == null)
                throw new ArgumentNullException(nameof(responseMsg), "Property is not nullable for class ViewLists.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ViewLists.");

            return new ViewLists(httpCode, responseCode, responseMsg, data);
        }

        /// <summary>
        /// Serializes a <see cref="ViewLists" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewLists"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ViewLists viewLists, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, viewLists, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ViewLists" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewLists"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ViewLists viewLists, JsonSerializerOptions jsonSerializerOptions)
        {
            if (viewLists.ResponseCodeOption.IsSet && viewLists.ResponseCode == null)
                throw new ArgumentNullException(nameof(viewLists.ResponseCode), "Property is required for class ViewLists.");

            if (viewLists.ResponseMsgOption.IsSet && viewLists.ResponseMsg == null)
                throw new ArgumentNullException(nameof(viewLists.ResponseMsg), "Property is required for class ViewLists.");

            if (viewLists.DataOption.IsSet && viewLists.Data == null)
                throw new ArgumentNullException(nameof(viewLists.Data), "Property is required for class ViewLists.");

            if (viewLists.HttpCodeOption.IsSet)
                writer.WriteNumber("http_code", viewLists.HttpCodeOption.Value!.Value);

            if (viewLists.ResponseCodeOption.IsSet)
                writer.WriteString("response_code", viewLists.ResponseCode);

            if (viewLists.ResponseMsgOption.IsSet)
                writer.WriteString("response_msg", viewLists.ResponseMsg);

            if (viewLists.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, viewLists.Data, jsonSerializerOptions);
            }
        }
    }
}
