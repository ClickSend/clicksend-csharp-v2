...
namespace ClickSend.Model
{
    ...
    /// </summary>
    public partial class ViewAllowedEmailsData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewAllowedEmailsData" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ViewAllowedEmailsData(Option<int?> total = default, Option<int?> perPage = default, Option<int?> currentPage = default, Option<int?> lastPage = default, Option<string?> nextPageUrl = default, Option<string?> prevPageUrl = default, Option<int?> from = default, Option<int?> to = default, Option<List<ViewAllowedEmailsDataAllOfDataInner>?> data = default)
        {
            TotalOption = total;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<ViewAllowedEmailsDataAllOfDataInner>?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        /* <example>[{&quot;email_address_id&quot;:84,&quot;email_address&quot;:&quot;my@email.com&quot;,&quot;from&quot;:&quot;+13523944199&quot;,&quot;subaccount_id&quot;:345789,&quot;from_fax&quot;:&quot;&quot;,&quot;voice&quot;:&quot;male&quot;,&quot;lang&quot;:&quot;en-us&quot;,&quot;_subaccount_name&quot;:&quot;my@email.com&quot;},{&quot;email_address_id&quot;:85,&quot;email_address&quot;:&quot;my@email.com&quot;,&quot;from&quot;:&quot;+13523944199&quot;,&quot;subaccount_id&quot;:345789,&quot;from_fax&quot;:&quot;&quot;,&quot;voice&quot;:&quot;male&quot;,&quot;lang&quot;:&quot;en-us&quot;,&quot;_subaccount_name&quot;:&quot;my@email.com&quot;}]</example> */
        [JsonPropertyName("data")]
        public List<ViewAllowedEmailsDataAllOfDataInner>? Data { get { return this.DataOption.Value; } set { this.DataOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ViewAllowedEmailsData" />
    /// </summary>
    public class ViewAllowedEmailsDataJsonConverter : JsonConverter<ViewAllowedEmailsData>
    {
        /// <summary>
        /// Deserializes json to <see cref="ViewAllowedEmailsData" />
        /// </summary>
        ...
        public override ViewAllowedEmailsData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<ViewAllowedEmailsDataAllOfDataInner>?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "to":
                            ...
                            break;
                        case "data":
                            data = new Option<List<ViewAllowedEmailsDataAllOfDataInner>?>(JsonSerializer.Deserialize<List<ViewAllowedEmailsDataAllOfDataInner>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class ViewAllowedEmailsData.");

            if (perPage.IsSet && perPage.Value == null)
                throw new ArgumentNullException(nameof(perPage), "Property is not nullable for class ViewAllowedEmailsData.");

            if (currentPage.IsSet && currentPage.Value == null)
                throw new ArgumentNullException(nameof(currentPage), "Property is not nullable for class ViewAllowedEmailsData.");

            if (lastPage.IsSet && lastPage.Value == null)
                throw new ArgumentNullException(nameof(lastPage), "Property is not nullable for class ViewAllowedEmailsData.");

            if (from.IsSet && from.Value == null)
                throw new ArgumentNullException(nameof(from), "Property is not nullable for class ViewAllowedEmailsData.");

            if (to.IsSet && to.Value == null)
                throw new ArgumentNullException(nameof(to), "Property is not nullable for class ViewAllowedEmailsData.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ViewAllowedEmailsData.");

            return new ViewAllowedEmailsData(total, perPage, currentPage, lastPage, nextPageUrl, prevPageUrl, from, to, data);
        }

        /// <summary>
        /// Serializes a <see cref="ViewAllowedEmailsData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewAllowedEmailsData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ViewAllowedEmailsData viewAllowedEmailsData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, viewAllowedEmailsData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ViewAllowedEmailsData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewAllowedEmailsData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ViewAllowedEmailsData viewAllowedEmailsData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (viewAllowedEmailsData.DataOption.IsSet && viewAllowedEmailsData.Data == null)
                throw new ArgumentNullException(nameof(viewAllowedEmailsData.Data), "Property is required for class ViewAllowedEmailsData.");

            if (viewAllowedEmailsData.TotalOption.IsSet)
                writer.WriteNumber("total", viewAllowedEmailsData.TotalOption.Value!.Value);

            if (viewAllowedEmailsData.PerPageOption.IsSet)
                writer.WriteNumber("per_page", viewAllowedEmailsData.PerPageOption.Value!.Value);

            if (viewAllowedEmailsData.CurrentPageOption.IsSet)
                writer.WriteNumber("current_page", viewAllowedEmailsData.CurrentPageOption.Value!.Value);

            if (viewAllowedEmailsData.LastPageOption.IsSet)
                writer.WriteNumber("last_page", viewAllowedEmailsData.LastPageOption.Value!.Value);

            if (viewAllowedEmailsData.NextPageUrlOption.IsSet)
                if (viewAllowedEmailsData.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", viewAllowedEmailsData.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (viewAllowedEmailsData.PrevPageUrlOption.IsSet)
                if (viewAllowedEmailsData.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", viewAllowedEmailsData.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (viewAllowedEmailsData.FromOption.IsSet)
                writer.WriteNumber("from", viewAllowedEmailsData.FromOption.Value!.Value);

            if (viewAllowedEmailsData.ToOption.IsSet)
                writer.WriteNumber("to", viewAllowedEmailsData.ToOption.Value!.Value);

            if (viewAllowedEmailsData.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, viewAllowedEmailsData.Data, jsonSerializerOptions);
            }
        }
    }
}
