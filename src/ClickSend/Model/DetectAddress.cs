...
namespace ClickSend.Model
{
    ...
    /// DetectAddress
    /// </summary>
    public partial class DetectAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DetectAddress" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public DetectAddress(Option<int?> httpCode = default, Option<string?> responseCode = default, Option<string?> responseMsg = default, Option<DetectAddressData?> data = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<DetectAddressData?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        [JsonPropertyName("data")]
        public DetectAddressData? Data { get { return this.DataOption.Value; } set { this.DataOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="DetectAddress" />
    /// </summary>
    public class DetectAddressJsonConverter : JsonConverter<DetectAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="DetectAddress" />
        /// </summary>
        ...
        public override DetectAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<DetectAddressData?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "response_msg":
                            ...
                            break;
                        case "data":
                            data = new Option<DetectAddressData?>(JsonSerializer.Deserialize<DetectAddressData>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (httpCode.IsSet && httpCode.Value == null)
                throw new ArgumentNullException(nameof(httpCode), "Property is not nullable for class DetectAddress.");

            if (responseCode.IsSet && responseCode.Value == null)
                throw new ArgumentNullException(nameof(responseCode), "Property is not nullable for class DetectAddress.");

            if (responseMsg.IsSet && responseMsg.Value == null)
                throw new ArgumentNullException(nameof(responseMsg), "Property is not nullable for class DetectAddress.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class DetectAddress.");

            return new DetectAddress(httpCode, responseCode, responseMsg, data);
        }

        /// <summary>
        /// Serializes a <see cref="DetectAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="detectAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DetectAddress detectAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, detectAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DetectAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="detectAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DetectAddress detectAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (detectAddress.ResponseCodeOption.IsSet && detectAddress.ResponseCode == null)
                throw new ArgumentNullException(nameof(detectAddress.ResponseCode), "Property is required for class DetectAddress.");

            if (detectAddress.ResponseMsgOption.IsSet && detectAddress.ResponseMsg == null)
                throw new ArgumentNullException(nameof(detectAddress.ResponseMsg), "Property is required for class DetectAddress.");

            if (detectAddress.DataOption.IsSet && detectAddress.Data == null)
                throw new ArgumentNullException(nameof(detectAddress.Data), "Property is required for class DetectAddress.");

            if (detectAddress.HttpCodeOption.IsSet)
                writer.WriteNumber("http_code", detectAddress.HttpCodeOption.Value!.Value);

            if (detectAddress.ResponseCodeOption.IsSet)
                writer.WriteString("response_code", detectAddress.ResponseCode);

            if (detectAddress.ResponseMsgOption.IsSet)
                writer.WriteString("response_msg", detectAddress.ResponseMsg);

            if (detectAddress.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, detectAddress.Data, jsonSerializerOptions);
            }
        }
    }
}
