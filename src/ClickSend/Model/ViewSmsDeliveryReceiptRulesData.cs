...
namespace ClickSend.Model
{
    ...
    /// </summary>
    public partial class ViewSmsDeliveryReceiptRulesData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewSmsDeliveryReceiptRulesData" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ViewSmsDeliveryReceiptRulesData(Option<int?> total = default, Option<int?> perPage = default, Option<int?> currentPage = default, Option<int?> lastPage = default, Option<string?> nextPageUrl = default, Option<string?> prevPageUrl = default, Option<int?> from = default, Option<int?> to = default, Option<List<SmsDeliveryReceiptRule>?> data = default)
        {
            TotalOption = total;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<SmsDeliveryReceiptRule>?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        /* <example>[{&quot;receipt_rule_id&quot;:5,&quot;rule_name&quot;:&quot;My Rule&quot;,&quot;match_type&quot;:0,&quot;action&quot;:&quot;EMAIL_FIXED&quot;,&quot;action_address&quot;:&quot;john@doe.com&quot;,&quot;enabled&quot;:0},{&quot;receipt_rule_id&quot;:6,&quot;rule_name&quot;:&quot;My Rule&quot;,&quot;match_type&quot;:0,&quot;action&quot;:&quot;EMAIL_FIXED&quot;,&quot;action_address&quot;:&quot;john@doe.com&quot;,&quot;enabled&quot;:1},{&quot;receipt_rule_id&quot;:7,&quot;rule_name&quot;:&quot;My Rule&quot;,&quot;match_type&quot;:0,&quot;action&quot;:&quot;EMAIL_FIXED&quot;,&quot;action_address&quot;:&quot;john@doe.com&quot;,&quot;enabled&quot;:1},{&quot;receipt_rule_id&quot;:8,&quot;rule_name&quot;:&quot;My Rule&quot;,&quot;match_type&quot;:0,&quot;action&quot;:&quot;SMS&quot;,&quot;action_address&quot;:&quot;+61298441484&quot;,&quot;enabled&quot;:1},{&quot;receipt_rule_id&quot;:9,&quot;rule_name&quot;:&quot;My Rule&quot;,&quot;match_type&quot;:0,&quot;action&quot;:&quot;URL&quot;,&quot;action_address&quot;:&quot;+61298441485&quot;,&quot;enabled&quot;:1}]</example> */
        [JsonPropertyName("data")]
        public List<SmsDeliveryReceiptRule>? Data { get { return this.DataOption.Value; } set { this.DataOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ViewSmsDeliveryReceiptRulesData" />
    /// </summary>
    public class ViewSmsDeliveryReceiptRulesDataJsonConverter : JsonConverter<ViewSmsDeliveryReceiptRulesData>
    {
        /// <summary>
        /// Deserializes json to <see cref="ViewSmsDeliveryReceiptRulesData" />
        /// </summary>
        ...
        public override ViewSmsDeliveryReceiptRulesData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<SmsDeliveryReceiptRule>?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "to":
                            ...
                            break;
                        case "data":
                            data = new Option<List<SmsDeliveryReceiptRule>?>(JsonSerializer.Deserialize<List<SmsDeliveryReceiptRule>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class ViewSmsDeliveryReceiptRulesData.");

            if (perPage.IsSet && perPage.Value == null)
                throw new ArgumentNullException(nameof(perPage), "Property is not nullable for class ViewSmsDeliveryReceiptRulesData.");

            if (currentPage.IsSet && currentPage.Value == null)
                throw new ArgumentNullException(nameof(currentPage), "Property is not nullable for class ViewSmsDeliveryReceiptRulesData.");

            if (lastPage.IsSet && lastPage.Value == null)
                throw new ArgumentNullException(nameof(lastPage), "Property is not nullable for class ViewSmsDeliveryReceiptRulesData.");

            if (from.IsSet && from.Value == null)
                throw new ArgumentNullException(nameof(from), "Property is not nullable for class ViewSmsDeliveryReceiptRulesData.");

            if (to.IsSet && to.Value == null)
                throw new ArgumentNullException(nameof(to), "Property is not nullable for class ViewSmsDeliveryReceiptRulesData.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ViewSmsDeliveryReceiptRulesData.");

            return new ViewSmsDeliveryReceiptRulesData(total, perPage, currentPage, lastPage, nextPageUrl, prevPageUrl, from, to, data);
        }

        /// <summary>
        /// Serializes a <see cref="ViewSmsDeliveryReceiptRulesData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewSmsDeliveryReceiptRulesData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ViewSmsDeliveryReceiptRulesData viewSmsDeliveryReceiptRulesData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, viewSmsDeliveryReceiptRulesData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ViewSmsDeliveryReceiptRulesData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewSmsDeliveryReceiptRulesData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ViewSmsDeliveryReceiptRulesData viewSmsDeliveryReceiptRulesData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (viewSmsDeliveryReceiptRulesData.DataOption.IsSet && viewSmsDeliveryReceiptRulesData.Data == null)
                throw new ArgumentNullException(nameof(viewSmsDeliveryReceiptRulesData.Data), "Property is required for class ViewSmsDeliveryReceiptRulesData.");

            if (viewSmsDeliveryReceiptRulesData.TotalOption.IsSet)
                writer.WriteNumber("total", viewSmsDeliveryReceiptRulesData.TotalOption.Value!.Value);

            if (viewSmsDeliveryReceiptRulesData.PerPageOption.IsSet)
                writer.WriteNumber("per_page", viewSmsDeliveryReceiptRulesData.PerPageOption.Value!.Value);

            if (viewSmsDeliveryReceiptRulesData.CurrentPageOption.IsSet)
                writer.WriteNumber("current_page", viewSmsDeliveryReceiptRulesData.CurrentPageOption.Value!.Value);

            if (viewSmsDeliveryReceiptRulesData.LastPageOption.IsSet)
                writer.WriteNumber("last_page", viewSmsDeliveryReceiptRulesData.LastPageOption.Value!.Value);

            if (viewSmsDeliveryReceiptRulesData.NextPageUrlOption.IsSet)
                if (viewSmsDeliveryReceiptRulesData.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", viewSmsDeliveryReceiptRulesData.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (viewSmsDeliveryReceiptRulesData.PrevPageUrlOption.IsSet)
                if (viewSmsDeliveryReceiptRulesData.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", viewSmsDeliveryReceiptRulesData.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (viewSmsDeliveryReceiptRulesData.FromOption.IsSet)
                writer.WriteNumber("from", viewSmsDeliveryReceiptRulesData.FromOption.Value!.Value);

            if (viewSmsDeliveryReceiptRulesData.ToOption.IsSet)
                writer.WriteNumber("to", viewSmsDeliveryReceiptRulesData.ToOption.Value!.Value);

            if (viewSmsDeliveryReceiptRulesData.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, viewSmsDeliveryReceiptRulesData.Data, jsonSerializerOptions);
            }
        }
    }
}
