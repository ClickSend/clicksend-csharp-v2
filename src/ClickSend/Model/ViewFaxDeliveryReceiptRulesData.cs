...
namespace ClickSend.Model
{
    ...
    /// </summary>
    public partial class ViewFaxDeliveryReceiptRulesData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewFaxDeliveryReceiptRulesData" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ViewFaxDeliveryReceiptRulesData(Option<int?> total = default, Option<int?> perPage = default, Option<int?> currentPage = default, Option<int?> lastPage = default, Option<string?> nextPageUrl = default, Option<string?> prevPageUrl = default, Option<int?> from = default, Option<int?> to = default, Option<List<FaxDeliveryReceiptRule>?> data = default)
        {
            TotalOption = total;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<FaxDeliveryReceiptRule>?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        /* <example>[{&quot;receipt_rule_id&quot;:1,&quot;rule_name&quot;:&quot;Email Test Rule&quot;,&quot;match_type&quot;:0,&quot;action&quot;:&quot;URL&quot;,&quot;action_address&quot;:&quot;http://yourdomain.com&quot;,&quot;enabled&quot;:1},{&quot;receipt_rule_id&quot;:2,&quot;rule_name&quot;:&quot;test&quot;,&quot;match_type&quot;:0,&quot;action&quot;:&quot;URL&quot;,&quot;action_address&quot;:&quot;http://yourdomain.com&quot;,&quot;enabled&quot;:1}]</example> */
        [JsonPropertyName("data")]
        public List<FaxDeliveryReceiptRule>? Data { get { return this.DataOption.Value; } set { this.DataOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ViewFaxDeliveryReceiptRulesData" />
    /// </summary>
    public class ViewFaxDeliveryReceiptRulesDataJsonConverter : JsonConverter<ViewFaxDeliveryReceiptRulesData>
    {
        /// <summary>
        /// Deserializes json to <see cref="ViewFaxDeliveryReceiptRulesData" />
        /// </summary>
        ...
        public override ViewFaxDeliveryReceiptRulesData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<FaxDeliveryReceiptRule>?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "to":
                            ...
                            break;
                        case "data":
                            data = new Option<List<FaxDeliveryReceiptRule>?>(JsonSerializer.Deserialize<List<FaxDeliveryReceiptRule>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class ViewFaxDeliveryReceiptRulesData.");

            if (perPage.IsSet && perPage.Value == null)
                throw new ArgumentNullException(nameof(perPage), "Property is not nullable for class ViewFaxDeliveryReceiptRulesData.");

            if (currentPage.IsSet && currentPage.Value == null)
                throw new ArgumentNullException(nameof(currentPage), "Property is not nullable for class ViewFaxDeliveryReceiptRulesData.");

            if (lastPage.IsSet && lastPage.Value == null)
                throw new ArgumentNullException(nameof(lastPage), "Property is not nullable for class ViewFaxDeliveryReceiptRulesData.");

            if (from.IsSet && from.Value == null)
                throw new ArgumentNullException(nameof(from), "Property is not nullable for class ViewFaxDeliveryReceiptRulesData.");

            if (to.IsSet && to.Value == null)
                throw new ArgumentNullException(nameof(to), "Property is not nullable for class ViewFaxDeliveryReceiptRulesData.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ViewFaxDeliveryReceiptRulesData.");

            return new ViewFaxDeliveryReceiptRulesData(total, perPage, currentPage, lastPage, nextPageUrl, prevPageUrl, from, to, data);
        }

        /// <summary>
        /// Serializes a <see cref="ViewFaxDeliveryReceiptRulesData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewFaxDeliveryReceiptRulesData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ViewFaxDeliveryReceiptRulesData viewFaxDeliveryReceiptRulesData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, viewFaxDeliveryReceiptRulesData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ViewFaxDeliveryReceiptRulesData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewFaxDeliveryReceiptRulesData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ViewFaxDeliveryReceiptRulesData viewFaxDeliveryReceiptRulesData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (viewFaxDeliveryReceiptRulesData.DataOption.IsSet && viewFaxDeliveryReceiptRulesData.Data == null)
                throw new ArgumentNullException(nameof(viewFaxDeliveryReceiptRulesData.Data), "Property is required for class ViewFaxDeliveryReceiptRulesData.");

            if (viewFaxDeliveryReceiptRulesData.TotalOption.IsSet)
                writer.WriteNumber("total", viewFaxDeliveryReceiptRulesData.TotalOption.Value!.Value);

            if (viewFaxDeliveryReceiptRulesData.PerPageOption.IsSet)
                writer.WriteNumber("per_page", viewFaxDeliveryReceiptRulesData.PerPageOption.Value!.Value);

            if (viewFaxDeliveryReceiptRulesData.CurrentPageOption.IsSet)
                writer.WriteNumber("current_page", viewFaxDeliveryReceiptRulesData.CurrentPageOption.Value!.Value);

            if (viewFaxDeliveryReceiptRulesData.LastPageOption.IsSet)
                writer.WriteNumber("last_page", viewFaxDeliveryReceiptRulesData.LastPageOption.Value!.Value);

            if (viewFaxDeliveryReceiptRulesData.NextPageUrlOption.IsSet)
                if (viewFaxDeliveryReceiptRulesData.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", viewFaxDeliveryReceiptRulesData.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (viewFaxDeliveryReceiptRulesData.PrevPageUrlOption.IsSet)
                if (viewFaxDeliveryReceiptRulesData.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", viewFaxDeliveryReceiptRulesData.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (viewFaxDeliveryReceiptRulesData.FromOption.IsSet)
                writer.WriteNumber("from", viewFaxDeliveryReceiptRulesData.FromOption.Value!.Value);

            if (viewFaxDeliveryReceiptRulesData.ToOption.IsSet)
                writer.WriteNumber("to", viewFaxDeliveryReceiptRulesData.ToOption.Value!.Value);

            if (viewFaxDeliveryReceiptRulesData.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, viewFaxDeliveryReceiptRulesData.Data, jsonSerializerOptions);
            }
        }
    }
}
