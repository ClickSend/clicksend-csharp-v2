...
namespace ClickSend.Model
{
    ...
    /// DeleteList
    /// </summary>
    public partial class DeleteList : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public DeleteList(Option<int?> httpCode = default, Option<string?> responseCode = default, Option<string?> responseMsg = default, Option<List<string>?> data = default)
        {
        ...
        /* <example>List #442 has been deleted.</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="DeleteList" />
    /// </summary>
    public class DeleteListJsonConverter : JsonConverter<DeleteList>
    {
        /// <summary>
        /// Deserializes json to <see cref="DeleteList" />
        /// </summary>
        ...
        public override DeleteList Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (httpCode.IsSet && httpCode.Value == null)
                throw new ArgumentNullException(nameof(httpCode), "Property is not nullable for class DeleteList.");

            if (responseCode.IsSet && responseCode.Value == null)
                throw new ArgumentNullException(nameof(responseCode), "Property is not nullable for class DeleteList.");

            if (responseMsg.IsSet && responseMsg.Value == null)
                throw new ArgumentNullException(nameof(responseMsg), "Property is not nullable for class DeleteList.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class DeleteList.");

            return new DeleteList(httpCode, responseCode, responseMsg, data);
        }

        /// <summary>
        /// Serializes a <see cref="DeleteList" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="deleteList"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DeleteList deleteList, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, deleteList, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DeleteList" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="deleteList"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DeleteList deleteList, JsonSerializerOptions jsonSerializerOptions)
        {
            if (deleteList.ResponseCodeOption.IsSet && deleteList.ResponseCode == null)
                throw new ArgumentNullException(nameof(deleteList.ResponseCode), "Property is required for class DeleteList.");

            if (deleteList.ResponseMsgOption.IsSet && deleteList.ResponseMsg == null)
                throw new ArgumentNullException(nameof(deleteList.ResponseMsg), "Property is required for class DeleteList.");

            if (deleteList.DataOption.IsSet && deleteList.Data == null)
                throw new ArgumentNullException(nameof(deleteList.Data), "Property is required for class DeleteList.");

            if (deleteList.HttpCodeOption.IsSet)
                writer.WriteNumber("http_code", deleteList.HttpCodeOption.Value!.Value);

            if (deleteList.ResponseCodeOption.IsSet)
                writer.WriteString("response_code", deleteList.ResponseCode);

            if (deleteList.ResponseMsgOption.IsSet)
                writer.WriteString("response_msg", deleteList.ResponseMsg);

            if (deleteList.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, deleteList.Data, jsonSerializerOptions);
            }
        }
    }
}
