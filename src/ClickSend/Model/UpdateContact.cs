...
namespace ClickSend.Model
{
    ...
    public partial class UpdateContact : IValidatableObject
    {
        ...
        [JsonConstructor]
        public UpdateContact(Option<int?> httpCode = default, Option<string?> responseCode = default, Option<string?> responseMsg = default, Option<Contact?> data = default)
        {
        ...
        /* <example>Contact #552807 has been updated successfully.</example> */
    ...
    public class UpdateContactJsonConverter : JsonConverter<UpdateContact>
    {
        ...
        public override UpdateContact Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (httpCode.IsSet && httpCode.Value == null)
                throw new ArgumentNullException(nameof(httpCode), "Property is not nullable for class UpdateContact.");

            if (responseCode.IsSet && responseCode.Value == null)
                throw new ArgumentNullException(nameof(responseCode), "Property is not nullable for class UpdateContact.");

            if (responseMsg.IsSet && responseMsg.Value == null)
                throw new ArgumentNullException(nameof(responseMsg), "Property is not nullable for class UpdateContact.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class UpdateContact.");

            return new UpdateContact(httpCode, responseCode, responseMsg, data);
        }
        ...
        {
            if (updateContact.ResponseCodeOption.IsSet && updateContact.ResponseCode == null)
                throw new ArgumentNullException(nameof(updateContact.ResponseCode), "Property is required for class UpdateContact.");

            if (updateContact.ResponseMsgOption.IsSet && updateContact.ResponseMsg == null)
                throw new ArgumentNullException(nameof(updateContact.ResponseMsg), "Property is required for class UpdateContact.");

            if (updateContact.DataOption.IsSet && updateContact.Data == null)
                throw new ArgumentNullException(nameof(updateContact.Data), "Property is required for class UpdateContact.");

            if (updateContact.HttpCodeOption.IsSet)
                writer.WriteNumber("http_code", updateContact.HttpCodeOption.Value!.Value);

            if (updateContact.ResponseCodeOption.IsSet)
                writer.WriteString("response_code", updateContact.ResponseCode);

            if (updateContact.ResponseMsgOption.IsSet)
                writer.WriteString("response_msg", updateContact.ResponseMsg);

            if (updateContact.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, updateContact.Data, jsonSerializerOptions);
            }
        }
    }
}
