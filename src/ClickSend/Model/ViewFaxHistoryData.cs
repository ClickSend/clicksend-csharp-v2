...
namespace ClickSend.Model
{
    ...
    /// ViewFaxHistoryData
    /// </summary>
    public partial class ViewFaxHistoryData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewFaxHistoryData" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ViewFaxHistoryData(Option<int?> total = default, Option<int?> perPage = default, Option<int?> currentPage = default, Option<int?> lastPage = default, Option<string?> nextPageUrl = default, Option<string?> prevPageUrl = default, Option<int?> from = default, Option<int?> to = default, Option<List<Fax>?> data = default)
        {
            TotalOption = total;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<Fax>?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        [JsonPropertyName("data")]
        public List<Fax>? Data { get { return this.DataOption.Value; } set { this.DataOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ViewFaxHistoryData" />
    /// </summary>
    public class ViewFaxHistoryDataJsonConverter : JsonConverter<ViewFaxHistoryData>
    {
        /// <summary>
        /// Deserializes json to <see cref="ViewFaxHistoryData" />
        /// </summary>
        ...
        public override ViewFaxHistoryData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "to":
                            ...
                            break;
                        case "data":
                            data = new Option<List<Fax>?>(JsonSerializer.Deserialize<List<Fax>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class ViewFaxHistoryData.");

            if (perPage.IsSet && perPage.Value == null)
                throw new ArgumentNullException(nameof(perPage), "Property is not nullable for class ViewFaxHistoryData.");

            if (currentPage.IsSet && currentPage.Value == null)
                throw new ArgumentNullException(nameof(currentPage), "Property is not nullable for class ViewFaxHistoryData.");

            if (lastPage.IsSet && lastPage.Value == null)
                throw new ArgumentNullException(nameof(lastPage), "Property is not nullable for class ViewFaxHistoryData.");

            if (from.IsSet && from.Value == null)
                throw new ArgumentNullException(nameof(from), "Property is not nullable for class ViewFaxHistoryData.");

            if (to.IsSet && to.Value == null)
                throw new ArgumentNullException(nameof(to), "Property is not nullable for class ViewFaxHistoryData.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ViewFaxHistoryData.");

            return new ViewFaxHistoryData(total, perPage, currentPage, lastPage, nextPageUrl, prevPageUrl, from, to, data);
        }

        /// <summary>
        /// Serializes a <see cref="ViewFaxHistoryData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewFaxHistoryData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ViewFaxHistoryData viewFaxHistoryData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, viewFaxHistoryData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ViewFaxHistoryData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewFaxHistoryData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ViewFaxHistoryData viewFaxHistoryData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (viewFaxHistoryData.DataOption.IsSet && viewFaxHistoryData.Data == null)
                throw new ArgumentNullException(nameof(viewFaxHistoryData.Data), "Property is required for class ViewFaxHistoryData.");

            if (viewFaxHistoryData.TotalOption.IsSet)
                writer.WriteNumber("total", viewFaxHistoryData.TotalOption.Value!.Value);

            if (viewFaxHistoryData.PerPageOption.IsSet)
                writer.WriteNumber("per_page", viewFaxHistoryData.PerPageOption.Value!.Value);

            if (viewFaxHistoryData.CurrentPageOption.IsSet)
                writer.WriteNumber("current_page", viewFaxHistoryData.CurrentPageOption.Value!.Value);

            if (viewFaxHistoryData.LastPageOption.IsSet)
                writer.WriteNumber("last_page", viewFaxHistoryData.LastPageOption.Value!.Value);

            if (viewFaxHistoryData.NextPageUrlOption.IsSet)
                if (viewFaxHistoryData.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", viewFaxHistoryData.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (viewFaxHistoryData.PrevPageUrlOption.IsSet)
                if (viewFaxHistoryData.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", viewFaxHistoryData.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (viewFaxHistoryData.FromOption.IsSet)
                writer.WriteNumber("from", viewFaxHistoryData.FromOption.Value!.Value);

            if (viewFaxHistoryData.ToOption.IsSet)
                writer.WriteNumber("to", viewFaxHistoryData.ToOption.Value!.Value);

            if (viewFaxHistoryData.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, viewFaxHistoryData.Data, jsonSerializerOptions);
            }
        }
    }
}
