...
namespace ClickSend.Model
{
    ...
    /// </summary>
    public partial class ViewPostcardHistoryData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewPostcardHistoryData" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ViewPostcardHistoryData(Option<int?> total = default, Option<int?> perPage = default, Option<int?> currentPage = default, Option<int?> lastPage = default, Option<string?> nextPageUrl = default, Option<string?> prevPageUrl = default, Option<int?> from = default, Option<int?> to = default, Option<List<PostcardRecipient>?> data = default)
        {
            TotalOption = total;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<PostcardRecipient>?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        [JsonPropertyName("data")]
        public List<PostcardRecipient>? Data { get { return this.DataOption.Value; } set { this.DataOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ViewPostcardHistoryData" />
    /// </summary>
    public class ViewPostcardHistoryDataJsonConverter : JsonConverter<ViewPostcardHistoryData>
    {
        /// <summary>
        /// Deserializes json to <see cref="ViewPostcardHistoryData" />
        /// </summary>
        ...
        public override ViewPostcardHistoryData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<PostcardRecipient>?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "to":
                            ...
                            break;
                        case "data":
                            data = new Option<List<PostcardRecipient>?>(JsonSerializer.Deserialize<List<PostcardRecipient>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class ViewPostcardHistoryData.");

            if (perPage.IsSet && perPage.Value == null)
                throw new ArgumentNullException(nameof(perPage), "Property is not nullable for class ViewPostcardHistoryData.");

            if (currentPage.IsSet && currentPage.Value == null)
                throw new ArgumentNullException(nameof(currentPage), "Property is not nullable for class ViewPostcardHistoryData.");

            if (lastPage.IsSet && lastPage.Value == null)
                throw new ArgumentNullException(nameof(lastPage), "Property is not nullable for class ViewPostcardHistoryData.");

            if (from.IsSet && from.Value == null)
                throw new ArgumentNullException(nameof(from), "Property is not nullable for class ViewPostcardHistoryData.");

            if (to.IsSet && to.Value == null)
                throw new ArgumentNullException(nameof(to), "Property is not nullable for class ViewPostcardHistoryData.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ViewPostcardHistoryData.");

            return new ViewPostcardHistoryData(total, perPage, currentPage, lastPage, nextPageUrl, prevPageUrl, from, to, data);
        }

        /// <summary>
        /// Serializes a <see cref="ViewPostcardHistoryData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewPostcardHistoryData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ViewPostcardHistoryData viewPostcardHistoryData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, viewPostcardHistoryData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ViewPostcardHistoryData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewPostcardHistoryData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ViewPostcardHistoryData viewPostcardHistoryData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (viewPostcardHistoryData.DataOption.IsSet && viewPostcardHistoryData.Data == null)
                throw new ArgumentNullException(nameof(viewPostcardHistoryData.Data), "Property is required for class ViewPostcardHistoryData.");

            if (viewPostcardHistoryData.TotalOption.IsSet)
                writer.WriteNumber("total", viewPostcardHistoryData.TotalOption.Value!.Value);

            if (viewPostcardHistoryData.PerPageOption.IsSet)
                writer.WriteNumber("per_page", viewPostcardHistoryData.PerPageOption.Value!.Value);

            if (viewPostcardHistoryData.CurrentPageOption.IsSet)
                writer.WriteNumber("current_page", viewPostcardHistoryData.CurrentPageOption.Value!.Value);

            if (viewPostcardHistoryData.LastPageOption.IsSet)
                writer.WriteNumber("last_page", viewPostcardHistoryData.LastPageOption.Value!.Value);

            if (viewPostcardHistoryData.NextPageUrlOption.IsSet)
                if (viewPostcardHistoryData.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", viewPostcardHistoryData.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (viewPostcardHistoryData.PrevPageUrlOption.IsSet)
                if (viewPostcardHistoryData.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", viewPostcardHistoryData.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (viewPostcardHistoryData.FromOption.IsSet)
                writer.WriteNumber("from", viewPostcardHistoryData.FromOption.Value!.Value);

            if (viewPostcardHistoryData.ToOption.IsSet)
                writer.WriteNumber("to", viewPostcardHistoryData.ToOption.Value!.Value);

            if (viewPostcardHistoryData.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, viewPostcardHistoryData.Data, jsonSerializerOptions);
            }
        }
    }
}
