...
namespace ClickSend.Model
{
    ...
    public partial class SendEmail : IValidatableObject
    {
        ...
        [JsonConstructor]
        public SendEmail(Option<int?> httpCode = default, Option<string?> responseCode = default, Option<string?> responseMsg = default, Option<TransactionalEmail?> data = default)
        {
        ...
        /* <example>Transactional email queued for delivery.</example> */
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<TransactionalEmail?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        [JsonPropertyName("data")]
        public TransactionalEmail? Data { get { return this.DataOption.Value; } set { this.DataOption = new(value); } }
    ...
    public class SendEmailJsonConverter : JsonConverter<SendEmail>
    {
        ...
        public override SendEmail Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<TransactionalEmail?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "response_msg":
                            ...
                            break;
                        case "data":
                            data = new Option<TransactionalEmail?>(JsonSerializer.Deserialize<TransactionalEmail>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (httpCode.IsSet && httpCode.Value == null)
                throw new ArgumentNullException(nameof(httpCode), "Property is not nullable for class SendEmail.");

            if (responseCode.IsSet && responseCode.Value == null)
                throw new ArgumentNullException(nameof(responseCode), "Property is not nullable for class SendEmail.");

            if (responseMsg.IsSet && responseMsg.Value == null)
                throw new ArgumentNullException(nameof(responseMsg), "Property is not nullable for class SendEmail.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class SendEmail.");

            return new SendEmail(httpCode, responseCode, responseMsg, data);
        }
        ...
        {
            if (sendEmail.ResponseCodeOption.IsSet && sendEmail.ResponseCode == null)
                throw new ArgumentNullException(nameof(sendEmail.ResponseCode), "Property is required for class SendEmail.");

            if (sendEmail.ResponseMsgOption.IsSet && sendEmail.ResponseMsg == null)
                throw new ArgumentNullException(nameof(sendEmail.ResponseMsg), "Property is required for class SendEmail.");

            if (sendEmail.DataOption.IsSet && sendEmail.Data == null)
                throw new ArgumentNullException(nameof(sendEmail.Data), "Property is required for class SendEmail.");

            if (sendEmail.HttpCodeOption.IsSet)
                writer.WriteNumber("http_code", sendEmail.HttpCodeOption.Value!.Value);

            if (sendEmail.ResponseCodeOption.IsSet)
                writer.WriteString("response_code", sendEmail.ResponseCode);

            if (sendEmail.ResponseMsgOption.IsSet)
                writer.WriteString("response_msg", sendEmail.ResponseMsg);

            if (sendEmail.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, sendEmail.Data, jsonSerializerOptions);
            }
        }
    }
}
