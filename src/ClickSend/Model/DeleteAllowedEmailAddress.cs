...
namespace ClickSend.Model
{
    ...
    /// </summary>
    public partial class DeleteAllowedEmailAddress : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteAllowedEmailAddress" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public DeleteAllowedEmailAddress(Option<int?> httpCode = default, Option<string?> responseCode = default, Option<string?> responseMsg = default, Option<Object?> data = default)
        {
        ...
        /* <example>Email address deleted.</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="DeleteAllowedEmailAddress" />
    /// </summary>
    public class DeleteAllowedEmailAddressJsonConverter : JsonConverter<DeleteAllowedEmailAddress>
    {
        /// <summary>
        /// Deserializes json to <see cref="DeleteAllowedEmailAddress" />
        /// </summary>
        ...
        public override DeleteAllowedEmailAddress Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (httpCode.IsSet && httpCode.Value == null)
                throw new ArgumentNullException(nameof(httpCode), "Property is not nullable for class DeleteAllowedEmailAddress.");

            if (responseCode.IsSet && responseCode.Value == null)
                throw new ArgumentNullException(nameof(responseCode), "Property is not nullable for class DeleteAllowedEmailAddress.");

            if (responseMsg.IsSet && responseMsg.Value == null)
                throw new ArgumentNullException(nameof(responseMsg), "Property is not nullable for class DeleteAllowedEmailAddress.");

            return new DeleteAllowedEmailAddress(httpCode, responseCode, responseMsg, data);
        }

        /// <summary>
        /// Serializes a <see cref="DeleteAllowedEmailAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="deleteAllowedEmailAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DeleteAllowedEmailAddress deleteAllowedEmailAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, deleteAllowedEmailAddress, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DeleteAllowedEmailAddress" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="deleteAllowedEmailAddress"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DeleteAllowedEmailAddress deleteAllowedEmailAddress, JsonSerializerOptions jsonSerializerOptions)
        {
            if (deleteAllowedEmailAddress.ResponseCodeOption.IsSet && deleteAllowedEmailAddress.ResponseCode == null)
                throw new ArgumentNullException(nameof(deleteAllowedEmailAddress.ResponseCode), "Property is required for class DeleteAllowedEmailAddress.");

            if (deleteAllowedEmailAddress.ResponseMsgOption.IsSet && deleteAllowedEmailAddress.ResponseMsg == null)
                throw new ArgumentNullException(nameof(deleteAllowedEmailAddress.ResponseMsg), "Property is required for class DeleteAllowedEmailAddress.");

            if (deleteAllowedEmailAddress.HttpCodeOption.IsSet)
                writer.WriteNumber("http_code", deleteAllowedEmailAddress.HttpCodeOption.Value!.Value);

            if (deleteAllowedEmailAddress.ResponseCodeOption.IsSet)
                writer.WriteString("response_code", deleteAllowedEmailAddress.ResponseCode);

            if (deleteAllowedEmailAddress.ResponseMsgOption.IsSet)
                writer.WriteString("response_msg", deleteAllowedEmailAddress.ResponseMsg);

            if (deleteAllowedEmailAddress.DataOption.IsSet)
                if (deleteAllowedEmailAddress.DataOption.Value != null)
                {
                    writer.WritePropertyName("data");
                    JsonSerializer.Serialize(writer, deleteAllowedEmailAddress.Data, jsonSerializerOptions);
                }
                else
