...
namespace ClickSend.Model
{
    ...
    public partial class CreateList : IValidatableObject
    {
        ...
        [JsonConstructor]
        public CreateList(Option<int?> httpCode = default, Option<string?> responseCode = default, Option<string?> responseMsg = default, Option<ContactList?> data = default)
        {
        ...
        /* <example>New list has been created.</example> */
    ...
    public class CreateListJsonConverter : JsonConverter<CreateList>
    {
        ...
        public override CreateList Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (httpCode.IsSet && httpCode.Value == null)
                throw new ArgumentNullException(nameof(httpCode), "Property is not nullable for class CreateList.");

            if (responseCode.IsSet && responseCode.Value == null)
                throw new ArgumentNullException(nameof(responseCode), "Property is not nullable for class CreateList.");

            if (responseMsg.IsSet && responseMsg.Value == null)
                throw new ArgumentNullException(nameof(responseMsg), "Property is not nullable for class CreateList.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class CreateList.");

            return new CreateList(httpCode, responseCode, responseMsg, data);
        }
        ...
        {
            if (createList.ResponseCodeOption.IsSet && createList.ResponseCode == null)
                throw new ArgumentNullException(nameof(createList.ResponseCode), "Property is required for class CreateList.");

            if (createList.ResponseMsgOption.IsSet && createList.ResponseMsg == null)
                throw new ArgumentNullException(nameof(createList.ResponseMsg), "Property is required for class CreateList.");

            if (createList.DataOption.IsSet && createList.Data == null)
                throw new ArgumentNullException(nameof(createList.Data), "Property is required for class CreateList.");

            if (createList.HttpCodeOption.IsSet)
                writer.WriteNumber("http_code", createList.HttpCodeOption.Value!.Value);

            if (createList.ResponseCodeOption.IsSet)
                writer.WriteString("response_code", createList.ResponseCode);

            if (createList.ResponseMsgOption.IsSet)
                writer.WriteString("response_msg", createList.ResponseMsg);

            if (createList.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, createList.Data, jsonSerializerOptions);
            }
        }
    }
}
