...
namespace ClickSend.Model
{
    ...
    /// </summary>
    public partial class ViewYourReturnAddressesData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewYourReturnAddressesData" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ViewYourReturnAddressesData(Option<int?> total = default, Option<int?> perPage = default, Option<int?> currentPage = default, Option<int?> lastPage = default, Option<string?> nextPageUrl = default, Option<string?> prevPageUrl = default, Option<int?> from = default, Option<int?> to = default, Option<List<PostReturnAddress>?> data = default)
        {
            TotalOption = total;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<PostReturnAddress>?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        [JsonPropertyName("data")]
        public List<PostReturnAddress>? Data { get { return this.DataOption.Value; } set { this.DataOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ViewYourReturnAddressesData" />
    /// </summary>
    public class ViewYourReturnAddressesDataJsonConverter : JsonConverter<ViewYourReturnAddressesData>
    {
        /// <summary>
        /// Deserializes json to <see cref="ViewYourReturnAddressesData" />
        /// </summary>
        ...
        public override ViewYourReturnAddressesData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<PostReturnAddress>?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "to":
                            ...
                            break;
                        case "data":
                            data = new Option<List<PostReturnAddress>?>(JsonSerializer.Deserialize<List<PostReturnAddress>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class ViewYourReturnAddressesData.");

            if (perPage.IsSet && perPage.Value == null)
                throw new ArgumentNullException(nameof(perPage), "Property is not nullable for class ViewYourReturnAddressesData.");

            if (currentPage.IsSet && currentPage.Value == null)
                throw new ArgumentNullException(nameof(currentPage), "Property is not nullable for class ViewYourReturnAddressesData.");

            if (lastPage.IsSet && lastPage.Value == null)
                throw new ArgumentNullException(nameof(lastPage), "Property is not nullable for class ViewYourReturnAddressesData.");

            if (from.IsSet && from.Value == null)
                throw new ArgumentNullException(nameof(from), "Property is not nullable for class ViewYourReturnAddressesData.");

            if (to.IsSet && to.Value == null)
                throw new ArgumentNullException(nameof(to), "Property is not nullable for class ViewYourReturnAddressesData.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ViewYourReturnAddressesData.");

            return new ViewYourReturnAddressesData(total, perPage, currentPage, lastPage, nextPageUrl, prevPageUrl, from, to, data);
        }

        /// <summary>
        /// Serializes a <see cref="ViewYourReturnAddressesData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewYourReturnAddressesData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ViewYourReturnAddressesData viewYourReturnAddressesData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, viewYourReturnAddressesData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ViewYourReturnAddressesData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewYourReturnAddressesData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ViewYourReturnAddressesData viewYourReturnAddressesData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (viewYourReturnAddressesData.DataOption.IsSet && viewYourReturnAddressesData.Data == null)
                throw new ArgumentNullException(nameof(viewYourReturnAddressesData.Data), "Property is required for class ViewYourReturnAddressesData.");

            if (viewYourReturnAddressesData.TotalOption.IsSet)
                writer.WriteNumber("total", viewYourReturnAddressesData.TotalOption.Value!.Value);

            if (viewYourReturnAddressesData.PerPageOption.IsSet)
                writer.WriteNumber("per_page", viewYourReturnAddressesData.PerPageOption.Value!.Value);

            if (viewYourReturnAddressesData.CurrentPageOption.IsSet)
                writer.WriteNumber("current_page", viewYourReturnAddressesData.CurrentPageOption.Value!.Value);

            if (viewYourReturnAddressesData.LastPageOption.IsSet)
                writer.WriteNumber("last_page", viewYourReturnAddressesData.LastPageOption.Value!.Value);

            if (viewYourReturnAddressesData.NextPageUrlOption.IsSet)
                if (viewYourReturnAddressesData.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", viewYourReturnAddressesData.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (viewYourReturnAddressesData.PrevPageUrlOption.IsSet)
                if (viewYourReturnAddressesData.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", viewYourReturnAddressesData.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (viewYourReturnAddressesData.FromOption.IsSet)
                writer.WriteNumber("from", viewYourReturnAddressesData.FromOption.Value!.Value);

            if (viewYourReturnAddressesData.ToOption.IsSet)
                writer.WriteNumber("to", viewYourReturnAddressesData.ToOption.Value!.Value);

            if (viewYourReturnAddressesData.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, viewYourReturnAddressesData.Data, jsonSerializerOptions);
            }
        }
    }
}
