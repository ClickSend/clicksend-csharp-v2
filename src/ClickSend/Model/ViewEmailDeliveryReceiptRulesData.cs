...
namespace ClickSend.Model
{
    ...
    /// </summary>
    public partial class ViewEmailDeliveryReceiptRulesData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewEmailDeliveryReceiptRulesData" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ViewEmailDeliveryReceiptRulesData(Option<int?> total = default, Option<int?> perPage = default, Option<int?> currentPage = default, Option<int?> lastPage = default, Option<string?> nextPageUrl = default, Option<string?> prevPageUrl = default, Option<int?> from = default, Option<int?> to = default)
        {
            TotalOption = total;
    ...
    /// <summary>
    /// A Json converter for type <see cref="ViewEmailDeliveryReceiptRulesData" />
    /// </summary>
    public class ViewEmailDeliveryReceiptRulesDataJsonConverter : JsonConverter<ViewEmailDeliveryReceiptRulesData>
    {
        /// <summary>
        /// Deserializes json to <see cref="ViewEmailDeliveryReceiptRulesData" />
        /// </summary>
        ...
        public override ViewEmailDeliveryReceiptRulesData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class ViewEmailDeliveryReceiptRulesData.");

            if (perPage.IsSet && perPage.Value == null)
                throw new ArgumentNullException(nameof(perPage), "Property is not nullable for class ViewEmailDeliveryReceiptRulesData.");

            if (currentPage.IsSet && currentPage.Value == null)
                throw new ArgumentNullException(nameof(currentPage), "Property is not nullable for class ViewEmailDeliveryReceiptRulesData.");

            if (lastPage.IsSet && lastPage.Value == null)
                throw new ArgumentNullException(nameof(lastPage), "Property is not nullable for class ViewEmailDeliveryReceiptRulesData.");

            if (from.IsSet && from.Value == null)
                throw new ArgumentNullException(nameof(from), "Property is not nullable for class ViewEmailDeliveryReceiptRulesData.");

            if (to.IsSet && to.Value == null)
                throw new ArgumentNullException(nameof(to), "Property is not nullable for class ViewEmailDeliveryReceiptRulesData.");

            return new ViewEmailDeliveryReceiptRulesData(total, perPage, currentPage, lastPage, nextPageUrl, prevPageUrl, from, to);
        }

        /// <summary>
        /// Serializes a <see cref="ViewEmailDeliveryReceiptRulesData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewEmailDeliveryReceiptRulesData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ViewEmailDeliveryReceiptRulesData viewEmailDeliveryReceiptRulesData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, viewEmailDeliveryReceiptRulesData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ViewEmailDeliveryReceiptRulesData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewEmailDeliveryReceiptRulesData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ViewEmailDeliveryReceiptRulesData viewEmailDeliveryReceiptRulesData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (viewEmailDeliveryReceiptRulesData.TotalOption.IsSet)
                writer.WriteNumber("total", viewEmailDeliveryReceiptRulesData.TotalOption.Value!.Value);

            if (viewEmailDeliveryReceiptRulesData.PerPageOption.IsSet)
                writer.WriteNumber("per_page", viewEmailDeliveryReceiptRulesData.PerPageOption.Value!.Value);

            if (viewEmailDeliveryReceiptRulesData.CurrentPageOption.IsSet)
                writer.WriteNumber("current_page", viewEmailDeliveryReceiptRulesData.CurrentPageOption.Value!.Value);

            if (viewEmailDeliveryReceiptRulesData.LastPageOption.IsSet)
                writer.WriteNumber("last_page", viewEmailDeliveryReceiptRulesData.LastPageOption.Value!.Value);

            if (viewEmailDeliveryReceiptRulesData.NextPageUrlOption.IsSet)
                if (viewEmailDeliveryReceiptRulesData.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", viewEmailDeliveryReceiptRulesData.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (viewEmailDeliveryReceiptRulesData.PrevPageUrlOption.IsSet)
                if (viewEmailDeliveryReceiptRulesData.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", viewEmailDeliveryReceiptRulesData.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (viewEmailDeliveryReceiptRulesData.FromOption.IsSet)
                writer.WriteNumber("from", viewEmailDeliveryReceiptRulesData.FromOption.Value!.Value);

            if (viewEmailDeliveryReceiptRulesData.ToOption.IsSet)
                writer.WriteNumber("to", viewEmailDeliveryReceiptRulesData.ToOption.Value!.Value);
        }
    }
}
