...
namespace ClickSend.Model
{
    ...
    /// </summary>
    public partial class ViewSmsTemplatesData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewSmsTemplatesData" /> class.
        /// </summary>
        ...
        /// <param name="data">The parameters related to the actual templates.</param>
        [JsonConstructor]
        public ViewSmsTemplatesData(Option<int?> total = default, Option<int?> perPage = default, Option<int?> currentPage = default, Option<int?> lastPage = default, Option<string?> nextPageUrl = default, Option<string?> prevPageUrl = default, Option<int?> from = default, Option<int?> to = default, Option<List<SmsTemplate>?> data = default)
        {
            TotalOption = total;
        ...
        /// </summary>
        /// <value>The parameters related to the actual templates.</value>
        [JsonPropertyName("data")]
        public List<SmsTemplate>? Data { get { return this.DataOption.Value; } set { this.DataOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ViewSmsTemplatesData" />
    /// </summary>
    public class ViewSmsTemplatesDataJsonConverter : JsonConverter<ViewSmsTemplatesData>
    {
        /// <summary>
        /// Deserializes json to <see cref="ViewSmsTemplatesData" />
        /// </summary>
        ...
        public override ViewSmsTemplatesData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class ViewSmsTemplatesData.");

            if (perPage.IsSet && perPage.Value == null)
                throw new ArgumentNullException(nameof(perPage), "Property is not nullable for class ViewSmsTemplatesData.");

            if (currentPage.IsSet && currentPage.Value == null)
                throw new ArgumentNullException(nameof(currentPage), "Property is not nullable for class ViewSmsTemplatesData.");

            if (lastPage.IsSet && lastPage.Value == null)
                throw new ArgumentNullException(nameof(lastPage), "Property is not nullable for class ViewSmsTemplatesData.");

            if (from.IsSet && from.Value == null)
                throw new ArgumentNullException(nameof(from), "Property is not nullable for class ViewSmsTemplatesData.");

            if (to.IsSet && to.Value == null)
                throw new ArgumentNullException(nameof(to), "Property is not nullable for class ViewSmsTemplatesData.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ViewSmsTemplatesData.");

            return new ViewSmsTemplatesData(total, perPage, currentPage, lastPage, nextPageUrl, prevPageUrl, from, to, data);
        }

        /// <summary>
        /// Serializes a <see cref="ViewSmsTemplatesData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewSmsTemplatesData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ViewSmsTemplatesData viewSmsTemplatesData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, viewSmsTemplatesData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ViewSmsTemplatesData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewSmsTemplatesData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ViewSmsTemplatesData viewSmsTemplatesData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (viewSmsTemplatesData.DataOption.IsSet && viewSmsTemplatesData.Data == null)
                throw new ArgumentNullException(nameof(viewSmsTemplatesData.Data), "Property is required for class ViewSmsTemplatesData.");

            if (viewSmsTemplatesData.TotalOption.IsSet)
                writer.WriteNumber("total", viewSmsTemplatesData.TotalOption.Value!.Value);

            if (viewSmsTemplatesData.PerPageOption.IsSet)
                writer.WriteNumber("per_page", viewSmsTemplatesData.PerPageOption.Value!.Value);

            if (viewSmsTemplatesData.CurrentPageOption.IsSet)
                writer.WriteNumber("current_page", viewSmsTemplatesData.CurrentPageOption.Value!.Value);

            if (viewSmsTemplatesData.LastPageOption.IsSet)
                writer.WriteNumber("last_page", viewSmsTemplatesData.LastPageOption.Value!.Value);

            if (viewSmsTemplatesData.NextPageUrlOption.IsSet)
                if (viewSmsTemplatesData.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", viewSmsTemplatesData.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (viewSmsTemplatesData.PrevPageUrlOption.IsSet)
                if (viewSmsTemplatesData.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", viewSmsTemplatesData.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (viewSmsTemplatesData.FromOption.IsSet)
                writer.WriteNumber("from", viewSmsTemplatesData.FromOption.Value!.Value);

            if (viewSmsTemplatesData.ToOption.IsSet)
                writer.WriteNumber("to", viewSmsTemplatesData.ToOption.Value!.Value);

            if (viewSmsTemplatesData.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, viewSmsTemplatesData.Data, jsonSerializerOptions);
            }
        }
    }
}
