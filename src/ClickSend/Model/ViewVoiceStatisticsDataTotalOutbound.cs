...
namespace ClickSend.Model
{
    ...
    /// </summary>
    public partial class ViewVoiceStatisticsDataTotalOutbound : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewVoiceStatisticsDataTotalOutbound" /> class.
        /// </summary>
        ...
        /// </summary>
        /// <value>The total count of outbound calls.</value>
        /* <example>1</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="ViewVoiceStatisticsDataTotalOutbound" />
    /// </summary>
    public class ViewVoiceStatisticsDataTotalOutboundJsonConverter : JsonConverter<ViewVoiceStatisticsDataTotalOutbound>
    {
        /// <summary>
        /// Deserializes json to <see cref="ViewVoiceStatisticsDataTotalOutbound" />
        /// </summary>
        ...
        public override ViewVoiceStatisticsDataTotalOutbound Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (count.IsSet && count.Value == null)
                throw new ArgumentNullException(nameof(count), "Property is not nullable for class ViewVoiceStatisticsDataTotalOutbound.");

            if (price.IsSet && price.Value == null)
                throw new ArgumentNullException(nameof(price), "Property is not nullable for class ViewVoiceStatisticsDataTotalOutbound.");

            return new ViewVoiceStatisticsDataTotalOutbound(count, price);
        }

        /// <summary>
        /// Serializes a <see cref="ViewVoiceStatisticsDataTotalOutbound" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewVoiceStatisticsDataTotalOutbound"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ViewVoiceStatisticsDataTotalOutbound viewVoiceStatisticsDataTotalOutbound, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, viewVoiceStatisticsDataTotalOutbound, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ViewVoiceStatisticsDataTotalOutbound" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewVoiceStatisticsDataTotalOutbound"></param>
        /// <param name="jsonSerializerOptions"></param>
