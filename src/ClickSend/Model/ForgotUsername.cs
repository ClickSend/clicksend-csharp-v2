...
namespace ClickSend.Model
{
    ...
    /// ForgotUsername
    /// </summary>
    public partial class ForgotUsername : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public ForgotUsername(Option<int?> httpCode = default, Option<string?> responseCode = default, Option<string?> responseMsg = default, Option<List<string>?> data = default)
        {
        ...
        /* <example>An email notification has been sent.</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="ForgotUsername" />
    /// </summary>
    public class ForgotUsernameJsonConverter : JsonConverter<ForgotUsername>
    {
        /// <summary>
        /// Deserializes json to <see cref="ForgotUsername" />
        /// </summary>
        ...
        public override ForgotUsername Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (httpCode.IsSet && httpCode.Value == null)
                throw new ArgumentNullException(nameof(httpCode), "Property is not nullable for class ForgotUsername.");

            if (responseCode.IsSet && responseCode.Value == null)
                throw new ArgumentNullException(nameof(responseCode), "Property is not nullable for class ForgotUsername.");

            if (responseMsg.IsSet && responseMsg.Value == null)
                throw new ArgumentNullException(nameof(responseMsg), "Property is not nullable for class ForgotUsername.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ForgotUsername.");

            return new ForgotUsername(httpCode, responseCode, responseMsg, data);
        }

        /// <summary>
        /// Serializes a <see cref="ForgotUsername" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="forgotUsername"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ForgotUsername forgotUsername, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, forgotUsername, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ForgotUsername" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="forgotUsername"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ForgotUsername forgotUsername, JsonSerializerOptions jsonSerializerOptions)
        {
            if (forgotUsername.ResponseCodeOption.IsSet && forgotUsername.ResponseCode == null)
                throw new ArgumentNullException(nameof(forgotUsername.ResponseCode), "Property is required for class ForgotUsername.");

            if (forgotUsername.ResponseMsgOption.IsSet && forgotUsername.ResponseMsg == null)
                throw new ArgumentNullException(nameof(forgotUsername.ResponseMsg), "Property is required for class ForgotUsername.");

            if (forgotUsername.DataOption.IsSet && forgotUsername.Data == null)
                throw new ArgumentNullException(nameof(forgotUsername.Data), "Property is required for class ForgotUsername.");

            if (forgotUsername.HttpCodeOption.IsSet)
                writer.WriteNumber("http_code", forgotUsername.HttpCodeOption.Value!.Value);

            if (forgotUsername.ResponseCodeOption.IsSet)
                writer.WriteString("response_code", forgotUsername.ResponseCode);

            if (forgotUsername.ResponseMsgOption.IsSet)
                writer.WriteString("response_msg", forgotUsername.ResponseMsg);

            if (forgotUsername.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, forgotUsername.Data, jsonSerializerOptions);
            }
        }
    }
}
