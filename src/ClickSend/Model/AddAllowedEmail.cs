...
namespace ClickSend.Model
{
    ...
    /// AddAllowedEmail
    /// </summary>
    public partial class AddAllowedEmail : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddAllowedEmail" /> class.
        /// </summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="AddAllowedEmail" />
    /// </summary>
    public class AddAllowedEmailJsonConverter : JsonConverter<AddAllowedEmail>
    {
        /// <summary>
        /// Deserializes json to <see cref="AddAllowedEmail" />
        /// </summary>
        ...
        public override AddAllowedEmail Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (httpCode.IsSet && httpCode.Value == null)
                throw new ArgumentNullException(nameof(httpCode), "Property is not nullable for class AddAllowedEmail.");

            if (responseCode.IsSet && responseCode.Value == null)
                throw new ArgumentNullException(nameof(responseCode), "Property is not nullable for class AddAllowedEmail.");

            if (responseMsg.IsSet && responseMsg.Value == null)
                throw new ArgumentNullException(nameof(responseMsg), "Property is not nullable for class AddAllowedEmail.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class AddAllowedEmail.");

            return new AddAllowedEmail(httpCode, responseCode, responseMsg, data);
        }

        /// <summary>
        /// Serializes a <see cref="AddAllowedEmail" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="addAllowedEmail"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, AddAllowedEmail addAllowedEmail, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, addAllowedEmail, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="AddAllowedEmail" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="addAllowedEmail"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, AddAllowedEmail addAllowedEmail, JsonSerializerOptions jsonSerializerOptions)
        {
            if (addAllowedEmail.ResponseCodeOption.IsSet && addAllowedEmail.ResponseCode == null)
                throw new ArgumentNullException(nameof(addAllowedEmail.ResponseCode), "Property is required for class AddAllowedEmail.");

            if (addAllowedEmail.ResponseMsgOption.IsSet && addAllowedEmail.ResponseMsg == null)
                throw new ArgumentNullException(nameof(addAllowedEmail.ResponseMsg), "Property is required for class AddAllowedEmail.");

            if (addAllowedEmail.DataOption.IsSet && addAllowedEmail.Data == null)
                throw new ArgumentNullException(nameof(addAllowedEmail.Data), "Property is required for class AddAllowedEmail.");

            if (addAllowedEmail.HttpCodeOption.IsSet)
                writer.WriteNumber("http_code", addAllowedEmail.HttpCodeOption.Value!.Value);

            if (addAllowedEmail.ResponseCodeOption.IsSet)
                writer.WriteString("response_code", addAllowedEmail.ResponseCode);

            if (addAllowedEmail.ResponseMsgOption.IsSet)
                writer.WriteString("response_msg", addAllowedEmail.ResponseMsg);

            if (addAllowedEmail.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, addAllowedEmail.Data, jsonSerializerOptions);
            }
        }
    }
}
