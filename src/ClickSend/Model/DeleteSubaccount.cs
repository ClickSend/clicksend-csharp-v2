...
namespace ClickSend.Model
{
    ...
    /// DeleteSubaccount
    /// </summary>
    public partial class DeleteSubaccount : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteSubaccount" /> class.
        /// </summary>
        ...
        /// <param name="data">The status of the operation.</param>
        [JsonConstructor]
        public DeleteSubaccount(Option<int?> httpCode = default, Option<string?> responseCode = default, Option<string?> responseMsg = default, Option<bool?> data = default)
        {
        ...
        /* <example>Subaccount #59 has been deleted</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="DeleteSubaccount" />
    /// </summary>
    public class DeleteSubaccountJsonConverter : JsonConverter<DeleteSubaccount>
    {
        /// <summary>
        /// Deserializes json to <see cref="DeleteSubaccount" />
        /// </summary>
        ...
        public override DeleteSubaccount Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (httpCode.IsSet && httpCode.Value == null)
                throw new ArgumentNullException(nameof(httpCode), "Property is not nullable for class DeleteSubaccount.");

            if (responseCode.IsSet && responseCode.Value == null)
                throw new ArgumentNullException(nameof(responseCode), "Property is not nullable for class DeleteSubaccount.");

            if (responseMsg.IsSet && responseMsg.Value == null)
                throw new ArgumentNullException(nameof(responseMsg), "Property is not nullable for class DeleteSubaccount.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class DeleteSubaccount.");

            return new DeleteSubaccount(httpCode, responseCode, responseMsg, data);
        }

        /// <summary>
        /// Serializes a <see cref="DeleteSubaccount" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="deleteSubaccount"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, DeleteSubaccount deleteSubaccount, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, deleteSubaccount, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DeleteSubaccount" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="deleteSubaccount"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, DeleteSubaccount deleteSubaccount, JsonSerializerOptions jsonSerializerOptions)
        {
            if (deleteSubaccount.ResponseCodeOption.IsSet && deleteSubaccount.ResponseCode == null)
                throw new ArgumentNullException(nameof(deleteSubaccount.ResponseCode), "Property is required for class DeleteSubaccount.");

            if (deleteSubaccount.ResponseMsgOption.IsSet && deleteSubaccount.ResponseMsg == null)
                throw new ArgumentNullException(nameof(deleteSubaccount.ResponseMsg), "Property is required for class DeleteSubaccount.");

            if (deleteSubaccount.HttpCodeOption.IsSet)
                writer.WriteNumber("http_code", deleteSubaccount.HttpCodeOption.Value!.Value);

            if (deleteSubaccount.ResponseCodeOption.IsSet)
                writer.WriteString("response_code", deleteSubaccount.ResponseCode);

            if (deleteSubaccount.ResponseMsgOption.IsSet)
                writer.WriteString("response_msg", deleteSubaccount.ResponseMsg);

            if (deleteSubaccount.DataOption.IsSet)
                writer.WriteBoolean("data", deleteSubaccount.DataOption.Value!.Value);
        }
    }
}
