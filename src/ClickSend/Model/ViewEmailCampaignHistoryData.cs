...
namespace ClickSend.Model
{
    ...
    /// </summary>
    public partial class ViewEmailCampaignHistoryData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewEmailCampaignHistoryData" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ViewEmailCampaignHistoryData(Option<int?> total = default, Option<int?> perPage = default, Option<int?> currentPage = default, Option<int?> lastPage = default, Option<string?> nextPageUrl = default, Option<string?> prevPageUrl = default, Option<int?> from = default, Option<int?> to = default, Option<List<EmailCampaignHistory>?> data = default)
        {
            TotalOption = total;
    ...
    /// <summary>
    /// A Json converter for type <see cref="ViewEmailCampaignHistoryData" />
    /// </summary>
    public class ViewEmailCampaignHistoryDataJsonConverter : JsonConverter<ViewEmailCampaignHistoryData>
    {
        /// <summary>
        /// Deserializes json to <see cref="ViewEmailCampaignHistoryData" />
        /// </summary>
        ...
        public override ViewEmailCampaignHistoryData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<EmailCampaignHistory>?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "to":
                            ...
                            break;
                        case "data":
                            data = new Option<List<EmailCampaignHistory>?>(JsonSerializer.Deserialize<List<EmailCampaignHistory>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class ViewEmailCampaignHistoryData.");

            if (perPage.IsSet && perPage.Value == null)
                throw new ArgumentNullException(nameof(perPage), "Property is not nullable for class ViewEmailCampaignHistoryData.");

            if (currentPage.IsSet && currentPage.Value == null)
                throw new ArgumentNullException(nameof(currentPage), "Property is not nullable for class ViewEmailCampaignHistoryData.");

            if (lastPage.IsSet && lastPage.Value == null)
                throw new ArgumentNullException(nameof(lastPage), "Property is not nullable for class ViewEmailCampaignHistoryData.");

            if (from.IsSet && from.Value == null)
                throw new ArgumentNullException(nameof(from), "Property is not nullable for class ViewEmailCampaignHistoryData.");

            if (to.IsSet && to.Value == null)
                throw new ArgumentNullException(nameof(to), "Property is not nullable for class ViewEmailCampaignHistoryData.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ViewEmailCampaignHistoryData.");

            return new ViewEmailCampaignHistoryData(total, perPage, currentPage, lastPage, nextPageUrl, prevPageUrl, from, to, data);
        }

        /// <summary>
        /// Serializes a <see cref="ViewEmailCampaignHistoryData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewEmailCampaignHistoryData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ViewEmailCampaignHistoryData viewEmailCampaignHistoryData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, viewEmailCampaignHistoryData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ViewEmailCampaignHistoryData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewEmailCampaignHistoryData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ViewEmailCampaignHistoryData viewEmailCampaignHistoryData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (viewEmailCampaignHistoryData.DataOption.IsSet && viewEmailCampaignHistoryData.Data == null)
                throw new ArgumentNullException(nameof(viewEmailCampaignHistoryData.Data), "Property is required for class ViewEmailCampaignHistoryData.");

            if (viewEmailCampaignHistoryData.TotalOption.IsSet)
                writer.WriteNumber("total", viewEmailCampaignHistoryData.TotalOption.Value!.Value);

            if (viewEmailCampaignHistoryData.PerPageOption.IsSet)
                writer.WriteNumber("per_page", viewEmailCampaignHistoryData.PerPageOption.Value!.Value);

            if (viewEmailCampaignHistoryData.CurrentPageOption.IsSet)
                writer.WriteNumber("current_page", viewEmailCampaignHistoryData.CurrentPageOption.Value!.Value);

            if (viewEmailCampaignHistoryData.LastPageOption.IsSet)
                writer.WriteNumber("last_page", viewEmailCampaignHistoryData.LastPageOption.Value!.Value);

            if (viewEmailCampaignHistoryData.NextPageUrlOption.IsSet)
                if (viewEmailCampaignHistoryData.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", viewEmailCampaignHistoryData.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (viewEmailCampaignHistoryData.PrevPageUrlOption.IsSet)
                if (viewEmailCampaignHistoryData.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", viewEmailCampaignHistoryData.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (viewEmailCampaignHistoryData.FromOption.IsSet)
                writer.WriteNumber("from", viewEmailCampaignHistoryData.FromOption.Value!.Value);

            if (viewEmailCampaignHistoryData.ToOption.IsSet)
                writer.WriteNumber("to", viewEmailCampaignHistoryData.ToOption.Value!.Value);

            if (viewEmailCampaignHistoryData.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, viewEmailCampaignHistoryData.Data, jsonSerializerOptions);
            }
        }
    }
}
