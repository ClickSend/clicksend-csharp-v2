...
namespace ClickSend.Model
{
    ...
    /// SendLetter
    /// </summary>
    public partial class SendLetter : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SendLetter" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public SendLetter(Option<int?> httpCode = default, Option<string?> responseCode = default, Option<string?> responseMsg = default, Option<SendLetterData?> data = default)
        {
        ...
        /* <example>Letters queued for delivery.</example> */
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<SendLetterData?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        [JsonPropertyName("data")]
        public SendLetterData? Data { get { return this.DataOption.Value; } set { this.DataOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="SendLetter" />
    /// </summary>
    public class SendLetterJsonConverter : JsonConverter<SendLetter>
    {
        /// <summary>
        /// Deserializes json to <see cref="SendLetter" />
        /// </summary>
        ...
        public override SendLetter Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<SendLetterData?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "response_msg":
                            ...
                            break;
                        case "data":
                            data = new Option<SendLetterData?>(JsonSerializer.Deserialize<SendLetterData>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (httpCode.IsSet && httpCode.Value == null)
                throw new ArgumentNullException(nameof(httpCode), "Property is not nullable for class SendLetter.");

            if (responseCode.IsSet && responseCode.Value == null)
                throw new ArgumentNullException(nameof(responseCode), "Property is not nullable for class SendLetter.");

            if (responseMsg.IsSet && responseMsg.Value == null)
                throw new ArgumentNullException(nameof(responseMsg), "Property is not nullable for class SendLetter.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class SendLetter.");

            return new SendLetter(httpCode, responseCode, responseMsg, data);
        }

        /// <summary>
        /// Serializes a <see cref="SendLetter" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="sendLetter"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SendLetter sendLetter, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, sendLetter, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SendLetter" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="sendLetter"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SendLetter sendLetter, JsonSerializerOptions jsonSerializerOptions)
        {
            if (sendLetter.ResponseCodeOption.IsSet && sendLetter.ResponseCode == null)
                throw new ArgumentNullException(nameof(sendLetter.ResponseCode), "Property is required for class SendLetter.");

            if (sendLetter.ResponseMsgOption.IsSet && sendLetter.ResponseMsg == null)
                throw new ArgumentNullException(nameof(sendLetter.ResponseMsg), "Property is required for class SendLetter.");

            if (sendLetter.DataOption.IsSet && sendLetter.Data == null)
                throw new ArgumentNullException(nameof(sendLetter.Data), "Property is required for class SendLetter.");

            if (sendLetter.HttpCodeOption.IsSet)
                writer.WriteNumber("http_code", sendLetter.HttpCodeOption.Value!.Value);

            if (sendLetter.ResponseCodeOption.IsSet)
                writer.WriteString("response_code", sendLetter.ResponseCode);

            if (sendLetter.ResponseMsgOption.IsSet)
                writer.WriteString("response_msg", sendLetter.ResponseMsg);

            if (sendLetter.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, sendLetter.Data, jsonSerializerOptions);
            }
        }
    }
}
