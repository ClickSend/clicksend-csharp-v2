...
namespace ClickSend.Model
{
    ...
    /// </summary>
    public partial class CalculateEmailPriceData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CalculateEmailPriceData" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public CalculateEmailPriceData(Option<int?> total = default, Option<int?> perPage = default, Option<int?> currentPage = default, Option<int?> lastPage = default, Option<string?> nextPageUrl = default, Option<string?> prevPageUrl = default, Option<int?> from = default, Option<int?> to = default)
        {
            TotalOption = total;
    ...
    /// <summary>
    /// A Json converter for type <see cref="CalculateEmailPriceData" />
    /// </summary>
    public class CalculateEmailPriceDataJsonConverter : JsonConverter<CalculateEmailPriceData>
    {
        /// <summary>
        /// Deserializes json to <see cref="CalculateEmailPriceData" />
        /// </summary>
        ...
        public override CalculateEmailPriceData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class CalculateEmailPriceData.");

            if (perPage.IsSet && perPage.Value == null)
                throw new ArgumentNullException(nameof(perPage), "Property is not nullable for class CalculateEmailPriceData.");

            if (currentPage.IsSet && currentPage.Value == null)
                throw new ArgumentNullException(nameof(currentPage), "Property is not nullable for class CalculateEmailPriceData.");

            if (lastPage.IsSet && lastPage.Value == null)
                throw new ArgumentNullException(nameof(lastPage), "Property is not nullable for class CalculateEmailPriceData.");

            if (from.IsSet && from.Value == null)
                throw new ArgumentNullException(nameof(from), "Property is not nullable for class CalculateEmailPriceData.");

            if (to.IsSet && to.Value == null)
                throw new ArgumentNullException(nameof(to), "Property is not nullable for class CalculateEmailPriceData.");

            return new CalculateEmailPriceData(total, perPage, currentPage, lastPage, nextPageUrl, prevPageUrl, from, to);
        }

        /// <summary>
        /// Serializes a <see cref="CalculateEmailPriceData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="calculateEmailPriceData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CalculateEmailPriceData calculateEmailPriceData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, calculateEmailPriceData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CalculateEmailPriceData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="calculateEmailPriceData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, CalculateEmailPriceData calculateEmailPriceData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (calculateEmailPriceData.TotalOption.IsSet)
                writer.WriteNumber("total", calculateEmailPriceData.TotalOption.Value!.Value);

            if (calculateEmailPriceData.PerPageOption.IsSet)
                writer.WriteNumber("per_page", calculateEmailPriceData.PerPageOption.Value!.Value);

            if (calculateEmailPriceData.CurrentPageOption.IsSet)
                writer.WriteNumber("current_page", calculateEmailPriceData.CurrentPageOption.Value!.Value);

            if (calculateEmailPriceData.LastPageOption.IsSet)
                writer.WriteNumber("last_page", calculateEmailPriceData.LastPageOption.Value!.Value);

            if (calculateEmailPriceData.NextPageUrlOption.IsSet)
                if (calculateEmailPriceData.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", calculateEmailPriceData.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (calculateEmailPriceData.PrevPageUrlOption.IsSet)
                if (calculateEmailPriceData.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", calculateEmailPriceData.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (calculateEmailPriceData.FromOption.IsSet)
                writer.WriteNumber("from", calculateEmailPriceData.FromOption.Value!.Value);

            if (calculateEmailPriceData.ToOption.IsSet)
                writer.WriteNumber("to", calculateEmailPriceData.ToOption.Value!.Value);
        }
    }
}
