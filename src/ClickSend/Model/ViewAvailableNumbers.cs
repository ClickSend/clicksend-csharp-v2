...
namespace ClickSend.Model
{
    ...
    /// </summary>
    public partial class ViewAvailableNumbers : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewAvailableNumbers" /> class.
        /// </summary>
        ...
        /* <example>Here are some numbers.</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="ViewAvailableNumbers" />
    /// </summary>
    public class ViewAvailableNumbersJsonConverter : JsonConverter<ViewAvailableNumbers>
    {
        /// <summary>
        /// Deserializes json to <see cref="ViewAvailableNumbers" />
        /// </summary>
        ...
        public override ViewAvailableNumbers Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (httpCode.IsSet && httpCode.Value == null)
                throw new ArgumentNullException(nameof(httpCode), "Property is not nullable for class ViewAvailableNumbers.");

            if (responseCode.IsSet && responseCode.Value == null)
                throw new ArgumentNullException(nameof(responseCode), "Property is not nullable for class ViewAvailableNumbers.");

            if (responseMsg.IsSet && responseMsg.Value == null)
                throw new ArgumentNullException(nameof(responseMsg), "Property is not nullable for class ViewAvailableNumbers.");
        ...
        /// <summary>
        /// Serializes a <see cref="ViewAvailableNumbers" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewAvailableNumbers"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ViewAvailableNumbers viewAvailableNumbers, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, viewAvailableNumbers, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ViewAvailableNumbers" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewAvailableNumbers"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ViewAvailableNumbers viewAvailableNumbers, JsonSerializerOptions jsonSerializerOptions)
        {
            if (viewAvailableNumbers.ResponseCodeOption.IsSet && viewAvailableNumbers.ResponseCode == null)
                throw new ArgumentNullException(nameof(viewAvailableNumbers.ResponseCode), "Property is required for class ViewAvailableNumbers.");

            if (viewAvailableNumbers.ResponseMsgOption.IsSet && viewAvailableNumbers.ResponseMsg == null)
                throw new ArgumentNullException(nameof(viewAvailableNumbers.ResponseMsg), "Property is required for class ViewAvailableNumbers.");
            ...
            if (viewAvailableNumbers.ResponseCodeOption.IsSet)
                writer.WriteString("response_code", viewAvailableNumbers.ResponseCode);

            if (viewAvailableNumbers.ResponseMsgOption.IsSet)
                writer.WriteString("response_msg", viewAvailableNumbers.ResponseMsg);

            if (viewAvailableNumbers.DataOption.IsSet)
            {
