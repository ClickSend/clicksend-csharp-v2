...
namespace ClickSend.Model
{
    ...
    /// </summary>
    public partial class ViewSmsCampaignsData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewSmsCampaignsData" /> class.
        /// </summary>
        ...
        /// <param name="data">The parameters related to the SMS campaign.</param>
        [JsonConstructor]
        public ViewSmsCampaignsData(Option<int?> total = default, Option<int?> perPage = default, Option<int?> currentPage = default, Option<int?> lastPage = default, Option<string?> nextPageUrl = default, Option<string?> prevPageUrl = default, Option<int?> from = default, Option<int?> to = default, Option<List<SmsCampaign>?> data = default)
        {
            TotalOption = total;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<SmsCampaign>?> DataOption { get; private set; }

        /// <summary>
        /// The parameters related to the SMS campaign.
        /// </summary>
        /// <value>The parameters related to the SMS campaign.</value>
        [JsonPropertyName("data")]
        public List<SmsCampaign>? Data { get { return this.DataOption.Value; } set { this.DataOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ViewSmsCampaignsData" />
    /// </summary>
    public class ViewSmsCampaignsDataJsonConverter : JsonConverter<ViewSmsCampaignsData>
    {
        /// <summary>
        /// Deserializes json to <see cref="ViewSmsCampaignsData" />
        /// </summary>
        ...
        public override ViewSmsCampaignsData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<SmsCampaign>?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "to":
                            ...
                            break;
                        case "data":
                            data = new Option<List<SmsCampaign>?>(JsonSerializer.Deserialize<List<SmsCampaign>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class ViewSmsCampaignsData.");

            if (perPage.IsSet && perPage.Value == null)
                throw new ArgumentNullException(nameof(perPage), "Property is not nullable for class ViewSmsCampaignsData.");

            if (currentPage.IsSet && currentPage.Value == null)
                throw new ArgumentNullException(nameof(currentPage), "Property is not nullable for class ViewSmsCampaignsData.");

            if (lastPage.IsSet && lastPage.Value == null)
                throw new ArgumentNullException(nameof(lastPage), "Property is not nullable for class ViewSmsCampaignsData.");

            if (from.IsSet && from.Value == null)
                throw new ArgumentNullException(nameof(from), "Property is not nullable for class ViewSmsCampaignsData.");

            if (to.IsSet && to.Value == null)
                throw new ArgumentNullException(nameof(to), "Property is not nullable for class ViewSmsCampaignsData.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ViewSmsCampaignsData.");

            return new ViewSmsCampaignsData(total, perPage, currentPage, lastPage, nextPageUrl, prevPageUrl, from, to, data);
        }

        /// <summary>
        /// Serializes a <see cref="ViewSmsCampaignsData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewSmsCampaignsData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ViewSmsCampaignsData viewSmsCampaignsData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, viewSmsCampaignsData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ViewSmsCampaignsData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewSmsCampaignsData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ViewSmsCampaignsData viewSmsCampaignsData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (viewSmsCampaignsData.DataOption.IsSet && viewSmsCampaignsData.Data == null)
                throw new ArgumentNullException(nameof(viewSmsCampaignsData.Data), "Property is required for class ViewSmsCampaignsData.");

            if (viewSmsCampaignsData.TotalOption.IsSet)
                writer.WriteNumber("total", viewSmsCampaignsData.TotalOption.Value!.Value);

            if (viewSmsCampaignsData.PerPageOption.IsSet)
                writer.WriteNumber("per_page", viewSmsCampaignsData.PerPageOption.Value!.Value);

            if (viewSmsCampaignsData.CurrentPageOption.IsSet)
                writer.WriteNumber("current_page", viewSmsCampaignsData.CurrentPageOption.Value!.Value);

            if (viewSmsCampaignsData.LastPageOption.IsSet)
                writer.WriteNumber("last_page", viewSmsCampaignsData.LastPageOption.Value!.Value);

            if (viewSmsCampaignsData.NextPageUrlOption.IsSet)
                if (viewSmsCampaignsData.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", viewSmsCampaignsData.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (viewSmsCampaignsData.PrevPageUrlOption.IsSet)
                if (viewSmsCampaignsData.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", viewSmsCampaignsData.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (viewSmsCampaignsData.FromOption.IsSet)
                writer.WriteNumber("from", viewSmsCampaignsData.FromOption.Value!.Value);

            if (viewSmsCampaignsData.ToOption.IsSet)
                writer.WriteNumber("to", viewSmsCampaignsData.ToOption.Value!.Value);

            if (viewSmsCampaignsData.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, viewSmsCampaignsData.Data, jsonSerializerOptions);
            }
        }
    }
}
