...
namespace ClickSend.Model
{
    ...
    /// CalculateSmsPrice
    /// </summary>
    public partial class CalculateSmsPrice : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CalculateSmsPrice" /> class.
        /// </summary>
        /// <param name="httpCode">The HTTP code of the response. Visit [this page](/#status-codes) for more information.  This parameter doesn’t reflect the status of each message. Check the status parameter of the message object to view the status of the individual message.</param>
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<CalculateSmsPriceData?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        [JsonPropertyName("data")]
        public CalculateSmsPriceData? Data { get { return this.DataOption.Value; } set { this.DataOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="CalculateSmsPrice" />
    /// </summary>
    public class CalculateSmsPriceJsonConverter : JsonConverter<CalculateSmsPrice>
    {
        /// <summary>
        /// Deserializes json to <see cref="CalculateSmsPrice" />
        /// </summary>
        ...
        public override CalculateSmsPrice Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "response_msg":
                            ...
                            break;
                        case "data":
                            data = new Option<CalculateSmsPriceData?>(JsonSerializer.Deserialize<CalculateSmsPriceData>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (httpCode.IsSet && httpCode.Value == null)
                throw new ArgumentNullException(nameof(httpCode), "Property is not nullable for class CalculateSmsPrice.");

            if (responseCode.IsSet && responseCode.Value == null)
                throw new ArgumentNullException(nameof(responseCode), "Property is not nullable for class CalculateSmsPrice.");

            if (responseMsg.IsSet && responseMsg.Value == null)
                throw new ArgumentNullException(nameof(responseMsg), "Property is not nullable for class CalculateSmsPrice.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class CalculateSmsPrice.");

            return new CalculateSmsPrice(httpCode, responseCode, responseMsg, data);
        }

        /// <summary>
        /// Serializes a <see cref="CalculateSmsPrice" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="calculateSmsPrice"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CalculateSmsPrice calculateSmsPrice, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, calculateSmsPrice, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CalculateSmsPrice" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="calculateSmsPrice"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, CalculateSmsPrice calculateSmsPrice, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (calculateSmsPrice.ResponseMsgOption.IsSet && calculateSmsPrice.ResponseMsg == null)
                throw new ArgumentNullException(nameof(calculateSmsPrice.ResponseMsg), "Property is required for class CalculateSmsPrice.");

            if (calculateSmsPrice.DataOption.IsSet && calculateSmsPrice.Data == null)
            ...
            if (calculateSmsPrice.ResponseMsgOption.IsSet)
                writer.WriteString("response_msg", calculateSmsPrice.ResponseMsg);

            if (calculateSmsPrice.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, calculateSmsPrice.Data, jsonSerializerOptions);
            }
        }
    }
}
