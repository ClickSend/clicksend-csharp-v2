...
namespace ClickSend.Model
{
    ...
    /// </summary>
    public partial class ViewReferralAccountsData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewReferralAccountsData" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ViewReferralAccountsData(Option<int?> total = default, Option<int?> perPage = default, Option<int?> currentPage = default, Option<int?> lastPage = default, Option<string?> nextPageUrl = default, Option<string?> prevPageUrl = default, Option<int?> from = default, Option<int?> to = default, Option<List<ViewReferralAccountsDataAllOfDataInner>?> data = default)
        {
            TotalOption = total;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<ViewReferralAccountsDataAllOfDataInner>?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        /* <example>[{&quot;referral_rule_id&quot;:1,&quot;refered_user_id&quot;:24,&quot;date_referred&quot;:1438260940,&quot;percentage_referral&quot;:5},{&quot;referral_rule_id&quot;:2,&quot;refered_user_id&quot;:25,&quot;date_referred&quot;:1438260989,&quot;percentage_referral&quot;:5}]</example> */
        [JsonPropertyName("data")]
        public List<ViewReferralAccountsDataAllOfDataInner>? Data { get { return this.DataOption.Value; } set { this.DataOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ViewReferralAccountsData" />
    /// </summary>
    public class ViewReferralAccountsDataJsonConverter : JsonConverter<ViewReferralAccountsData>
    {
        /// <summary>
        /// Deserializes json to <see cref="ViewReferralAccountsData" />
        /// </summary>
        ...
        public override ViewReferralAccountsData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<ViewReferralAccountsDataAllOfDataInner>?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "to":
                            ...
                            break;
                        case "data":
                            data = new Option<List<ViewReferralAccountsDataAllOfDataInner>?>(JsonSerializer.Deserialize<List<ViewReferralAccountsDataAllOfDataInner>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class ViewReferralAccountsData.");

            if (perPage.IsSet && perPage.Value == null)
                throw new ArgumentNullException(nameof(perPage), "Property is not nullable for class ViewReferralAccountsData.");

            if (currentPage.IsSet && currentPage.Value == null)
                throw new ArgumentNullException(nameof(currentPage), "Property is not nullable for class ViewReferralAccountsData.");

            if (lastPage.IsSet && lastPage.Value == null)
                throw new ArgumentNullException(nameof(lastPage), "Property is not nullable for class ViewReferralAccountsData.");

            if (from.IsSet && from.Value == null)
                throw new ArgumentNullException(nameof(from), "Property is not nullable for class ViewReferralAccountsData.");

            if (to.IsSet && to.Value == null)
                throw new ArgumentNullException(nameof(to), "Property is not nullable for class ViewReferralAccountsData.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ViewReferralAccountsData.");

            return new ViewReferralAccountsData(total, perPage, currentPage, lastPage, nextPageUrl, prevPageUrl, from, to, data);
        }

        /// <summary>
        /// Serializes a <see cref="ViewReferralAccountsData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewReferralAccountsData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ViewReferralAccountsData viewReferralAccountsData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, viewReferralAccountsData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ViewReferralAccountsData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewReferralAccountsData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ViewReferralAccountsData viewReferralAccountsData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (viewReferralAccountsData.DataOption.IsSet && viewReferralAccountsData.Data == null)
                throw new ArgumentNullException(nameof(viewReferralAccountsData.Data), "Property is required for class ViewReferralAccountsData.");

            if (viewReferralAccountsData.TotalOption.IsSet)
                writer.WriteNumber("total", viewReferralAccountsData.TotalOption.Value!.Value);

            if (viewReferralAccountsData.PerPageOption.IsSet)
                writer.WriteNumber("per_page", viewReferralAccountsData.PerPageOption.Value!.Value);

            if (viewReferralAccountsData.CurrentPageOption.IsSet)
                writer.WriteNumber("current_page", viewReferralAccountsData.CurrentPageOption.Value!.Value);

            if (viewReferralAccountsData.LastPageOption.IsSet)
                writer.WriteNumber("last_page", viewReferralAccountsData.LastPageOption.Value!.Value);

            if (viewReferralAccountsData.NextPageUrlOption.IsSet)
                if (viewReferralAccountsData.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", viewReferralAccountsData.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (viewReferralAccountsData.PrevPageUrlOption.IsSet)
                if (viewReferralAccountsData.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", viewReferralAccountsData.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (viewReferralAccountsData.FromOption.IsSet)
                writer.WriteNumber("from", viewReferralAccountsData.FromOption.Value!.Value);

            if (viewReferralAccountsData.ToOption.IsSet)
                writer.WriteNumber("to", viewReferralAccountsData.ToOption.Value!.Value);

            if (viewReferralAccountsData.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, viewReferralAccountsData.Data, jsonSerializerOptions);
            }
        }
    }
}
