...
namespace ClickSend.Model
{
    ...
    /// SendFax
    /// </summary>
    public partial class SendFax : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SendFax" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public SendFax(Option<int?> httpCode = default, Option<string?> responseCode = default, Option<string?> responseMsg = default, Option<SendFaxData?> data = default)
        {
        ...
        /* <example>Fax queued for delivery.</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="SendFax" />
    /// </summary>
    public class SendFaxJsonConverter : JsonConverter<SendFax>
    {
        /// <summary>
        /// Deserializes json to <see cref="SendFax" />
        /// </summary>
        ...
        public override SendFax Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (httpCode.IsSet && httpCode.Value == null)
                throw new ArgumentNullException(nameof(httpCode), "Property is not nullable for class SendFax.");

            if (responseCode.IsSet && responseCode.Value == null)
                throw new ArgumentNullException(nameof(responseCode), "Property is not nullable for class SendFax.");

            if (responseMsg.IsSet && responseMsg.Value == null)
                throw new ArgumentNullException(nameof(responseMsg), "Property is not nullable for class SendFax.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class SendFax.");

            return new SendFax(httpCode, responseCode, responseMsg, data);
        }

        /// <summary>
        /// Serializes a <see cref="SendFax" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="sendFax"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SendFax sendFax, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, sendFax, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SendFax" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="sendFax"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SendFax sendFax, JsonSerializerOptions jsonSerializerOptions)
        {
            if (sendFax.ResponseCodeOption.IsSet && sendFax.ResponseCode == null)
                throw new ArgumentNullException(nameof(sendFax.ResponseCode), "Property is required for class SendFax.");

            if (sendFax.ResponseMsgOption.IsSet && sendFax.ResponseMsg == null)
                throw new ArgumentNullException(nameof(sendFax.ResponseMsg), "Property is required for class SendFax.");

            if (sendFax.DataOption.IsSet && sendFax.Data == null)
                throw new ArgumentNullException(nameof(sendFax.Data), "Property is required for class SendFax.");

            if (sendFax.HttpCodeOption.IsSet)
                writer.WriteNumber("http_code", sendFax.HttpCodeOption.Value!.Value);

            if (sendFax.ResponseCodeOption.IsSet)
                writer.WriteString("response_code", sendFax.ResponseCode);

            if (sendFax.ResponseMsgOption.IsSet)
                writer.WriteString("response_msg", sendFax.ResponseMsg);

            if (sendFax.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, sendFax.Data, jsonSerializerOptions);
            }
        }
    }
}
