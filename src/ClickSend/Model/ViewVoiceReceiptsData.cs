...
namespace ClickSend.Model
{
    ...
    /// </summary>
    public partial class ViewVoiceReceiptsData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewVoiceReceiptsData" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ViewVoiceReceiptsData(Option<int?> total = default, Option<int?> perPage = default, Option<int?> currentPage = default, Option<int?> lastPage = default, Option<string?> nextPageUrl = default, Option<string?> prevPageUrl = default, Option<int?> from = default, Option<int?> to = default, Option<List<VoiceReceipt>?> data = default)
        {
            TotalOption = total;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<VoiceReceipt>?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        /* <example>[{&quot;timestamp_send&quot;:&quot;1442381791&quot;,&quot;timestamp&quot;:&quot;1442381791&quot;,&quot;message_id&quot;:&quot;31BC271B-1E0C-45F6-9E7E-97186C46BB82&quot;,&quot;status_code&quot;:&quot;201&quot;,&quot;status_text&quot;:&quot;Success: Message received on handset.&quot;,&quot;error_code&quot;:null,&quot;error_text&quot;:null,&quot;custom_string&quot;:null,&quot;message_type&quot;:&quot;voice&quot;,&quot;digits&quot;:2},{&quot;timestamp_send&quot;:&quot;1442381829&quot;,&quot;timestamp&quot;:&quot;1442381829&quot;,&quot;message_id&quot;:&quot;23C8ADA3-FD8B-420B-801A-F829BB87AC6F&quot;,&quot;status_code&quot;:&quot;201&quot;,&quot;status_text&quot;:&quot;Success: Message received on handset.&quot;,&quot;error_code&quot;:null,&quot;error_text&quot;:null,&quot;custom_string&quot;:null,&quot;message_type&quot;:&quot;voice&quot;,&quot;digits&quot;:5}]</example> */
        [JsonPropertyName("data")]
        public List<VoiceReceipt>? Data { get { return this.DataOption.Value; } set { this.DataOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ViewVoiceReceiptsData" />
    /// </summary>
    public class ViewVoiceReceiptsDataJsonConverter : JsonConverter<ViewVoiceReceiptsData>
    {
        /// <summary>
        /// Deserializes json to <see cref="ViewVoiceReceiptsData" />
        /// </summary>
        ...
        public override ViewVoiceReceiptsData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<VoiceReceipt>?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "to":
                            ...
                            break;
                        case "data":
                            data = new Option<List<VoiceReceipt>?>(JsonSerializer.Deserialize<List<VoiceReceipt>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class ViewVoiceReceiptsData.");

            if (perPage.IsSet && perPage.Value == null)
                throw new ArgumentNullException(nameof(perPage), "Property is not nullable for class ViewVoiceReceiptsData.");

            if (currentPage.IsSet && currentPage.Value == null)
                throw new ArgumentNullException(nameof(currentPage), "Property is not nullable for class ViewVoiceReceiptsData.");

            if (lastPage.IsSet && lastPage.Value == null)
                throw new ArgumentNullException(nameof(lastPage), "Property is not nullable for class ViewVoiceReceiptsData.");

            if (from.IsSet && from.Value == null)
                throw new ArgumentNullException(nameof(from), "Property is not nullable for class ViewVoiceReceiptsData.");

            if (to.IsSet && to.Value == null)
                throw new ArgumentNullException(nameof(to), "Property is not nullable for class ViewVoiceReceiptsData.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ViewVoiceReceiptsData.");

            return new ViewVoiceReceiptsData(total, perPage, currentPage, lastPage, nextPageUrl, prevPageUrl, from, to, data);
        }

        /// <summary>
        /// Serializes a <see cref="ViewVoiceReceiptsData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewVoiceReceiptsData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ViewVoiceReceiptsData viewVoiceReceiptsData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, viewVoiceReceiptsData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ViewVoiceReceiptsData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewVoiceReceiptsData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ViewVoiceReceiptsData viewVoiceReceiptsData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (viewVoiceReceiptsData.DataOption.IsSet && viewVoiceReceiptsData.Data == null)
                throw new ArgumentNullException(nameof(viewVoiceReceiptsData.Data), "Property is required for class ViewVoiceReceiptsData.");

            if (viewVoiceReceiptsData.TotalOption.IsSet)
                writer.WriteNumber("total", viewVoiceReceiptsData.TotalOption.Value!.Value);

            if (viewVoiceReceiptsData.PerPageOption.IsSet)
                writer.WriteNumber("per_page", viewVoiceReceiptsData.PerPageOption.Value!.Value);

            if (viewVoiceReceiptsData.CurrentPageOption.IsSet)
                writer.WriteNumber("current_page", viewVoiceReceiptsData.CurrentPageOption.Value!.Value);

            if (viewVoiceReceiptsData.LastPageOption.IsSet)
                writer.WriteNumber("last_page", viewVoiceReceiptsData.LastPageOption.Value!.Value);

            if (viewVoiceReceiptsData.NextPageUrlOption.IsSet)
                if (viewVoiceReceiptsData.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", viewVoiceReceiptsData.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (viewVoiceReceiptsData.PrevPageUrlOption.IsSet)
                if (viewVoiceReceiptsData.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", viewVoiceReceiptsData.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (viewVoiceReceiptsData.FromOption.IsSet)
                writer.WriteNumber("from", viewVoiceReceiptsData.FromOption.Value!.Value);

            if (viewVoiceReceiptsData.ToOption.IsSet)
                writer.WriteNumber("to", viewVoiceReceiptsData.ToOption.Value!.Value);

            if (viewVoiceReceiptsData.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, viewVoiceReceiptsData.Data, jsonSerializerOptions);
            }
        }
    }
}
