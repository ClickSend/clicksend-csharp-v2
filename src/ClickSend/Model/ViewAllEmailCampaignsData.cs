...
namespace ClickSend.Model
{
    ...
    /// </summary>
    public partial class ViewAllEmailCampaignsData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewAllEmailCampaignsData" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ViewAllEmailCampaignsData(Option<int?> total = default, Option<int?> perPage = default, Option<int?> currentPage = default, Option<int?> lastPage = default, Option<string?> nextPageUrl = default, Option<string?> prevPageUrl = default, Option<int?> from = default, Option<int?> to = default, Option<List<EmailCampaign>?> data = default)
        {
            TotalOption = total;
    ...
    /// <summary>
    /// A Json converter for type <see cref="ViewAllEmailCampaignsData" />
    /// </summary>
    public class ViewAllEmailCampaignsDataJsonConverter : JsonConverter<ViewAllEmailCampaignsData>
    {
        /// <summary>
        /// Deserializes json to <see cref="ViewAllEmailCampaignsData" />
        /// </summary>
        ...
        public override ViewAllEmailCampaignsData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<EmailCampaign>?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "to":
                            ...
                            break;
                        case "data":
                            data = new Option<List<EmailCampaign>?>(JsonSerializer.Deserialize<List<EmailCampaign>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class ViewAllEmailCampaignsData.");

            if (perPage.IsSet && perPage.Value == null)
                throw new ArgumentNullException(nameof(perPage), "Property is not nullable for class ViewAllEmailCampaignsData.");

            if (currentPage.IsSet && currentPage.Value == null)
                throw new ArgumentNullException(nameof(currentPage), "Property is not nullable for class ViewAllEmailCampaignsData.");

            if (lastPage.IsSet && lastPage.Value == null)
                throw new ArgumentNullException(nameof(lastPage), "Property is not nullable for class ViewAllEmailCampaignsData.");

            if (from.IsSet && from.Value == null)
                throw new ArgumentNullException(nameof(from), "Property is not nullable for class ViewAllEmailCampaignsData.");

            if (to.IsSet && to.Value == null)
                throw new ArgumentNullException(nameof(to), "Property is not nullable for class ViewAllEmailCampaignsData.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ViewAllEmailCampaignsData.");

            return new ViewAllEmailCampaignsData(total, perPage, currentPage, lastPage, nextPageUrl, prevPageUrl, from, to, data);
        }

        /// <summary>
        /// Serializes a <see cref="ViewAllEmailCampaignsData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewAllEmailCampaignsData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ViewAllEmailCampaignsData viewAllEmailCampaignsData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, viewAllEmailCampaignsData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ViewAllEmailCampaignsData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewAllEmailCampaignsData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ViewAllEmailCampaignsData viewAllEmailCampaignsData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (viewAllEmailCampaignsData.DataOption.IsSet && viewAllEmailCampaignsData.Data == null)
                throw new ArgumentNullException(nameof(viewAllEmailCampaignsData.Data), "Property is required for class ViewAllEmailCampaignsData.");

            if (viewAllEmailCampaignsData.TotalOption.IsSet)
                writer.WriteNumber("total", viewAllEmailCampaignsData.TotalOption.Value!.Value);

            if (viewAllEmailCampaignsData.PerPageOption.IsSet)
                writer.WriteNumber("per_page", viewAllEmailCampaignsData.PerPageOption.Value!.Value);

            if (viewAllEmailCampaignsData.CurrentPageOption.IsSet)
                writer.WriteNumber("current_page", viewAllEmailCampaignsData.CurrentPageOption.Value!.Value);

            if (viewAllEmailCampaignsData.LastPageOption.IsSet)
                writer.WriteNumber("last_page", viewAllEmailCampaignsData.LastPageOption.Value!.Value);

            if (viewAllEmailCampaignsData.NextPageUrlOption.IsSet)
                if (viewAllEmailCampaignsData.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", viewAllEmailCampaignsData.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (viewAllEmailCampaignsData.PrevPageUrlOption.IsSet)
                if (viewAllEmailCampaignsData.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", viewAllEmailCampaignsData.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (viewAllEmailCampaignsData.FromOption.IsSet)
                writer.WriteNumber("from", viewAllEmailCampaignsData.FromOption.Value!.Value);

            if (viewAllEmailCampaignsData.ToOption.IsSet)
                writer.WriteNumber("to", viewAllEmailCampaignsData.ToOption.Value!.Value);

            if (viewAllEmailCampaignsData.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, viewAllEmailCampaignsData.Data, jsonSerializerOptions);
            }
        }
    }
}
