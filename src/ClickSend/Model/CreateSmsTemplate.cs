...
namespace ClickSend.Model
{
    ...
    /// CreateSmsTemplate
    /// </summary>
    public partial class CreateSmsTemplate : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSmsTemplate" /> class.
        /// </summary>
        ...
        /* <example>New template has been saved.</example> */
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<SmsTemplate?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        [JsonPropertyName("data")]
        public SmsTemplate? Data { get { return this.DataOption.Value; } set { this.DataOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="CreateSmsTemplate" />
    /// </summary>
    public class CreateSmsTemplateJsonConverter : JsonConverter<CreateSmsTemplate>
    {
        /// <summary>
        /// Deserializes json to <see cref="CreateSmsTemplate" />
        /// </summary>
        ...
        public override CreateSmsTemplate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "response_msg":
                            ...
                            break;
                        case "data":
                            data = new Option<SmsTemplate?>(JsonSerializer.Deserialize<SmsTemplate>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (httpCode.IsSet && httpCode.Value == null)
                throw new ArgumentNullException(nameof(httpCode), "Property is not nullable for class CreateSmsTemplate.");

            if (responseCode.IsSet && responseCode.Value == null)
                throw new ArgumentNullException(nameof(responseCode), "Property is not nullable for class CreateSmsTemplate.");

            if (responseMsg.IsSet && responseMsg.Value == null)
                throw new ArgumentNullException(nameof(responseMsg), "Property is not nullable for class CreateSmsTemplate.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class CreateSmsTemplate.");

            return new CreateSmsTemplate(httpCode, responseCode, responseMsg, data);
        }

        /// <summary>
        /// Serializes a <see cref="CreateSmsTemplate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createSmsTemplate"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, CreateSmsTemplate createSmsTemplate, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, createSmsTemplate, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="CreateSmsTemplate" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="createSmsTemplate"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, CreateSmsTemplate createSmsTemplate, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (createSmsTemplate.ResponseMsgOption.IsSet && createSmsTemplate.ResponseMsg == null)
                throw new ArgumentNullException(nameof(createSmsTemplate.ResponseMsg), "Property is required for class CreateSmsTemplate.");

            if (createSmsTemplate.DataOption.IsSet && createSmsTemplate.Data == null)
            ...
            if (createSmsTemplate.ResponseMsgOption.IsSet)
                writer.WriteString("response_msg", createSmsTemplate.ResponseMsg);

            if (createSmsTemplate.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, createSmsTemplate.Data, jsonSerializerOptions);
            }
        }
    }
}
