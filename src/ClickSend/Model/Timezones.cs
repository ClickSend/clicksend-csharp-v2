...
namespace ClickSend.Model
{
    ...
    /// Timezones
    /// </summary>
    public partial class Timezones : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Timezones" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public Timezones(Option<int?> httpCode = default, Option<string?> responseCode = default, Option<string?> responseMsg = default, Option<List<string>?> data = default)
        {
        ...
        /* <example>List of timezones.</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="Timezones" />
    /// </summary>
    public class TimezonesJsonConverter : JsonConverter<Timezones>
    {
        /// <summary>
        /// Deserializes json to <see cref="Timezones" />
        /// </summary>
        ...
        public override Timezones Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (httpCode.IsSet && httpCode.Value == null)
                throw new ArgumentNullException(nameof(httpCode), "Property is not nullable for class Timezones.");

            if (responseCode.IsSet && responseCode.Value == null)
                throw new ArgumentNullException(nameof(responseCode), "Property is not nullable for class Timezones.");

            if (responseMsg.IsSet && responseMsg.Value == null)
                throw new ArgumentNullException(nameof(responseMsg), "Property is not nullable for class Timezones.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class Timezones.");

            return new Timezones(httpCode, responseCode, responseMsg, data);
        }

        /// <summary>
        /// Serializes a <see cref="Timezones" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="timezones"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Timezones timezones, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, timezones, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Timezones" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="timezones"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Timezones timezones, JsonSerializerOptions jsonSerializerOptions)
        {
            if (timezones.ResponseCodeOption.IsSet && timezones.ResponseCode == null)
                throw new ArgumentNullException(nameof(timezones.ResponseCode), "Property is required for class Timezones.");

            if (timezones.ResponseMsgOption.IsSet && timezones.ResponseMsg == null)
                throw new ArgumentNullException(nameof(timezones.ResponseMsg), "Property is required for class Timezones.");

            if (timezones.DataOption.IsSet && timezones.Data == null)
                throw new ArgumentNullException(nameof(timezones.Data), "Property is required for class Timezones.");

            if (timezones.HttpCodeOption.IsSet)
                writer.WriteNumber("http_code", timezones.HttpCodeOption.Value!.Value);

            if (timezones.ResponseCodeOption.IsSet)
                writer.WriteString("response_code", timezones.ResponseCode);

            if (timezones.ResponseMsgOption.IsSet)
                writer.WriteString("response_msg", timezones.ResponseMsg);

            if (timezones.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, timezones.Data, jsonSerializerOptions);
            }
        }
    }
}
