...
namespace ClickSend.Model
{
    ...
    /// </summary>
    public partial class ViewMasterEmailTemplates : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewMasterEmailTemplates" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ViewMasterEmailTemplates(Option<int?> httpCode = default, Option<string?> responseCode = default, Option<string?> responseMsg = default, Option<List<MasterEmailTemplate>?> data = default)
        {
        ...
        /* <example>List of Email Master Templates</example> */
    ...
    /// <summary>
    /// A Json converter for type <see cref="ViewMasterEmailTemplates" />
    /// </summary>
    public class ViewMasterEmailTemplatesJsonConverter : JsonConverter<ViewMasterEmailTemplates>
    {
        /// <summary>
        /// Deserializes json to <see cref="ViewMasterEmailTemplates" />
        /// </summary>
        ...
        public override ViewMasterEmailTemplates Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (httpCode.IsSet && httpCode.Value == null)
                throw new ArgumentNullException(nameof(httpCode), "Property is not nullable for class ViewMasterEmailTemplates.");

            if (responseCode.IsSet && responseCode.Value == null)
                throw new ArgumentNullException(nameof(responseCode), "Property is not nullable for class ViewMasterEmailTemplates.");

            if (responseMsg.IsSet && responseMsg.Value == null)
                throw new ArgumentNullException(nameof(responseMsg), "Property is not nullable for class ViewMasterEmailTemplates.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ViewMasterEmailTemplates.");

            return new ViewMasterEmailTemplates(httpCode, responseCode, responseMsg, data);
        }

        /// <summary>
        /// Serializes a <see cref="ViewMasterEmailTemplates" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewMasterEmailTemplates"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ViewMasterEmailTemplates viewMasterEmailTemplates, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, viewMasterEmailTemplates, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ViewMasterEmailTemplates" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewMasterEmailTemplates"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ViewMasterEmailTemplates viewMasterEmailTemplates, JsonSerializerOptions jsonSerializerOptions)
        {
            if (viewMasterEmailTemplates.ResponseCodeOption.IsSet && viewMasterEmailTemplates.ResponseCode == null)
                throw new ArgumentNullException(nameof(viewMasterEmailTemplates.ResponseCode), "Property is required for class ViewMasterEmailTemplates.");

            if (viewMasterEmailTemplates.ResponseMsgOption.IsSet && viewMasterEmailTemplates.ResponseMsg == null)
                throw new ArgumentNullException(nameof(viewMasterEmailTemplates.ResponseMsg), "Property is required for class ViewMasterEmailTemplates.");

            if (viewMasterEmailTemplates.DataOption.IsSet && viewMasterEmailTemplates.Data == null)
                throw new ArgumentNullException(nameof(viewMasterEmailTemplates.Data), "Property is required for class ViewMasterEmailTemplates.");

            if (viewMasterEmailTemplates.HttpCodeOption.IsSet)
                writer.WriteNumber("http_code", viewMasterEmailTemplates.HttpCodeOption.Value!.Value);

            if (viewMasterEmailTemplates.ResponseCodeOption.IsSet)
                writer.WriteString("response_code", viewMasterEmailTemplates.ResponseCode);

            if (viewMasterEmailTemplates.ResponseMsgOption.IsSet)
                writer.WriteString("response_msg", viewMasterEmailTemplates.ResponseMsg);

            if (viewMasterEmailTemplates.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, viewMasterEmailTemplates.Data, jsonSerializerOptions);
            }
        }
    }
}
