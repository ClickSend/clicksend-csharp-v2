...
namespace ClickSend.Model
{
    ...
    /// </summary>
    public partial class ViewListContactsData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewListContactsData" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ViewListContactsData(Option<int?> total = default, Option<int?> perPage = default, Option<int?> currentPage = default, Option<int?> lastPage = default, Option<string?> nextPageUrl = default, Option<string?> prevPageUrl = default, Option<int?> from = default, Option<int?> to = default, Option<List<Contact>?> data = default)
        {
            TotalOption = total;
    ...
    /// <summary>
    /// A Json converter for type <see cref="ViewListContactsData" />
    /// </summary>
    public class ViewListContactsDataJsonConverter : JsonConverter<ViewListContactsData>
    {
        /// <summary>
        /// Deserializes json to <see cref="ViewListContactsData" />
        /// </summary>
        ...
        public override ViewListContactsData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class ViewListContactsData.");

            if (perPage.IsSet && perPage.Value == null)
                throw new ArgumentNullException(nameof(perPage), "Property is not nullable for class ViewListContactsData.");

            if (currentPage.IsSet && currentPage.Value == null)
                throw new ArgumentNullException(nameof(currentPage), "Property is not nullable for class ViewListContactsData.");

            if (lastPage.IsSet && lastPage.Value == null)
                throw new ArgumentNullException(nameof(lastPage), "Property is not nullable for class ViewListContactsData.");

            if (from.IsSet && from.Value == null)
                throw new ArgumentNullException(nameof(from), "Property is not nullable for class ViewListContactsData.");

            if (to.IsSet && to.Value == null)
                throw new ArgumentNullException(nameof(to), "Property is not nullable for class ViewListContactsData.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ViewListContactsData.");

            return new ViewListContactsData(total, perPage, currentPage, lastPage, nextPageUrl, prevPageUrl, from, to, data);
        }

        /// <summary>
        /// Serializes a <see cref="ViewListContactsData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewListContactsData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ViewListContactsData viewListContactsData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, viewListContactsData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ViewListContactsData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewListContactsData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ViewListContactsData viewListContactsData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (viewListContactsData.DataOption.IsSet && viewListContactsData.Data == null)
                throw new ArgumentNullException(nameof(viewListContactsData.Data), "Property is required for class ViewListContactsData.");

            if (viewListContactsData.TotalOption.IsSet)
                writer.WriteNumber("total", viewListContactsData.TotalOption.Value!.Value);

            if (viewListContactsData.PerPageOption.IsSet)
                writer.WriteNumber("per_page", viewListContactsData.PerPageOption.Value!.Value);

            if (viewListContactsData.CurrentPageOption.IsSet)
                writer.WriteNumber("current_page", viewListContactsData.CurrentPageOption.Value!.Value);

            if (viewListContactsData.LastPageOption.IsSet)
                writer.WriteNumber("last_page", viewListContactsData.LastPageOption.Value!.Value);

            if (viewListContactsData.NextPageUrlOption.IsSet)
                if (viewListContactsData.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", viewListContactsData.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (viewListContactsData.PrevPageUrlOption.IsSet)
                if (viewListContactsData.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", viewListContactsData.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (viewListContactsData.FromOption.IsSet)
                writer.WriteNumber("from", viewListContactsData.FromOption.Value!.Value);

            if (viewListContactsData.ToOption.IsSet)
                writer.WriteNumber("to", viewListContactsData.ToOption.Value!.Value);

            if (viewListContactsData.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, viewListContactsData.Data, jsonSerializerOptions);
            }
        }
    }
}
