...
namespace ClickSend.Model
{
    ...
    /// SendMms
    /// </summary>
    public partial class SendMms : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SendMms" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public SendMms(Option<int?> httpCode = default, Option<string?> responseCode = default, Option<string?> responseMsg = default, Option<SendMmsData?> data = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="SendMms" />
    /// </summary>
    public class SendMmsJsonConverter : JsonConverter<SendMms>
    {
        /// <summary>
        /// Deserializes json to <see cref="SendMms" />
        /// </summary>
        ...
        public override SendMms Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (httpCode.IsSet && httpCode.Value == null)
                throw new ArgumentNullException(nameof(httpCode), "Property is not nullable for class SendMms.");

            if (responseCode.IsSet && responseCode.Value == null)
                throw new ArgumentNullException(nameof(responseCode), "Property is not nullable for class SendMms.");

            if (responseMsg.IsSet && responseMsg.Value == null)
                throw new ArgumentNullException(nameof(responseMsg), "Property is not nullable for class SendMms.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class SendMms.");

            return new SendMms(httpCode, responseCode, responseMsg, data);
        }

        /// <summary>
        /// Serializes a <see cref="SendMms" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="sendMms"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SendMms sendMms, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, sendMms, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SendMms" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="sendMms"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SendMms sendMms, JsonSerializerOptions jsonSerializerOptions)
        {
            if (sendMms.ResponseCodeOption.IsSet && sendMms.ResponseCode == null)
                throw new ArgumentNullException(nameof(sendMms.ResponseCode), "Property is required for class SendMms.");

            if (sendMms.ResponseMsgOption.IsSet && sendMms.ResponseMsg == null)
                throw new ArgumentNullException(nameof(sendMms.ResponseMsg), "Property is required for class SendMms.");

            if (sendMms.DataOption.IsSet && sendMms.Data == null)
                throw new ArgumentNullException(nameof(sendMms.Data), "Property is required for class SendMms.");

            if (sendMms.HttpCodeOption.IsSet)
                writer.WriteNumber("http_code", sendMms.HttpCodeOption.Value!.Value);

            if (sendMms.ResponseCodeOption.IsSet)
                writer.WriteString("response_code", sendMms.ResponseCode);

            if (sendMms.ResponseMsgOption.IsSet)
                writer.WriteString("response_msg", sendMms.ResponseMsg);

            if (sendMms.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, sendMms.Data, jsonSerializerOptions);
            }
        }
    }
}
