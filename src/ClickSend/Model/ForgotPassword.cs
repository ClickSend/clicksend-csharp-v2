...
namespace ClickSend.Model
{
    ...
    public partial class ForgotPassword : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ForgotPassword(Option<int?> httpCode = default, Option<string?> responseCode = default, Option<string?> responseMsg = default, Option<List<string>?> data = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="ForgotPassword" />
    /// </summary>
    public class ForgotPasswordJsonConverter : JsonConverter<ForgotPassword>
    {
        /// <summary>
        /// Deserializes json to <see cref="ForgotPassword" />
        /// </summary>
        ...
        public override ForgotPassword Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (httpCode.IsSet && httpCode.Value == null)
                throw new ArgumentNullException(nameof(httpCode), "Property is not nullable for class ForgotPassword.");

            if (responseCode.IsSet && responseCode.Value == null)
                throw new ArgumentNullException(nameof(responseCode), "Property is not nullable for class ForgotPassword.");

            if (responseMsg.IsSet && responseMsg.Value == null)
                throw new ArgumentNullException(nameof(responseMsg), "Property is not nullable for class ForgotPassword.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ForgotPassword.");

            return new ForgotPassword(httpCode, responseCode, responseMsg, data);
        }

        /// <summary>
        /// Serializes a <see cref="ForgotPassword" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="forgotPassword"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ForgotPassword forgotPassword, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, forgotPassword, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ForgotPassword" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="forgotPassword"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ForgotPassword forgotPassword, JsonSerializerOptions jsonSerializerOptions)
        {
            if (forgotPassword.ResponseCodeOption.IsSet && forgotPassword.ResponseCode == null)
                throw new ArgumentNullException(nameof(forgotPassword.ResponseCode), "Property is required for class ForgotPassword.");

            if (forgotPassword.ResponseMsgOption.IsSet && forgotPassword.ResponseMsg == null)
                throw new ArgumentNullException(nameof(forgotPassword.ResponseMsg), "Property is required for class ForgotPassword.");

            if (forgotPassword.DataOption.IsSet && forgotPassword.Data == null)
                throw new ArgumentNullException(nameof(forgotPassword.Data), "Property is required for class ForgotPassword.");

            if (forgotPassword.HttpCodeOption.IsSet)
                writer.WriteNumber("http_code", forgotPassword.HttpCodeOption.Value!.Value);

            if (forgotPassword.ResponseCodeOption.IsSet)
                writer.WriteString("response_code", forgotPassword.ResponseCode);

            if (forgotPassword.ResponseMsgOption.IsSet)
                writer.WriteString("response_msg", forgotPassword.ResponseMsg);

            if (forgotPassword.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, forgotPassword.Data, jsonSerializerOptions);
            }
        }
    }
}
