...
namespace ClickSend.Model
{
    ...
    /// </summary>
    public partial class ViewAvailableNumbersData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewAvailableNumbersData" /> class.
        /// </summary>
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<ViewAvailableNumbersDataAllOfDataInner>?> DataOption { get; private set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ViewAvailableNumbersData" />
    /// </summary>
    public class ViewAvailableNumbersDataJsonConverter : JsonConverter<ViewAvailableNumbersData>
    {
        /// <summary>
        /// Deserializes json to <see cref="ViewAvailableNumbersData" />
        /// </summary>
        ...
        public override ViewAvailableNumbersData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class ViewAvailableNumbersData.");

            if (perPage.IsSet && perPage.Value == null)
                throw new ArgumentNullException(nameof(perPage), "Property is not nullable for class ViewAvailableNumbersData.");

            if (currentPage.IsSet && currentPage.Value == null)
                throw new ArgumentNullException(nameof(currentPage), "Property is not nullable for class ViewAvailableNumbersData.");

            if (lastPage.IsSet && lastPage.Value == null)
                throw new ArgumentNullException(nameof(lastPage), "Property is not nullable for class ViewAvailableNumbersData.");

            if (from.IsSet && from.Value == null)
                throw new ArgumentNullException(nameof(from), "Property is not nullable for class ViewAvailableNumbersData.");

            if (to.IsSet && to.Value == null)
                throw new ArgumentNullException(nameof(to), "Property is not nullable for class ViewAvailableNumbersData.");
        ...
        /// <summary>
        /// Serializes a <see cref="ViewAvailableNumbersData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewAvailableNumbersData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ViewAvailableNumbersData viewAvailableNumbersData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, viewAvailableNumbersData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ViewAvailableNumbersData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewAvailableNumbersData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ViewAvailableNumbersData viewAvailableNumbersData, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (viewAvailableNumbersData.PerPageOption.IsSet)
                writer.WriteNumber("per_page", viewAvailableNumbersData.PerPageOption.Value!.Value);

            if (viewAvailableNumbersData.CurrentPageOption.IsSet)
                writer.WriteNumber("current_page", viewAvailableNumbersData.CurrentPageOption.Value!.Value);

            if (viewAvailableNumbersData.LastPageOption.IsSet)
                writer.WriteNumber("last_page", viewAvailableNumbersData.LastPageOption.Value!.Value);

            if (viewAvailableNumbersData.NextPageUrlOption.IsSet)
                if (viewAvailableNumbersData.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", viewAvailableNumbersData.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (viewAvailableNumbersData.PrevPageUrlOption.IsSet)
                if (viewAvailableNumbersData.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", viewAvailableNumbersData.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (viewAvailableNumbersData.FromOption.IsSet)
                writer.WriteNumber("from", viewAvailableNumbersData.FromOption.Value!.Value);

            if (viewAvailableNumbersData.ToOption.IsSet)
                writer.WriteNumber("to", viewAvailableNumbersData.ToOption.Value!.Value);

            if (viewAvailableNumbersData.DataOption.IsSet)
            {
