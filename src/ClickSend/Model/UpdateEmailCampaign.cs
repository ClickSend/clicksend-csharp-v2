...
namespace ClickSend.Model
{
    ...
    public partial class UpdateEmailCampaign : IValidatableObject
    {
        ...
        [JsonConstructor]
        public UpdateEmailCampaign(Option<int?> httpCode = default, Option<string?> responseCode = default, Option<string?> responseMsg = default, Option<EmailCampaign?> data = default)
        {
        ...
        /* <example>Email campaign has been updated.</example> */
    ...
    public class UpdateEmailCampaignJsonConverter : JsonConverter<UpdateEmailCampaign>
    {
        ...
        public override UpdateEmailCampaign Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (httpCode.IsSet && httpCode.Value == null)
                throw new ArgumentNullException(nameof(httpCode), "Property is not nullable for class UpdateEmailCampaign.");

            if (responseCode.IsSet && responseCode.Value == null)
                throw new ArgumentNullException(nameof(responseCode), "Property is not nullable for class UpdateEmailCampaign.");

            if (responseMsg.IsSet && responseMsg.Value == null)
                throw new ArgumentNullException(nameof(responseMsg), "Property is not nullable for class UpdateEmailCampaign.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class UpdateEmailCampaign.");

            return new UpdateEmailCampaign(httpCode, responseCode, responseMsg, data);
        }
        ...
        {
            if (updateEmailCampaign.ResponseCodeOption.IsSet && updateEmailCampaign.ResponseCode == null)
                throw new ArgumentNullException(nameof(updateEmailCampaign.ResponseCode), "Property is required for class UpdateEmailCampaign.");

            if (updateEmailCampaign.ResponseMsgOption.IsSet && updateEmailCampaign.ResponseMsg == null)
                throw new ArgumentNullException(nameof(updateEmailCampaign.ResponseMsg), "Property is required for class UpdateEmailCampaign.");

            if (updateEmailCampaign.DataOption.IsSet && updateEmailCampaign.Data == null)
                throw new ArgumentNullException(nameof(updateEmailCampaign.Data), "Property is required for class UpdateEmailCampaign.");

            if (updateEmailCampaign.HttpCodeOption.IsSet)
                writer.WriteNumber("http_code", updateEmailCampaign.HttpCodeOption.Value!.Value);

            if (updateEmailCampaign.ResponseCodeOption.IsSet)
                writer.WriteString("response_code", updateEmailCampaign.ResponseCode);

            if (updateEmailCampaign.ResponseMsgOption.IsSet)
                writer.WriteString("response_msg", updateEmailCampaign.ResponseMsg);

            if (updateEmailCampaign.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, updateEmailCampaign.Data, jsonSerializerOptions);
            }
        }
    }
}
