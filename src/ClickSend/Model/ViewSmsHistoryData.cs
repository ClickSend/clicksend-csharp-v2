...
namespace ClickSend.Model
{
    ...
    /// </summary>
    public partial class ViewSmsHistoryData : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ViewSmsHistoryData" /> class.
        /// </summary>
        ...
        /// <param name="data">The parameters related to the actual SMS.</param>
        [JsonConstructor]
        public ViewSmsHistoryData(Option<int?> total = default, Option<int?> perPage = default, Option<int?> currentPage = default, Option<int?> lastPage = default, Option<string?> nextPageUrl = default, Option<string?> prevPageUrl = default, Option<int?> from = default, Option<int?> to = default, Option<List<ViewSmsHistoryDataAllOfDataInner>?> data = default)
        {
            TotalOption = total;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<ViewSmsHistoryDataAllOfDataInner>?> DataOption { get; private set; }

        /// <summary>
        /// The parameters related to the actual SMS.
        /// </summary>
        /// <value>The parameters related to the actual SMS.</value>
        [JsonPropertyName("data")]
        public List<ViewSmsHistoryDataAllOfDataInner>? Data { get { return this.DataOption.Value; } set { this.DataOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="ViewSmsHistoryData" />
    /// </summary>
    public class ViewSmsHistoryDataJsonConverter : JsonConverter<ViewSmsHistoryData>
    {
        /// <summary>
        /// Deserializes json to <see cref="ViewSmsHistoryData" />
        /// </summary>
        ...
        public override ViewSmsHistoryData Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<ViewSmsHistoryDataAllOfDataInner>?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "to":
                            ...
                            break;
                        case "data":
                            data = new Option<List<ViewSmsHistoryDataAllOfDataInner>?>(JsonSerializer.Deserialize<List<ViewSmsHistoryDataAllOfDataInner>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (total.IsSet && total.Value == null)
                throw new ArgumentNullException(nameof(total), "Property is not nullable for class ViewSmsHistoryData.");

            if (perPage.IsSet && perPage.Value == null)
                throw new ArgumentNullException(nameof(perPage), "Property is not nullable for class ViewSmsHistoryData.");

            if (currentPage.IsSet && currentPage.Value == null)
                throw new ArgumentNullException(nameof(currentPage), "Property is not nullable for class ViewSmsHistoryData.");

            if (lastPage.IsSet && lastPage.Value == null)
                throw new ArgumentNullException(nameof(lastPage), "Property is not nullable for class ViewSmsHistoryData.");

            if (from.IsSet && from.Value == null)
                throw new ArgumentNullException(nameof(from), "Property is not nullable for class ViewSmsHistoryData.");

            if (to.IsSet && to.Value == null)
                throw new ArgumentNullException(nameof(to), "Property is not nullable for class ViewSmsHistoryData.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class ViewSmsHistoryData.");

            return new ViewSmsHistoryData(total, perPage, currentPage, lastPage, nextPageUrl, prevPageUrl, from, to, data);
        }

        /// <summary>
        /// Serializes a <see cref="ViewSmsHistoryData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewSmsHistoryData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ViewSmsHistoryData viewSmsHistoryData, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, viewSmsHistoryData, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ViewSmsHistoryData" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="viewSmsHistoryData"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ViewSmsHistoryData viewSmsHistoryData, JsonSerializerOptions jsonSerializerOptions)
        {
            if (viewSmsHistoryData.DataOption.IsSet && viewSmsHistoryData.Data == null)
                throw new ArgumentNullException(nameof(viewSmsHistoryData.Data), "Property is required for class ViewSmsHistoryData.");

            if (viewSmsHistoryData.TotalOption.IsSet)
                writer.WriteNumber("total", viewSmsHistoryData.TotalOption.Value!.Value);

            if (viewSmsHistoryData.PerPageOption.IsSet)
                writer.WriteNumber("per_page", viewSmsHistoryData.PerPageOption.Value!.Value);

            if (viewSmsHistoryData.CurrentPageOption.IsSet)
                writer.WriteNumber("current_page", viewSmsHistoryData.CurrentPageOption.Value!.Value);

            if (viewSmsHistoryData.LastPageOption.IsSet)
                writer.WriteNumber("last_page", viewSmsHistoryData.LastPageOption.Value!.Value);

            if (viewSmsHistoryData.NextPageUrlOption.IsSet)
                if (viewSmsHistoryData.NextPageUrlOption.Value != null)
                    writer.WriteString("next_page_url", viewSmsHistoryData.NextPageUrl);
                else
                    writer.WriteNull("next_page_url");

            if (viewSmsHistoryData.PrevPageUrlOption.IsSet)
                if (viewSmsHistoryData.PrevPageUrlOption.Value != null)
                    writer.WriteString("prev_page_url", viewSmsHistoryData.PrevPageUrl);
                else
                    writer.WriteNull("prev_page_url");

            if (viewSmsHistoryData.FromOption.IsSet)
                writer.WriteNumber("from", viewSmsHistoryData.FromOption.Value!.Value);

            if (viewSmsHistoryData.ToOption.IsSet)
                writer.WriteNumber("to", viewSmsHistoryData.ToOption.Value!.Value);

            if (viewSmsHistoryData.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, viewSmsHistoryData.Data, jsonSerializerOptions);
            }
        }
    }
}
