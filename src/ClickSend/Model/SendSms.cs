...
namespace ClickSend.Model
{
    ...
    public partial class SendSms : IValidatableObject
    {
        ...
        [JsonConstructor]
        public SendSms(Option<string?> httpCode = default, Option<string?> responseCode = default, Option<string?> responseMsg = default, Option<SendSmsData?> data = default)
        {
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<SendSmsData?> DataOption { get; private set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        [JsonPropertyName("data")]
        public SendSmsData? Data { get { return this.DataOption.Value; } set { this.DataOption = new(value); } }
    ...
    public class SendSmsJsonConverter : JsonConverter<SendSms>
    {
        ...
        public override SendSms Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<SendSmsData?> data = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "response_msg":
                            ...
                            break;
                        case "data":
                            data = new Option<SendSmsData?>(JsonSerializer.Deserialize<SendSmsData>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (httpCode.IsSet && httpCode.Value == null)
                throw new ArgumentNullException(nameof(httpCode), "Property is not nullable for class SendSms.");

            if (responseCode.IsSet && responseCode.Value == null)
                throw new ArgumentNullException(nameof(responseCode), "Property is not nullable for class SendSms.");

            if (responseMsg.IsSet && responseMsg.Value == null)
                throw new ArgumentNullException(nameof(responseMsg), "Property is not nullable for class SendSms.");

            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class SendSms.");

            return new SendSms(httpCode, responseCode, responseMsg, data);
        }
        ...
        {
            if (sendSms.HttpCodeOption.IsSet && sendSms.HttpCode == null)
                throw new ArgumentNullException(nameof(sendSms.HttpCode), "Property is required for class SendSms.");

            if (sendSms.ResponseCodeOption.IsSet && sendSms.ResponseCode == null)
                throw new ArgumentNullException(nameof(sendSms.ResponseCode), "Property is required for class SendSms.");

            if (sendSms.ResponseMsgOption.IsSet && sendSms.ResponseMsg == null)
                throw new ArgumentNullException(nameof(sendSms.ResponseMsg), "Property is required for class SendSms.");

            if (sendSms.DataOption.IsSet && sendSms.Data == null)
                throw new ArgumentNullException(nameof(sendSms.Data), "Property is required for class SendSms.");

            if (sendSms.HttpCodeOption.IsSet)
                writer.WriteString("http_code", sendSms.HttpCode);

            if (sendSms.ResponseCodeOption.IsSet)
                writer.WriteString("response_code", sendSms.ResponseCode);

            if (sendSms.ResponseMsgOption.IsSet)
                writer.WriteString("response_msg", sendSms.ResponseMsg);

            if (sendSms.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, sendSms.Data, jsonSerializerOptions);
            }
        }
    }
}
