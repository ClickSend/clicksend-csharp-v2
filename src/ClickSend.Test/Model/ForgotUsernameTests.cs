...
namespace ClickSend.Test.Model
{
    ...
    public class ForgotUsernameTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" ForgotUsername
            //Assert.IsType<ForgotUsername>(instance);
        }
