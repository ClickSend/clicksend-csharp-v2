...
namespace ClickSend.Test.Model
{
    ...
    public class InboundFaxRuleTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" InboundFaxRule
            //Assert.IsType<InboundFaxRule>(instance);
        }
