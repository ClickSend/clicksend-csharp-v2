...
namespace ClickSend.Test.Api
{
    ...
    public sealed class ContactsApiTests : ApiTestsBase
    {
        ...
        public async Task DeleteContactAsyncTest()
        {
            ...
            var response = await _instance.DeleteContactAsync(listId, contactId, contentType);
            var model = response.Ok();
            Assert.IsType<DeleteContact>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetSpecificContactAsyncTest()
        {
            string listId = default!;
            string contactId = default!;
            Client.Option<string> contentType = default!;
            var response = await _instance.GetSpecificContactAsync(listId, contactId, contentType);
            var model = response.Ok();
            Assert.IsType<GetSpecificContact>(model);
        }
        ...
        public async Task UpdateContactAsyncTest()
        {
            ...
            var response = await _instance.UpdateContactAsync(listId, contactId, contentType, createNewContactRequest);
            var model = response.Ok();
            Assert.IsType<UpdateContact>(model);
        }
    }
}
