...
namespace ClickSend.Test.Api
{
    ...
    public sealed class StatisticsApiTests : ApiTestsBase
    {
        ...
        public async Task ViewSmsStatisticsAsyncTest()
        {
            Client.Option<string> contentType = default!;
            var response = await _instance.ViewSmsStatisticsAsync(contentType);
            var model = response.Ok();
            Assert.IsType<ViewSmsStatistics>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ViewVoiceStatisticsAsyncTest()
        {
            Client.Option<string> contentType = default!;
            var response = await _instance.ViewVoiceStatisticsAsync(contentType);
            var model = response.Ok();
            Assert.IsType<ViewVoiceStatistics>(model);
        }
    }
}
