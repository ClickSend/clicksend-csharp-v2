...
namespace ClickSend.Test.Api
{
    ...
    public sealed class VerificationApiTests : ApiTestsBase
    {
        ...
        public async Task ForgotPasswordAsyncTest()
        {
            ...
            Client.Option<ForgotPasswordRequest> forgotPasswordRequest = default!;
            var response = await _instance.ForgotPasswordAsync(contentType, forgotPasswordRequest);
            var model = response.Ok();
            Assert.IsType<ForgotPassword>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ForgotUsernameAsyncTest()
        {
            Client.Option<string> contentType = default!;
            Client.Option<ForgotUsernameRequest> forgotUsernameRequest = default!;
            var response = await _instance.ForgotUsernameAsync(contentType, forgotUsernameRequest);
            var model = response.Ok();
            Assert.IsType<ForgotUsername>(model);
        }
    }
}
