...
namespace ClickSend.Test.Api
{
    ...
    public sealed class ManagementApiTests : ApiTestsBase
    {
        ...
        public async Task ViewAccountDetailsAsyncTest()
        {
            Client.Option<string> contentType = default!;
            var response = await _instance.ViewAccountDetailsAsync(contentType);
            var model = response.Ok();
            Assert.IsType<ViewAccountDetails>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ViewAccountUsageAsyncTest()
        {
            string year = default!;
            string month = default!;
            Client.Option<string> contentType = default!;
            var response = await _instance.ViewAccountUsageAsync(year, month, contentType);
            var model = response.Ok();
            Assert.IsType<ViewAccountUsage>(model);
        }
    }
}
