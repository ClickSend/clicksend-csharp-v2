...
{
    /// <summary>
    ///  Class for testing UrlShorteningApi
    /// </summary>
    public sealed class UrlShorteningApiTests : ApiTestsBase
    {
        private readonly IUrlShorteningApi _instance;

        public UrlShorteningApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IUrlShorteningApi>();
        }

        /// <summary>
        /// Test ShortUrlGetStatistics
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ShortUrlGetStatisticsAsyncTest()
        {
            string source = default!;
            string sourceId = default!;
            Client.Option<string> contentType = default!;
            var response = await _instance.ShortUrlGetStatisticsAsync(source, sourceId, contentType);
            var model = response.Ok();
            Assert.IsType<GetStatistics>(model);
        }

        /// <summary>
        /// Test ShortUrlGetTracking
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ShortUrlGetTrackingAsyncTest()
        {
            string longUrlId = default!;
            Client.Option<string> contentType = default!;
            var response = await _instance.ShortUrlGetTrackingAsync(longUrlId, contentType);
            var model = response.Ok();
            Assert.IsType<GetTracking>(model);
        }
    }
}
