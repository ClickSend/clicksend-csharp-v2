...
{
    /// <summary>
    ///  Class for testing AlphaTagsApi
    /// </summary>
    public sealed class AlphaTagsApiTests : ApiTestsBase
    {
        private readonly IAlphaTagsApi _instance;

        public AlphaTagsApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IAlphaTagsApi>();
        }
        ...
        public async Task DeleteAlphaTagAsyncTest()
        {
            string alphaTagId = default!;
            Client.Option<string> contentType = default!;
            await _instance.DeleteAlphaTagAsync(alphaTagId, contentType);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetAlphaTagAsyncTest()
        {
            string alphaTagId = default!;
            Client.Option<string> contentType = default!;
            var response = await _instance.GetAlphaTagAsync(alphaTagId, contentType);
            var model = response.Ok();
            Assert.IsType<AlphaTag>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ListAlphaTagsAsyncTest()
        {
            Client.Option<string> sortDirection = default!;
            Client.Option<int> pageSize = default!;
            var response = await _instance.ListAlphaTagsAsync(sortDirection, pageSize);
            var model = response.Ok();
            Assert.IsType<ListAlphaTags>(model);
        }

        /// <summary>
        /// Test RequestAlphaTag
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task RequestAlphaTagAsyncTest()
        {
            Client.Option<string> contentType = default!;
            Client.Option<RequestAlphaTagRequest> requestAlphaTagRequest = default!;
            var response = await _instance.RequestAlphaTagAsync(contentType, requestAlphaTagRequest);
            var model = response.Ok();
            Assert.IsType<AlphaTag>(model);
        }
    }
