...
**Schedule** | **decimal** | The timestamp when the message should be sent. | [optional] 
**MessageId** | **string** | The ID of the message. | [optional] 
**MessageParts** | **decimal** | The number of parts in the message. | [optional] 
**MessagePrice** | **decimal** | The price of the message. | [optional] 
